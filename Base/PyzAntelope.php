...
abstract class PyzAntelope implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Pyz\\Zed\\Antelope\\Persistence\\Propel\\Map\\PyzAntelopeTableMap';
    ...
    /**
     * Initializes internal state of Pyz\Zed\Antelope\Persistence\Propel\Base\PyzAntelope object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Pyz\\Zed\\Antelope\\Persistence\\Propel\\PyzAntelope'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Pyz\Zed\Antelope\Persistence\Propel\PyzAntelope (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Pyz\Zed\Antelope\Persistence\Propel\PyzAntelope Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
