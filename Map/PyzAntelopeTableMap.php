...
namespace Pyz\Zed\Antelope\Persistence\Propel\Map;
...
use Pyz\Zed\Antelope\Persistence\Propel\PyzAntelope;
use Pyz\Zed\Antelope\Persistence\Propel\PyzAntelopeQuery;
...
class PyzAntelopeTableMap extends TableMap
{
     ...
     */
    public const OM_CLASS = '\\Pyz\\Zed\\Antelope\\Persistence\\Propel\\PyzAntelope';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAntelope', 'Name', 'Color', ],
        self::TYPE_CAMELNAME     => ['idAntelope', 'name', 'color', ],
        self::TYPE_COLNAME       => [PyzAntelopeTableMap::COL_ID_ANTELOPE, PyzAntelopeTableMap::COL_NAME, PyzAntelopeTableMap::COL_COLOR, ],
        self::TYPE_FIELDNAME     => ['id_antelope', 'name', 'color', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAntelope' => 0, 'Name' => 1, 'Color' => 2, ],
        self::TYPE_CAMELNAME     => ['idAntelope' => 0, 'name' => 1, 'color' => 2, ],
        self::TYPE_COLNAME       => [PyzAntelopeTableMap::COL_ID_ANTELOPE => 0, PyzAntelopeTableMap::COL_NAME => 1, PyzAntelopeTableMap::COL_COLOR => 2, ],
        self::TYPE_FIELDNAME     => ['id_antelope' => 0, 'name' => 1, 'color' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Pyz\\Zed\\Antelope\\Persistence\\Propel\\PyzAntelope');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Pyz\Zed\Antelope\Persistence\Propel\PyzAntelope) { // it's a model object
