...
class ItemBuilder extends AbstractDataBuilder
{
    ...
    protected $defaultRules = [
        ...
        "name" => "lexify('??????????')",
        "sumSubtotalAggregation" => "randomNumber(5)",
        "unitPrice" => "randomNumber(5)",
        "unitNetPrice" => "randomNumber(5)",
        "sumPriceToPayAggregation" => "randomNumber(5)",
        "unitTaxAmountFullAggregation" => "randomNumber(5)",
        "sumTaxAmountFullAggregation" => "randomNumber(5)",
        "unitSubtotalAggregation" => "randomNumber(5)",
        "unitDiscountAmountAggregation" => "randomNumber(5)",
        "sumDiscountAmountFullAggregation" => "randomNumber(5)",
        "abstractSku" => "isbn10()",
    ];
    ...
    protected $dependencies = [
        ...
        'merchantStockAddress' => 'MerchantStockAddress',
    ];
     ...
     * @return $this
     */
    public function withMerchantProfileAddress($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('merchantProfileAddress', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('merchantProfileAddress', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherMerchantProfileAddress($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('merchantProfileAddress', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('merchantProfileAddress', $overrideOrBuilder, true);
     ...
     * @return $this
     */
    public function withMerchantStockAddress($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('merchantStockAddress', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('merchantStockAddress', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherMerchantStockAddress($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('merchantStockAddress', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('merchantStockAddress', $overrideOrBuilder, true);
