 ...
 */
class WishlistOverviewResponseBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
     ...
     */
    public function build(): WishlistOverviewResponseTransfer
    {
        /** @var \Generated\Shared\Transfer\WishlistOverviewResponseTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\WishlistOverviewResponseTransfer
     */
    public function getTransfer(): WishlistOverviewResponseTransfer
    {
     ...
     * @return $this
     */
    public function withMeta($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('meta', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('meta', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherMeta($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('meta', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('meta', $overrideOrBuilder, true);
