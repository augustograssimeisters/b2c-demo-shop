 ...
 */
class TaxAppConfigBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
    ...
    protected $defaultRules = [
        "applicationId" => "lexify('??????????')",
        "vendorCode" => "lexify('??????????')",
        "storeReference" => "=de-DE",
        "tenantIdentifier" => "lexify('??????????')",
    ];
     ...
     */
    public function build(): TaxAppConfigTransfer
    {
        /** @var \Generated\Shared\Transfer\TaxAppConfigTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\TaxAppConfigTransfer
     */
    public function getTransfer(): TaxAppConfigTransfer
    {
        return new TaxAppConfigTransfer;
    }
