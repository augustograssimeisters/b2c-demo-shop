 ...
 */
class ShipmentTypeCriteriaBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
     ...
     */
    public function build(): ShipmentTypeCriteriaTransfer
    {
        /** @var \Generated\Shared\Transfer\ShipmentTypeCriteriaTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\ShipmentTypeCriteriaTransfer
     */
    public function getTransfer(): ShipmentTypeCriteriaTransfer
    {
        return new ShipmentTypeCriteriaTransfer;
    }
     ...
     * @return $this
     */
    public function withShipmentTypeConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('shipmentTypeConditions', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('shipmentTypeConditions', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherShipmentTypeConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('shipmentTypeConditions', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('shipmentTypeConditions', $overrideOrBuilder, true);
