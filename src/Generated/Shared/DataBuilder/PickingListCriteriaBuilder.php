 ...
 */
class PickingListCriteriaBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
     ...
     */
    public function build(): PickingListCriteriaTransfer
    {
        /** @var \Generated\Shared\Transfer\PickingListCriteriaTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\PickingListCriteriaTransfer
     */
    public function getTransfer(): PickingListCriteriaTransfer
    {
     ...
     * @return $this
     */
    public function withPickingListConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('pickingListConditions', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('pickingListConditions', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherPickingListConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('pickingListConditions', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('pickingListConditions', $overrideOrBuilder, true);
