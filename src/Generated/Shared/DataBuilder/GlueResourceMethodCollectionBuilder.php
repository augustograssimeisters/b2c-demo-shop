...
class GlueResourceMethodCollectionBuilder extends AbstractDataBuilder
{
    ...
    protected $dependencies = [
        ...
        'put' => 'GlueResourceMethodConfiguration',
    ];
     ...
     * @return $this
     */
    public function withPut($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('put', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('put', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherPut($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('put', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('put', $overrideOrBuilder, true);
