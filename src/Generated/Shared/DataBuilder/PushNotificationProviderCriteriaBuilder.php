 ...
 */
class PushNotificationProviderCriteriaBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
     ...
     */
    public function build(): PushNotificationProviderCriteriaTransfer
    {
        /** @var \Generated\Shared\Transfer\PushNotificationProviderCriteriaTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\PushNotificationProviderCriteriaTransfer
     */
    public function getTransfer(): PushNotificationProviderCriteriaTransfer
    {
     ...
     * @return $this
     */
    public function withPushNotificationProviderConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('pushNotificationProviderConditions', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('pushNotificationProviderConditions', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherPushNotificationProviderConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('pushNotificationProviderConditions', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('pushNotificationProviderConditions', $overrideOrBuilder, true);
