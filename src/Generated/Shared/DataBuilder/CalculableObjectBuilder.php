...
class CalculableObjectBuilder extends AbstractDataBuilder
{
     ...
     * @return $this
     */
    public function withGiftCard($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('giftCard', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('giftCard', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherGiftCard($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('giftCard', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('giftCard', $overrideOrBuilder, true);
     ...
     * @return $this
     */
    public function withTaxCalculationResponse($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('taxCalculationResponse', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('taxCalculationResponse', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherTaxCalculationResponse($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('taxCalculationResponse', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('taxCalculationResponse', $overrideOrBuilder, true);
