 ...
 */
class AclUserHasGroupTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @module Acl
     *
     * @param \Generated\Shared\Transfer\GroupTransfer|null $group
     *
     * @return $this
     */
    public function setGroup(?GroupTransfer $group = null)
    {
        $this->group = $group;
     ...
     */
    public function getGroup(): ?GroupTransfer
    {
        return $this->group;
    }
     ...
     * @return $this
     */
    public function setGroupOrFail(GroupTransfer $group)
    {
     ...
     */
    public function getGroupOrFail(): GroupTransfer
    {
        if ($this->group === null) {
