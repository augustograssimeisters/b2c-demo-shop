...
class CheckoutResponseTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CheckoutPage|DateTimeConfiguratorPageExample|Availability|Calculation|CheckoutRestApi|Checkout|Country|Customer|CustomersRestApi|Discount|DummyPayment|Payment|ProductBundle|ProductCartConnector|ProductConfigurationCart|ProductDiscontinued|ProductOption|ProductQuantity|SalesOrderThreshold|SalesProductConnector|Sales|ShipmentCheckoutConnector|Shipment|ShipmentsRestApi
     *
    ...
    /**
     * @module CheckoutPage|CheckoutRestApi|Checkout|Customer|Discount|GiftCardBalance|GiftCard|Oms|Payment|ProductBundle|ProductOption|SalesProductConnector|Sales|Shipment
     *
     * @deprecated Use SaveOrderTransfer directly/decoupled from the checkout response
     *
    ...
    /**
     * @module CheckoutPage|DateTimeConfiguratorPageExample|Availability|Calculation|CheckoutRestApi|Checkout|Country|Customer|CustomersRestApi|Discount|DummyPayment|GiftCard|Nopayment|Payment|ProductBundle|ProductCartConnector|ProductConfigurationCart|ProductDiscontinued|ProductOption|ProductQuantity|SalesOrderThreshold|SalesProductConnector|Sales|ShipmentCheckoutConnector|Shipment|ShipmentsRestApi
     *
