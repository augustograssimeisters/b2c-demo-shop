 ...
 */
class StockResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module StockAddress|Stock
     *
     * @param \Generated\Shared\Transfer\StockTransfer|null $stock
     *
     * @return $this
     */
    public function setStock(StockTransfer $stock = null)
    {
        $this->stock = $stock;
     ...
     * @return $this
     */
    public function setStockOrFail(StockTransfer $stock)
    {
    ...
    /**
     * @module StockAddress|StockGui|Stock
     *
