 ...
 */
class ProductAlternativeResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const PRODUCT_ALTERNATIVE = 'productAlternative';
    ...
    /**
     * @var \Generated\Shared\Transfer\ProductAlternativeTransfer|null
     */
    protected $productAlternative;
    ...
    protected $transferMetadata = [
        ...
        self::PRODUCT_ALTERNATIVE => [
            'type' => 'Generated\Shared\Transfer\ProductAlternativeTransfer',
            'type_shim' => null,
            'name_underscore' => 'product_alternative',
            'is_collection' => false,
            'is_transfer' => true,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
     ...
     *
     * @param \Generated\Shared\Transfer\ProductAlternativeTransfer|null $productAlternative
     *
     * @return $this
     */
    public function setProductAlternative(ProductAlternativeTransfer $productAlternative = null)
    {
        $this->productAlternative = $productAlternative;
        $this->modifiedProperties[self::PRODUCT_ALTERNATIVE] = true;
     ...
     * @return $this
     */
    public function setProductAlternativeOrFail(ProductAlternativeTransfer $productAlternative)
    {
        return $this->setProductAlternative($productAlternative);
    }
     ...
     */
    public function getProductAlternativeOrFail()
    {
        if ($this->productAlternative === null) {
            $this->throwNullValueException(static::PRODUCT_ALTERNATIVE);
        }
     ...
     * @return $this
     */
    public function requireProductAlternative()
    {
        $this->assertPropertyIsSet(self::PRODUCT_ALTERNATIVE);
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'productAlternative' => $this->productAlternative,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'product_alternative' => $this->productAlternative,
            'messages' => $this->messages,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'product_alternative' => $this->productAlternative instanceof AbstractTransfer ? $this->productAlternative->toArray(true, false) : $this->productAlternative,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'productAlternative' => $this->productAlternative instanceof AbstractTransfer ? $this->productAlternative->toArray(true, true) : $this->productAlternative,
