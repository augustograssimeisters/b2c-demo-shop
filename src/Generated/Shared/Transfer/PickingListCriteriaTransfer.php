 ...
 */
class PickingListCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const PICKING_LIST_CONDITIONS = 'pickingListConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\PickingListConditionsTransfer|null
     */
    protected $pickingListConditions;
    ...
    protected $transferPropertyNameMap = [
        'picking_list_conditions' => 'pickingListConditions',
        'pickingListConditions' => 'pickingListConditions',
        'PickingListConditions' => 'pickingListConditions',
    ...
    protected $transferMetadata = [
        self::PICKING_LIST_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\PickingListConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'picking_list_conditions',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     *
     * @param \Generated\Shared\Transfer\PickingListConditionsTransfer|null $pickingListConditions
     *
     * @return $this
     */
    public function setPickingListConditions(?PickingListConditionsTransfer $pickingListConditions = null)
    {
        $this->pickingListConditions = $pickingListConditions;
        $this->modifiedProperties[self::PICKING_LIST_CONDITIONS] = true;
     ...
     * @module PickingList|PickingListsBackendApi|PickingListsUsersBackendApi|PickingListsWarehousesBackendApi
     *
     * @return \Generated\Shared\Transfer\PickingListConditionsTransfer|null
     */
    public function getPickingListConditions(): ?PickingListConditionsTransfer
    {
        return $this->pickingListConditions;
    }

    /**
     * @module PickingList|PickingListsBackendApi|PickingListsUsersBackendApi|PickingListsWarehousesBackendApi
     *
     * @param \Generated\Shared\Transfer\PickingListConditionsTransfer $pickingListConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setPickingListConditionsOrFail(PickingListConditionsTransfer $pickingListConditions)
    {
        return $this->setPickingListConditions($pickingListConditions);
    }
     ...
     */
    public function getPickingListConditionsOrFail(): PickingListConditionsTransfer
    {
        if ($this->pickingListConditions === null) {
            $this->throwNullValueException(static::PICKING_LIST_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requirePickingListConditions()
    {
        $this->assertPropertyIsSet(self::PICKING_LIST_CONDITIONS);
    ...
    {
        return [
            'pickingListConditions' => $this->pickingListConditions,
    ...
    {
        return [
            'picking_list_conditions' => $this->pickingListConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'picking_list_conditions' => $this->pickingListConditions instanceof AbstractTransfer ? $this->pickingListConditions->toArray(true, false) : $this->pickingListConditions,
    ...
    {
        return [
            'pickingListConditions' => $this->pickingListConditions instanceof AbstractTransfer ? $this->pickingListConditions->toArray(true, true) : $this->pickingListConditions,
