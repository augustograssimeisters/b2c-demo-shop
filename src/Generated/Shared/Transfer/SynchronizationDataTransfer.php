...
class SynchronizationDataTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AssetStorage|AvailabilityStorage|CategoryImageStorage|CategoryStorage|CmsBlockCategoryStorage|CmsBlockProductStorage|CmsBlockStorage|CmsSlotBlockStorage|CmsSlotStorage|CmsStorage|ConfigurableBundleStorage|ContentStorage|CustomerStorage|EntityTag|FileManagerStorage|GlossaryStorage|NavigationStorage|PriceProductStorage|ProductAlternativeStorage|ProductBundleStorage|ProductCategoryFilterStorage|ProductCategoryStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductGroupStorage|ProductImageStorage|ProductLabelStorage|ProductListStorage|ProductOptionStorage|ProductQuantityStorage|ProductRelationStorage|ProductResourceAliasStorage|ProductReviewStorage|ProductSetStorage|ProductStorage|ShipmentTypeStorage|StoreContextStorage|StoreStorage|Synchronization|TaxProductStorage|TaxStorage|UrlStorage
     *
    ...
    /**
     * @module AssetStorage|CategoryImageStorage|CmsSlotBlockStorage|CmsSlotStorage|ConfigurableBundlePageSearch|ConfigurableBundleStorage|ContentStorage|CustomerAccessStorage|CustomerStorage|FileManagerStorage|GlossaryStorage|ProductAlternativeStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductListStorage|ProductPageSearch|ProductQuantityStorage|SalesReturnSearch|StoreStorage|Synchronization|TaxProductStorage|TaxStorage
     *
    ...
    /**
     * @module AssetStorage|CategoryImageStorage|CmsSlotBlockStorage|CmsSlotStorage|ConfigurableBundlePageSearch|ConfigurableBundleStorage|ContentStorage|CustomerAccessStorage|EntityTag|FileManagerStorage|GlossaryStorage|ProductAlternativeStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductListStorage|ProductPageSearch|ProductQuantityStorage|SalesReturnSearch|StoreStorage|Synchronization|TaxProductStorage|TaxStorage
     *
    ...
    /**
     * @module AssetStorage|AvailabilityStorage|CategoryStorage|CmsBlockCategoryStorage|CmsBlockProductStorage|CmsBlockStorage|CmsStorage|PriceProductStorage|ProductCategoryStorage|ProductLabelStorage|ProductOptionStorage|ProductPageSearch|ProductRelationStorage|ProductResourceAliasStorage|ProductStorage|ShipmentTypeStorage|Synchronization
     *
