 ...
 */
class ReturnCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\ReturnTransfer>
     */
    protected $returns;
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\ReturnTransfer> $returns
     *
     * @return $this
     */
    public function setReturns(ArrayObject $returns)
    {
        $this->returns = $returns;
        $this->modifiedProperties[self::RETURNS] = true;
     ...
     * @module SalesReturnPage|SalesReturnGui|SalesReturn|SalesReturnsRestApi
     *
     * @return \ArrayObject<\Generated\Shared\Transfer\ReturnTransfer>
     */
     ...
     * @return $this
     */
    public function addReturn(ReturnTransfer $return)
    {
        $this->returns[] = $return;
        $this->modifiedProperties[self::RETURNS] = true;
     ...
     * @return $this
     */
    public function requireReturns()
    {
        $this->assertCollectionPropertyIsSet(self::RETURNS);
    ...
    {
        $this->returns = $this->returns ?: new ArrayObject();
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'returns' => $this->returns instanceof AbstractTransfer ? $this->returns->toArray(true, false) : $this->addValuesToCollection($this->returns, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'returns' => $this->returns instanceof AbstractTransfer ? $this->returns->toArray(true, true) : $this->addValuesToCollection($this->returns, true, true),
        ];
    }
}
