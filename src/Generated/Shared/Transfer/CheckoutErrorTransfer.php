...
class CheckoutErrorTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CheckoutPage|DateTimeConfiguratorPageExample|Availability|Calculation|CheckoutRestApi|Checkout|Country|Customer|CustomersRestApi|Discount|DummyPayment|GiftCard|Nopayment|Payment|ProductBundle|ProductCartConnector|ProductConfigurationCart|ProductDiscontinued|ProductQuantity|SalesOrderThreshold|Sales|ShipmentCheckoutConnector|ShipmentsRestApi
     *
    ...
    /**
     * @module CheckoutPage|Availability|CheckoutRestApi|Country|CustomersRestApi|ProductBundle|ProductCartConnector|ProductDiscontinued|ProductQuantity|SalesOrderThreshold|Sales|ShipmentCheckoutConnector|ShipmentsRestApi
     *
