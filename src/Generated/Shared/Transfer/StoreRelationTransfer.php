...
class StoreRelationTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CategoryDataImport|CategoryStorage|Category|CmsBlock|Cms|Discount|Payment|ProductLabel|ProductManagement|ProductRelationGui|ProductRelation|ProductWarehouseAllocationExample|Product|ProductsBackendApi|ShipmentGui|Shipment|Stock|StoreGui|Store
     *
    ...
    /**
     * @module CategoryGui|CategoryPageSearch|CategoryStorage|Category|CmsBlockGui|CmsBlock|CmsGui|CmsSlotBlockGui|Cms|Discount|Payment|ProductLabelSearch|ProductLabelStorage|ProductLabel|ProductManagement|ProductRelationGui|ProductRelationStorage|ProductRelation|Product|ProductsBackendApi|ShipmentGui|ShipmentTypeStorage|ShipmentType|Shipment|Stock
     *
    ...
    /**
     * @module CategoryStorage|Category|CmsBlock|Cms|Discount|Payment|ProductLabel|ProductManagement|ProductRelationGui|ProductRelation|Product|ShipmentGui|ShipmentType|Shipment|Stock|Store
     *
