 ...
 */
class SalesShipmentTypeTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module SalesShipmentType
     *
     * @param int|null $idSalesShipmentType
     *
     * @return $this
     */
    public function setIdSalesShipmentType(?int $idSalesShipmentType = null)
    {
     ...
     * @return int|null
     */
    public function getIdSalesShipmentType(): ?int
    {
     ...
     * @return $this
     */
    public function setIdSalesShipmentTypeOrFail(int $idSalesShipmentType)
    {
     ...
     * @return int
     */
    public function getIdSalesShipmentTypeOrFail(): int
    {
