 ...
 */
class PaymentMethodsTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\PaymentMethodTransfer> $methods
     *
     * @return $this
     */
     ...
     * @module CheckoutPage|PaymentPage|CheckoutRestApi|GiftCard|Nopayment|Payment|PaymentsRestApi
     *
     * @param \Generated\Shared\Transfer\PaymentMethodTransfer $method
     *
     * @return $this
     */
    public function addMethod(PaymentMethodTransfer $method)
    {
        $this->methods[] = $method;
        $this->modifiedProperties[self::METHODS] = true;
