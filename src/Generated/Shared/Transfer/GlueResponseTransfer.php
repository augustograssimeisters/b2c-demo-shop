...
class GlueResponseTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const OAUTH_RESPONSE = 'oauthResponse';
    ...
    /**
     * @var \Generated\Shared\Transfer\OauthResponseTransfer|null
     */
    ...
    protected $transferMetadata = [
        ...
        self::OAUTH_RESPONSE => [
            'type' => 'Generated\Shared\Transfer\OauthResponseTransfer',
            'type_shim' => null,
            'name_underscore' => 'oauth_response',
            'is_collection' => false,
            'is_transfer' => true,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module DynamicEntityBackendApi|GlueApplication|ProductsBackendApi|WarehouseUsersBackendApi
     *
    ...
    /**
     * @module DynamicEntityBackendApi|GlueApplication|GlueBackendApiApplication|GlueJsonApiConvention|GlueStorefrontApiApplication|OauthApi|OauthBackendApi|PickingListsBackendApi|ProductsBackendApi|PushNotificationsBackendApi|StoresApi|WarehouseOauthBackendApi|WarehouseUsersBackendApi
     *
    ...
    /**
     * @module DynamicEntityBackendApi|GlueApplication|GlueBackendApiApplication|GlueStorefrontApiApplication
     *
     * @param array $meta
     *
     * @return $this
    ...
    /**
     * @module DynamicEntityBackendApi|GlueApplication|GlueJsonApiConvention|OauthApi|OauthBackendApi|PickingListsBackendApi|ProductsBackendApi|PushNotificationsBackendApi|StoresApi|TestifyBackendApi|WarehouseOauthBackendApi|WarehouseUsersBackendApi
     *
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\GlueResourceTransfer> $includedRelationships
     *
     * @return $this
     */
    public function setIncludedRelationships(ArrayObject $includedRelationships)
    {
     ...
     * @module GlueJsonApiConvention
     *
     * @param \Generated\Shared\Transfer\GlueResourceTransfer $includedRelationship
     *
     * @return $this
     */
    public function addIncludedRelationship(GlueResourceTransfer $includedRelationship)
    {
    ...
    {
        $this->assertCollectionPropertyIsSet(self::INCLUDED_RELATIONSHIPS);

        return $this;
    }

    /**
     * @module OauthBackendApi
     *
     * @param \Generated\Shared\Transfer\OauthResponseTransfer|null $oauthResponse
     *
     * @return $this
     */
    public function setOauthResponse(OauthResponseTransfer $oauthResponse = null)
    {
        $this->oauthResponse = $oauthResponse;
        $this->modifiedProperties[self::OAUTH_RESPONSE] = true;
     ...
     * @module OauthBackendApi
     *
     * @return \Generated\Shared\Transfer\OauthResponseTransfer|null
     */
     ...
     * @module OauthBackendApi
     *
     * @param \Generated\Shared\Transfer\OauthResponseTransfer $oauthResponse
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setOauthResponseOrFail(OauthResponseTransfer $oauthResponse)
    {
        return $this->setOauthResponse($oauthResponse);
    }
     ...
     */
    public function getOauthResponseOrFail()
    {
        if ($this->oauthResponse === null) {
            $this->throwNullValueException(static::OAUTH_RESPONSE);
        }
     ...
     * @return $this
     */
    public function requireOauthResponse()
    {
        $this->assertPropertyIsSet(self::OAUTH_RESPONSE);
    ...
    protected function initCollectionProperties(): void
    {
        ...
        $this->includedRelationships = $this->includedRelationships ?: new ArrayObject();
    }
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'oauthResponse' => $this->oauthResponse,
            'errors' => $this->errors,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'oauth_response' => $this->oauthResponse,
            'errors' => $this->errors,
            'resources' => $this->resources,
            'filters' => $this->filters,
            'sortings' => $this->sortings,
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'oauth_response' => $this->oauthResponse instanceof AbstractTransfer ? $this->oauthResponse->toArray(true, false) : $this->oauthResponse,
            ...
            'included_relationships' => $this->includedRelationships instanceof AbstractTransfer ? $this->includedRelationships->toArray(true, false) : $this->addValuesToCollection($this->includedRelationships, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'oauthResponse' => $this->oauthResponse instanceof AbstractTransfer ? $this->oauthResponse->toArray(true, true) : $this->oauthResponse,
            ...
            'includedRelationships' => $this->includedRelationships instanceof AbstractTransfer ? $this->includedRelationships->toArray(true, true) : $this->addValuesToCollection($this->includedRelationships, true, true),
        ];
    }
}
