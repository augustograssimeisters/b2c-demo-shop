 ...
 */
class CriteriaRangeFilterTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module ApiKeyAuthorizationConnector|ApiKey|DynamicEntityBackendApi|DynamicEntityGui|DynamicEntity
     *
     ...
     * @return $this
     */
    public function setFromOrFail(string $from)
    {
     ...
     * @return string
     */
    public function getFromOrFail(): string
    {
        if ($this->from === null) {
     ...
     * @return $this
     */
    public function setToOrFail(string $to)
    {
     ...
     * @return string
     */
    public function getToOrFail(): string
    {
        if ($this->to === null) {
