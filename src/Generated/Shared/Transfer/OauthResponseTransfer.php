...
class OauthResponseTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AgentAuthRestApi|AuthRestApi|OauthApi|OauthBackendApi|Oauth|WarehouseOauthBackendApi
     *
    ...
    /**
     * @module AuthRestApi|OauthApi|OauthBackendApi|Oauth|WarehouseOauthBackendApi
     *
