 ...
 */
class WarehouseUserAssignmentCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const WAREHOUSE_USER_ASSIGNMENT_CONDITIONS = 'warehouseUserAssignmentConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\WarehouseUserAssignmentConditionsTransfer|null
     */
    protected $warehouseUserAssignmentConditions;
    ...
    protected $transferPropertyNameMap = [
        'warehouse_user_assignment_conditions' => 'warehouseUserAssignmentConditions',
        'warehouseUserAssignmentConditions' => 'warehouseUserAssignmentConditions',
        'WarehouseUserAssignmentConditions' => 'warehouseUserAssignmentConditions',
    ...
    protected $transferMetadata = [
        self::WAREHOUSE_USER_ASSIGNMENT_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\WarehouseUserAssignmentConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'warehouse_user_assignment_conditions',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     *
     * @param \Generated\Shared\Transfer\WarehouseUserAssignmentConditionsTransfer|null $warehouseUserAssignmentConditions
     *
     * @return $this
     */
    public function setWarehouseUserAssignmentConditions(?WarehouseUserAssignmentConditionsTransfer $warehouseUserAssignmentConditions = null)
    {
        $this->warehouseUserAssignmentConditions = $warehouseUserAssignmentConditions;
        $this->modifiedProperties[self::WAREHOUSE_USER_ASSIGNMENT_CONDITIONS] = true;
     ...
     * @module PickingListPushNotification|PickingList|PickingListsBackendApi|WarehouseOauthBackendApi|WarehouseUserGui|WarehouseUser|WarehouseUsersBackendApi
     *
     * @return \Generated\Shared\Transfer\WarehouseUserAssignmentConditionsTransfer|null
     */
    public function getWarehouseUserAssignmentConditions(): ?WarehouseUserAssignmentConditionsTransfer
    {
        return $this->warehouseUserAssignmentConditions;
    }

    /**
     * @module PickingListPushNotification|PickingList|PickingListsBackendApi|WarehouseOauthBackendApi|WarehouseUserGui|WarehouseUser|WarehouseUsersBackendApi
     *
     * @param \Generated\Shared\Transfer\WarehouseUserAssignmentConditionsTransfer $warehouseUserAssignmentConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setWarehouseUserAssignmentConditionsOrFail(WarehouseUserAssignmentConditionsTransfer $warehouseUserAssignmentConditions)
    {
        return $this->setWarehouseUserAssignmentConditions($warehouseUserAssignmentConditions);
    }
     ...
     */
    public function getWarehouseUserAssignmentConditionsOrFail(): WarehouseUserAssignmentConditionsTransfer
    {
        if ($this->warehouseUserAssignmentConditions === null) {
            $this->throwNullValueException(static::WAREHOUSE_USER_ASSIGNMENT_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requireWarehouseUserAssignmentConditions()
    {
        $this->assertPropertyIsSet(self::WAREHOUSE_USER_ASSIGNMENT_CONDITIONS);
    ...
    public function fromArray(array $data, $ignoreMissingProperty = false)
    {
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                case 'warehouseUserAssignmentConditions':
                case 'pagination':
                    if (is_array($value)) {
    ...
    {
        return [
            'warehouseUserAssignmentConditions' => $this->warehouseUserAssignmentConditions,
    ...
    {
        return [
            'warehouse_user_assignment_conditions' => $this->warehouseUserAssignmentConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'warehouse_user_assignment_conditions' => $this->warehouseUserAssignmentConditions instanceof AbstractTransfer ? $this->warehouseUserAssignmentConditions->toArray(true, false) : $this->warehouseUserAssignmentConditions,
    ...
    {
        return [
            'warehouseUserAssignmentConditions' => $this->warehouseUserAssignmentConditions instanceof AbstractTransfer ? $this->warehouseUserAssignmentConditions->toArray(true, true) : $this->warehouseUserAssignmentConditions,
