 ...
 */
class FileDirectoryTreeTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @module FileManager
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\FileDirectoryTreeNodeTransfer> $nodes
     *
     * @return $this
     */
     ...
     * @module FileManager
     *
     * @param \Generated\Shared\Transfer\FileDirectoryTreeNodeTransfer $node
     *
     * @return $this
     */
    public function addNode(FileDirectoryTreeNodeTransfer $node)
    {
        $this->nodes[] = $node;
        $this->modifiedProperties[self::NODES] = true;
