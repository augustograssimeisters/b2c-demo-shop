...
class OrderListTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const WITHOUT_SEARCH_ORDER_EXPANDERS = 'withoutSearchOrderExpanders';
     ...
     * @var bool|null
     */
    protected $withoutSearchOrderExpanders;
    ...
    protected $transferPropertyNameMap = [
        ...
        'CustomerReference' => 'customerReference',
        'without_search_order_expanders' => 'withoutSearchOrderExpanders',
        'withoutSearchOrderExpanders' => 'withoutSearchOrderExpanders',
        'WithoutSearchOrderExpanders' => 'withoutSearchOrderExpanders',
    ...
    protected $transferMetadata = [
        ...
        self::WITHOUT_SEARCH_ORDER_EXPANDERS => [
            'type' => 'bool',
            'type_shim' => null,
            'name_underscore' => 'without_search_order_expanders',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module CustomerPage|OrdersRestApi|SalesDiscountConnector|Sales
     *
    ...
    /**
     * @module CustomerPage|SalesOrdersBackendApi|Sales
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|OrdersRestApi|SalesDiscountConnector|SalesOrdersBackendApi|Sales
     *
    ...
    /**
     * @module SalesDiscountConnector|Sales
     *
     * @param bool|null $withoutSearchOrderExpanders
     *
     * @return $this
     */
    public function setWithoutSearchOrderExpanders(?bool $withoutSearchOrderExpanders = null)
    {
        $this->withoutSearchOrderExpanders = $withoutSearchOrderExpanders;
        $this->modifiedProperties[self::WITHOUT_SEARCH_ORDER_EXPANDERS] = true;
     ...
     * @return bool|null
     */
    public function getWithoutSearchOrderExpanders(): ?bool
    {
        return $this->withoutSearchOrderExpanders;
    }

    /**
     * @module SalesDiscountConnector|Sales
     *
     * @param bool $withoutSearchOrderExpanders
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setWithoutSearchOrderExpandersOrFail(bool $withoutSearchOrderExpanders)
    {
        return $this->setWithoutSearchOrderExpanders($withoutSearchOrderExpanders);
    }
     ...
     * @return bool
     */
    public function getWithoutSearchOrderExpandersOrFail(): bool
    {
        if ($this->withoutSearchOrderExpanders === null) {
            $this->throwNullValueException(static::WITHOUT_SEARCH_ORDER_EXPANDERS);
        }
     ...
     * @return $this
     */
    public function requireWithoutSearchOrderExpanders()
    {
        $this->assertPropertyIsSet(self::WITHOUT_SEARCH_ORDER_EXPANDERS);
    ...
    public function fromArray(array $data, $ignoreMissingProperty = false)
    {
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                ...
                case 'withoutSearchOrderExpanders':
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'withoutSearchOrderExpanders' => $this->withoutSearchOrderExpanders,
            'filter' => $this->filter,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'without_search_order_expanders' => $this->withoutSearchOrderExpanders,
            'filter' => $this->filter,
            'pagination' => $this->pagination,
            'format' => $this->format,
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'without_search_order_expanders' => $this->withoutSearchOrderExpanders instanceof AbstractTransfer ? $this->withoutSearchOrderExpanders->toArray(true, false) : $this->withoutSearchOrderExpanders,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'withoutSearchOrderExpanders' => $this->withoutSearchOrderExpanders instanceof AbstractTransfer ? $this->withoutSearchOrderExpanders->toArray(true, true) : $this->withoutSearchOrderExpanders,
