 ...
 */
class ProductExportedTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const PRODUCTS_CONCRETE = 'productsConcrete';
    ...
    protected $transferPropertyNameMap = [
        'products_concrete' => 'productsConcrete',
        'productsConcrete' => 'productsConcrete',
        'ProductsConcrete' => 'productsConcrete',
    ...
    protected $transferMetadata = [
        self::PRODUCTS_CONCRETE => [
            'type' => 'Generated\Shared\Transfer\ProductConcreteTransfer',
            'type_shim' => null,
            'name_underscore' => 'products_concrete',
            'is_collection' => true,
            'is_transfer' => true,
     ...
     * @return $this
     */
    public function setProductsConcrete(ArrayObject $productsConcrete)
    {
        $this->productsConcrete = $productsConcrete;
        $this->modifiedProperties[self::PRODUCTS_CONCRETE] = true;
     ...
     */
    public function getProductsConcrete()
    {
        return $this->productsConcrete;
    }
    ...
    {
        $this->productsConcrete[] = $productConcrete;
        $this->modifiedProperties[self::PRODUCTS_CONCRETE] = true;
     ...
     * @return $this
     */
    public function requireProductsConcrete()
    {
        $this->assertCollectionPropertyIsSet(self::PRODUCTS_CONCRETE);
    ...
    {
        $this->productsConcrete = $this->productsConcrete ?: new ArrayObject();
    }
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'productsConcrete' => $this->productsConcrete,
        ];
    }
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'products_concrete' => $this->productsConcrete,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'products_concrete' => $this->productsConcrete instanceof AbstractTransfer ? $this->productsConcrete->toArray(true, false) : $this->addValuesToCollection($this->productsConcrete, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'productsConcrete' => $this->productsConcrete instanceof AbstractTransfer ? $this->productsConcrete->toArray(true, true) : $this->addValuesToCollection($this->productsConcrete, true, true),
        ];
    }
}
