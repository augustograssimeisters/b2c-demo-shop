...
class ProductAbstractTransfer extends AbstractTransfer
{
    ...
    protected $transferMetadata = [
        ...
        self::APPROVAL_STATUS => [
            'type' => 'string',
            'type_shim' => null,
            'name_underscore' => 'approval_status',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module CmsBlockProductConnector|ProductDynamicEntityConnector|Product|ProductsBackendApi
     *
    ...
    /**
     * @module CmsBlockProductConnector|Product|ProductsBackendApi
     *
    ...
    /**
     * @module ProductDynamicEntityConnector|Product|ProductsBackendApi
     *
    ...
    /**
     * @module ProductImage|ProductsBackendApi
     *
    ...
    /**
     * @module ProductManagement|Product|ProductsBackendApi
     *
    ...
    public function setApprovalStatus($approvalStatus)
    {
        ...
        $this->modifiedProperties[self::APPROVAL_STATUS] = true;
     ...
     * @return $this
     */
    public function setApprovalStatusOrFail($approvalStatus)
    {
        if ($approvalStatus === null) {
            $this->throwNullValueException(static::APPROVAL_STATUS);
        }

        return $this->setApprovalStatus($approvalStatus);
    }
     ...
     * @return string
     */
    public function getApprovalStatusOrFail()
    {
     ...
     * @return $this
     */
    public function requireApprovalStatus()
    {
        $this->assertPropertyIsSet(self::APPROVAL_STATUS);

        return $this;
    }

    /**
     * @module ProductsBackendApi|TaxProductConnector
     *
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'approval_status' => $this->approvalStatus instanceof AbstractTransfer ? $this->approvalStatus->toArray(true, false) : $this->approvalStatus,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'approvalStatus' => $this->approvalStatus instanceof AbstractTransfer ? $this->approvalStatus->toArray(true, true) : $this->approvalStatus,
