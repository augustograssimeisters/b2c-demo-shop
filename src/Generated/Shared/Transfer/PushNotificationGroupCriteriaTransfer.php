 ...
 */
class PushNotificationGroupCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const PUSH_NOTIFICATION_GROUP_CONDITIONS = 'pushNotificationGroupConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\PushNotificationGroupConditionsTransfer|null
     */
    protected $pushNotificationGroupConditions;
    ...
    protected $transferPropertyNameMap = [
        'push_notification_group_conditions' => 'pushNotificationGroupConditions',
    ...
    protected $transferMetadata = [
        self::PUSH_NOTIFICATION_GROUP_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\PushNotificationGroupConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'push_notification_group_conditions',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     *
     * @param \Generated\Shared\Transfer\PushNotificationGroupConditionsTransfer|null $pushNotificationGroupConditions
     *
     * @return $this
     */
    public function setPushNotificationGroupConditions(?PushNotificationGroupConditionsTransfer $pushNotificationGroupConditions = null)
    {
        $this->pushNotificationGroupConditions = $pushNotificationGroupConditions;
        $this->modifiedProperties[self::PUSH_NOTIFICATION_GROUP_CONDITIONS] = true;
     ...
     * @module PushNotification
     *
     * @return \Generated\Shared\Transfer\PushNotificationGroupConditionsTransfer|null
     */
    public function getPushNotificationGroupConditions(): ?PushNotificationGroupConditionsTransfer
    {
        return $this->pushNotificationGroupConditions;
    }

    /**
     * @module PushNotification
     *
     * @param \Generated\Shared\Transfer\PushNotificationGroupConditionsTransfer $pushNotificationGroupConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setPushNotificationGroupConditionsOrFail(PushNotificationGroupConditionsTransfer $pushNotificationGroupConditions)
    {
        return $this->setPushNotificationGroupConditions($pushNotificationGroupConditions);
    }
     ...
     */
    public function getPushNotificationGroupConditionsOrFail(): PushNotificationGroupConditionsTransfer
    {
        if ($this->pushNotificationGroupConditions === null) {
            $this->throwNullValueException(static::PUSH_NOTIFICATION_GROUP_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requirePushNotificationGroupConditions()
    {
        $this->assertPropertyIsSet(self::PUSH_NOTIFICATION_GROUP_CONDITIONS);
    ...
    public function fromArray(array $data, $ignoreMissingProperty = false)
    {
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                case 'pushNotificationGroupConditions':
                case 'pagination':
                    if (is_array($value)) {
    ...
    {
        return [
            'pushNotificationGroupConditions' => $this->pushNotificationGroupConditions,
    ...
    {
        return [
            'push_notification_group_conditions' => $this->pushNotificationGroupConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'push_notification_group_conditions' => $this->pushNotificationGroupConditions instanceof AbstractTransfer ? $this->pushNotificationGroupConditions->toArray(true, false) : $this->pushNotificationGroupConditions,
    ...
    {
        return [
            'pushNotificationGroupConditions' => $this->pushNotificationGroupConditions instanceof AbstractTransfer ? $this->pushNotificationGroupConditions->toArray(true, true) : $this->pushNotificationGroupConditions,
