 ...
 */
class ProductImageSetImagesBackendApiAttributesTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module ProductImageSetsBackendApi|ProductsBackendApi
     *
     * @param string|null $externalUrlLarge
     *
     * @return $this
     */
    public function setExternalUrlLarge(?string $externalUrlLarge = null)
    {
     ...
     * @return $this
     */
    public function setExternalUrlLargeOrFail(string $externalUrlLarge)
    {
     ...
     * @return string
     */
    public function getExternalUrlLargeOrFail(): string
    {
     ...
     * @return $this
     */
    public function setExternalUrlSmall(?string $externalUrlSmall = null)
    {
     ...
     * @return $this
     */
    public function setExternalUrlSmallOrFail(string $externalUrlSmall)
    {
     ...
     * @return string
     */
    public function getExternalUrlSmallOrFail(): string
    {
