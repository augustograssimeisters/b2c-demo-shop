...
class OrderTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const IS_PICKING_LIST_GENERATION_FINISHED = 'isPickingListGenerationFinished';

    /**
     * @var string
     */
    public const IS_PICKING_STARTED = 'isPickingStarted';

    /**
     * @var string
     */
    public const IS_PICKING_FINISHED = 'isPickingFinished';
     ...
     * @var bool|null
     */
    protected $isPickingListGenerationFinished;

    /**
     * @var bool|null
     */
    protected $isPickingStarted;

    /**
     * @var bool|null
     */
    protected $isPickingFinished;
    ...
    protected $transferPropertyNameMap = [
        ...
        'ShipmentMethods' => 'shipmentMethods',
        'is_picking_list_generation_finished' => 'isPickingListGenerationFinished',
        'isPickingListGenerationFinished' => 'isPickingListGenerationFinished',
        'IsPickingListGenerationFinished' => 'isPickingListGenerationFinished',
        'is_picking_started' => 'isPickingStarted',
        'isPickingStarted' => 'isPickingStarted',
        'IsPickingStarted' => 'isPickingStarted',
        'is_picking_finished' => 'isPickingFinished',
    ...
    protected $transferMetadata = [
        ...
        self::IS_PICKING_LIST_GENERATION_FINISHED => [
            'type' => 'bool',
            'type_shim' => null,
            'name_underscore' => 'is_picking_list_generation_finished',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
        ...
        self::IS_PICKING_STARTED => [
            'type' => 'bool',
            'type_shim' => null,
            'name_underscore' => 'is_picking_started',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
        ...
        self::IS_PICKING_FINISHED => [
            'type' => 'bool',
            'type_shim' => null,
            'name_underscore' => 'is_picking_finished',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module CustomerPage|CustomerReorderWidget|SalesReturnPage|Checkout|Discount|DummyPayment|GiftCard|Oms|OrderCustomReferenceGui|OrderCustomReference|OrdersRestApi|Payment|PickingList|ProductBundle|ProductOption|Refund|SalesInvoice|SalesPayment|SalesProductConnector|SalesReclamationGui|SalesReclamation|SalesReturnGui|Sales|ShipmentGui|Shipment|TaxApp
     *
    ...
    /**
     * @module CustomerPage|GiftCardMailConnector|Oms|SalesInvoice|SalesReclamation|SalesReturnGui|Sales
     *
    ...
    /**
     * @module CustomerPage|CustomerReorderWidget|SalesReturnPage|CartNotesBackendApi|DiscountCalculationConnector|Oms|OrdersRestApi|Payment|SalesOrdersBackendApi|SalesPaymentDetail|SalesPayment|SalesReclamationGui|SalesReturnGui|Sales|Shipment
     *
    ...
    /**
     * @module CustomerPage|CustomerReorderWidget|Checkout|Customer|Oms|SalesReturnGui|Sales|ShipmentGui
     *
    ...
    /**
     * @module CustomerPage|CustomerReorderWidget|SalesConfigurableBundleWidget|SalesReturnPage|Checkout|Discount|DummyPayment|Oms|OrdersRestApi|PickingList|ProductBundle|ProductOption|ProductWarehouseAllocationExample|Refund|SalesConfigurableBundle|SalesOrdersBackendApi|SalesPayment|SalesProductConfiguration|SalesProductConnector|SalesReclamationGui|SalesReclamation|SalesReturnGui|SalesReturn|Sales|ShipmentGui|Shipment|ShipmentsRestApi|TaxApp|WarehouseAllocation
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Oms|Sales
     *
    ...
    /**
     * @module CustomerPage|OrderCancelWidget|Customer|GiftCardMailConnector|OrdersRestApi|SalesReclamation|Sales
     *
    ...
    /**
     * @module CustomerPage|Calculation|GiftCardMailConnector|Oms|ProductWarehouseAllocationExample|SalesInvoice|SalesReturnGui|Sales|Shipment|TaxApp
     *
    ...
    /**
     * @module CustomerPage|CartNote|CartNotesBackendApi
     *
    ...
    {
        $this->merchants = new ArrayObject();

        foreach ($merchants as $key => $value) {
            $args = [$value];

            if ($this->transferMetadata[static::MERCHANTS]['is_associative']) {
                $args = [$key, $value];
            }

            $this->addMerchant(...$args);
        }
     ...
     */
    public function getMerchants(): ArrayObject
    {
     ...
     * @module PickingList
     *
     * @param bool|null $isPickingListGenerationFinished
     *
     * @return $this
     */
    public function setIsPickingListGenerationFinished(?bool $isPickingListGenerationFinished = null)
    {
        $this->isPickingListGenerationFinished = $isPickingListGenerationFinished;
        $this->modifiedProperties[self::IS_PICKING_LIST_GENERATION_FINISHED] = true;
     ...
     * @return bool|null
     */
    public function getIsPickingListGenerationFinished(): ?bool
    {
        return $this->isPickingListGenerationFinished;
    }

    /**
     * @module PickingList
     *
     * @param bool $isPickingListGenerationFinished
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setIsPickingListGenerationFinishedOrFail(bool $isPickingListGenerationFinished)
    {
        return $this->setIsPickingListGenerationFinished($isPickingListGenerationFinished);
    }
     ...
     * @return bool
     */
    public function getIsPickingListGenerationFinishedOrFail(): bool
    {
        if ($this->isPickingListGenerationFinished === null) {
            $this->throwNullValueException(static::IS_PICKING_LIST_GENERATION_FINISHED);
        }
     ...
     * @return $this
     */
    public function requireIsPickingListGenerationFinished()
    {
        $this->assertPropertyIsSet(self::IS_PICKING_LIST_GENERATION_FINISHED);
     ...
     * @module PickingList
     *
     * @param bool|null $isPickingStarted
     *
     * @return $this
     */
    public function setIsPickingStarted(?bool $isPickingStarted = null)
    {
        $this->isPickingStarted = $isPickingStarted;
        $this->modifiedProperties[self::IS_PICKING_STARTED] = true;
     ...
     * @return bool|null
     */
    public function getIsPickingStarted(): ?bool
    {
        return $this->isPickingStarted;
    }

    /**
     * @module PickingList
     *
     * @param bool $isPickingStarted
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setIsPickingStartedOrFail(bool $isPickingStarted)
    {
        return $this->setIsPickingStarted($isPickingStarted);
    }
     ...
     * @return bool
     */
    public function getIsPickingStartedOrFail(): bool
    {
        if ($this->isPickingStarted === null) {
            $this->throwNullValueException(static::IS_PICKING_STARTED);
        }
     ...
     * @return $this
     */
    public function requireIsPickingStarted()
    {
        $this->assertPropertyIsSet(self::IS_PICKING_STARTED);
     ...
     * @module PickingList
     *
     * @param bool|null $isPickingFinished
     *
     * @return $this
     */
    public function setIsPickingFinished(?bool $isPickingFinished = null)
    {
        $this->isPickingFinished = $isPickingFinished;
        $this->modifiedProperties[self::IS_PICKING_FINISHED] = true;
     ...
     * @return bool|null
     */
    public function getIsPickingFinished(): ?bool
    {
        return $this->isPickingFinished;
    }

    /**
     * @module PickingList
     *
     * @param bool $isPickingFinished
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setIsPickingFinishedOrFail(bool $isPickingFinished)
    {
        return $this->setIsPickingFinished($isPickingFinished);
    }
     ...
     * @return bool
     */
    public function getIsPickingFinishedOrFail(): bool
    {
        if ($this->isPickingFinished === null) {
            $this->throwNullValueException(static::IS_PICKING_FINISHED);
        }
     ...
     * @return $this
     */
    public function requireIsPickingFinished()
    {
        $this->assertPropertyIsSet(self::IS_PICKING_FINISHED);
    ...
    public function fromArray(array $data, $ignoreMissingProperty = false)
    {
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                ...
                case 'isCancellable':
                case 'itemStates':
                case 'isPickingListGenerationFinished':
                case 'isPickingStarted':
                case 'isPickingFinished':
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'isPickingListGenerationFinished' => $this->isPickingListGenerationFinished,
            'isPickingStarted' => $this->isPickingStarted,
            'isPickingFinished' => $this->isPickingFinished,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'is_picking_list_generation_finished' => $this->isPickingListGenerationFinished,
            'is_picking_started' => $this->isPickingStarted,
            'is_picking_finished' => $this->isPickingFinished,
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'is_picking_list_generation_finished' => $this->isPickingListGenerationFinished instanceof AbstractTransfer ? $this->isPickingListGenerationFinished->toArray(true, false) : $this->isPickingListGenerationFinished,
            'is_picking_started' => $this->isPickingStarted instanceof AbstractTransfer ? $this->isPickingStarted->toArray(true, false) : $this->isPickingStarted,
            'is_picking_finished' => $this->isPickingFinished instanceof AbstractTransfer ? $this->isPickingFinished->toArray(true, false) : $this->isPickingFinished,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'isPickingListGenerationFinished' => $this->isPickingListGenerationFinished instanceof AbstractTransfer ? $this->isPickingListGenerationFinished->toArray(true, true) : $this->isPickingListGenerationFinished,
            'isPickingStarted' => $this->isPickingStarted instanceof AbstractTransfer ? $this->isPickingStarted->toArray(true, true) : $this->isPickingStarted,
            'isPickingFinished' => $this->isPickingFinished instanceof AbstractTransfer ? $this->isPickingFinished->toArray(true, true) : $this->isPickingFinished,
