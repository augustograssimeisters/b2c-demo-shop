 ...
 */
class TaxAppConfigCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const TAX_APP_CONFIG_CONDITIONS = 'taxAppConfigConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\TaxAppConfigConditionsTransfer|null
     */
    protected $taxAppConfigConditions;
    ...
    protected $transferPropertyNameMap = [
        'tax_app_config_conditions' => 'taxAppConfigConditions',
    ...
    protected $transferMetadata = [
        self::TAX_APP_CONFIG_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\TaxAppConfigConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'tax_app_config_conditions',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     * @module TaxApp
     *
     * @param \Generated\Shared\Transfer\TaxAppConfigConditionsTransfer|null $taxAppConfigConditions
     *
     * @return $this
     */
    public function setTaxAppConfigConditions(?TaxAppConfigConditionsTransfer $taxAppConfigConditions = null)
    {
        $this->taxAppConfigConditions = $taxAppConfigConditions;
        $this->modifiedProperties[self::TAX_APP_CONFIG_CONDITIONS] = true;
     ...
     * @module TaxApp
     *
     * @return \Generated\Shared\Transfer\TaxAppConfigConditionsTransfer|null
     */
    public function getTaxAppConfigConditions(): ?TaxAppConfigConditionsTransfer
    {
        return $this->taxAppConfigConditions;
    }

    /**
     * @module TaxApp
     *
     * @param \Generated\Shared\Transfer\TaxAppConfigConditionsTransfer $taxAppConfigConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setTaxAppConfigConditionsOrFail(TaxAppConfigConditionsTransfer $taxAppConfigConditions)
    {
        return $this->setTaxAppConfigConditions($taxAppConfigConditions);
    }
     ...
     */
    public function getTaxAppConfigConditionsOrFail(): TaxAppConfigConditionsTransfer
    {
        if ($this->taxAppConfigConditions === null) {
            $this->throwNullValueException(static::TAX_APP_CONFIG_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requireTaxAppConfigConditions()
    {
        $this->assertPropertyIsSet(self::TAX_APP_CONFIG_CONDITIONS);
    ...
    {
        return [
            'taxAppConfigConditions' => $this->taxAppConfigConditions,
    ...
    {
        return [
            'tax_app_config_conditions' => $this->taxAppConfigConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'tax_app_config_conditions' => $this->taxAppConfigConditions instanceof AbstractTransfer ? $this->taxAppConfigConditions->toArray(true, false) : $this->taxAppConfigConditions,
    ...
    {
        return [
            'taxAppConfigConditions' => $this->taxAppConfigConditions instanceof AbstractTransfer ? $this->taxAppConfigConditions->toArray(true, true) : $this->taxAppConfigConditions,
