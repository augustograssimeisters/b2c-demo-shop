 ...
 */
class UrlCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const URL_CONDITIONS = 'urlConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\UrlConditionsTransfer|null
     */
    protected $urlConditions;
    ...
    protected $transferMetadata = [
        self::URL_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\UrlConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'url_conditions',
            'is_collection' => false,
            'is_transfer' => true,
    ...
    /**
     * @module ProductsBackendApi|Url
     *
     * @param \Generated\Shared\Transfer\UrlConditionsTransfer|null $urlConditions
     *
     * @return $this
     */
    public function setUrlConditions(?UrlConditionsTransfer $urlConditions = null)
    {
        $this->urlConditions = $urlConditions;
        $this->modifiedProperties[self::URL_CONDITIONS] = true;
     ...
     * @module ProductsBackendApi|Url
     *
     * @return \Generated\Shared\Transfer\UrlConditionsTransfer|null
     */
    public function getUrlConditions(): ?UrlConditionsTransfer
    {
     ...
     * @module ProductsBackendApi|Url
     *
     * @param \Generated\Shared\Transfer\UrlConditionsTransfer $urlConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setUrlConditionsOrFail(UrlConditionsTransfer $urlConditions)
    {
        return $this->setUrlConditions($urlConditions);
    }
     ...
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return \Generated\Shared\Transfer\UrlConditionsTransfer
     */
    public function getUrlConditionsOrFail(): UrlConditionsTransfer
    {
        if ($this->urlConditions === null) {
            $this->throwNullValueException(static::URL_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requireUrlConditions()
    {
        $this->assertPropertyIsSet(self::URL_CONDITIONS);
    ...
    {
        return [
            'urlConditions' => $this->urlConditions,
    ...
    {
        return [
            'url_conditions' => $this->urlConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'url_conditions' => $this->urlConditions instanceof AbstractTransfer ? $this->urlConditions->toArray(true, false) : $this->urlConditions,
    ...
    {
        return [
            'urlConditions' => $this->urlConditions instanceof AbstractTransfer ? $this->urlConditions->toArray(true, true) : $this->urlConditions,
