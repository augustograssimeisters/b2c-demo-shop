...
class SpyMimeTypeEntityTransfer extends AbstractEntityTransfer
{
    ...
    public function setExtensions($extensions)
    {
        ...
        $this->modifiedProperties[self::EXTENSIONS] = true;
     ...
     * @return $this
     */
    public function setExtensionsOrFail($extensions)
    {
        if ($extensions === null) {
            $this->throwNullValueException(static::EXTENSIONS);
        }
     ...
     * @return string
     */
    public function getExtensionsOrFail()
    {
    ...
    {
        $this->assertPropertyIsSet(self::EXTENSIONS);
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'extensions' => $this->extensions instanceof AbstractTransfer ? $this->extensions->toArray(true, false) : $this->extensions,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'extensions' => $this->extensions instanceof AbstractTransfer ? $this->extensions->toArray(true, true) : $this->extensions,
