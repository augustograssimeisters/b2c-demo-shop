...
class CartChangeTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CustomerReorderWidget|AvailabilityCartConnector|Cart|DiscountPromotion|PersistentCart|PriceCartConnector|ProductBundle|ProductConfigurationCart|ProductList|ProductOptionCartConnector|ProductQuantity|ShipmentCartConnector|Wishlist
     *
    ...
    /**
     * @module CustomerReorderWidget|AvailabilityCartConnector|Cart|ConfigurableBundleCart|DiscountPromotion|GiftCard|PersistentCart|PriceCartConnector|ProductBundle|ProductCartConnector|ProductConfigurationCart|ProductConfigurationStorage|ProductDiscontinued|ProductImageCartConnector|ProductList|ProductOptionCartConnector|ProductQuantity|SalesQuantity|ShipmentCartConnector|Wishlist
     *
