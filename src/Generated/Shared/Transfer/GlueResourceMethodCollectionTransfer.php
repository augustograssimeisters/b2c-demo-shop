...
class GlueResourceMethodCollectionTransfer extends AbstractTransfer
{
    ...
    /**
     * @module DocumentationGeneratorOpenApi|GlueApplication|PushNotificationsBackendApi|WarehouseUsersBackendApi
     *
    ...
    /**
     * @module DocumentationGeneratorOpenApi|GlueApplication|PickingListsBackendApi|ProductsBackendApi|PushNotificationsBackendApi|StoresApi|WarehouseUsersBackendApi
     *
    ...
    /**
     * @module DocumentationGeneratorOpenApi|GlueApplication|PickingListsBackendApi|ProductsBackendApi|PushNotificationsBackendApi|WarehouseUsersBackendApi
     *
    ...
    /**
     * @module DocumentationGeneratorOpenApi|GlueApplication|OauthApi|OauthBackendApi|PickingListsBackendApi|ProductsBackendApi|PushNotificationsBackendApi|TestifyBackendApi|WarehouseOauthBackendApi|WarehouseUsersBackendApi
     *
     ...
     *
     * @param \Generated\Shared\Transfer\GlueResourceMethodConfigurationTransfer|null $put
     *
     * @return $this
     */
    public function setPut(GlueResourceMethodConfigurationTransfer $put = null)
    {
        $this->put = $put;
        $this->modifiedProperties[self::PUT] = true;
     ...
     * @module GlueApplication
     *
     * @param \Generated\Shared\Transfer\GlueResourceMethodConfigurationTransfer $put
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setPutOrFail(GlueResourceMethodConfigurationTransfer $put)
    {
        return $this->setPut($put);
    }
     ...
     * @return \Generated\Shared\Transfer\GlueResourceMethodConfigurationTransfer
     */
    public function getPutOrFail()
    {
        if ($this->put === null) {
            $this->throwNullValueException(static::PUT);
        }
    ...
    {
        $this->assertPropertyIsSet(self::PUT);
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'put' => $this->put instanceof AbstractTransfer ? $this->put->toArray(true, false) : $this->put,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'put' => $this->put instanceof AbstractTransfer ? $this->put->toArray(true, true) : $this->put,
        ];
    }
}
