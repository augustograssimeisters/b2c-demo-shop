 ...
 */
class PushNotificationGroupCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\PushNotificationGroupTransfer>
     */
    protected $groups;
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\PushNotificationGroupTransfer> $groups
     *
     * @return $this
     */
    public function setGroups(ArrayObject $groups)
    {
        ...
        foreach ($groups as $key => $value) {
            ...
            if ($this->transferMetadata[static::GROUPS]['is_associative']) {
                $args = [$key, $value];
            }
     ...
     * @module PushNotification
     *
     * @return \ArrayObject<\Generated\Shared\Transfer\PushNotificationGroupTransfer>
     */
     ...
     * @return $this
     */
    public function addGroup(PushNotificationGroupTransfer $group)
    {
        $this->groups[] = $group;
        $this->modifiedProperties[self::GROUPS] = true;
