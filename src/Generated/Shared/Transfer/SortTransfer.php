...
class SortTransfer extends AbstractTransfer
{
    ...
    /**
     * @module Category|Currency|GlueApplication|GlueJsonApiConvention|PickingList|ProductConfiguration|ProductImage|ProductLabelDiscountConnector|ProductLabelSearch|ProductLabelStorage|ProductLabel|ProductSearchConfigStorage|ProductSearch|Product|PushNotification|ShipmentType|Shipment|TaxApp|Url|WarehouseUser
     *
