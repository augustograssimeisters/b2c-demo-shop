 ...
 */
class ShipmentMethodCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const SHIPMENT_METHOD_CONDITIONS = 'shipmentMethodConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\ShipmentMethodConditionsTransfer|null
     */
    protected $shipmentMethodConditions;
    ...
    protected $transferPropertyNameMap = [
        'shipment_method_conditions' => 'shipmentMethodConditions',
        'shipmentMethodConditions' => 'shipmentMethodConditions',
        'ShipmentMethodConditions' => 'shipmentMethodConditions',
    ...
    protected $transferMetadata = [
        self::SHIPMENT_METHOD_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\ShipmentMethodConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'shipment_method_conditions',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     *
     * @param \Generated\Shared\Transfer\ShipmentMethodConditionsTransfer|null $shipmentMethodConditions
     *
     * @return $this
     */
    public function setShipmentMethodConditions(?ShipmentMethodConditionsTransfer $shipmentMethodConditions = null)
    {
        $this->shipmentMethodConditions = $shipmentMethodConditions;
        $this->modifiedProperties[self::SHIPMENT_METHOD_CONDITIONS] = true;
     ...
     * @module ShipmentTypeStorage|Shipment
     *
     * @return \Generated\Shared\Transfer\ShipmentMethodConditionsTransfer|null
     */
    public function getShipmentMethodConditions(): ?ShipmentMethodConditionsTransfer
    {
        return $this->shipmentMethodConditions;
    }

    /**
     * @module ShipmentTypeStorage|Shipment
     *
     * @param \Generated\Shared\Transfer\ShipmentMethodConditionsTransfer $shipmentMethodConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setShipmentMethodConditionsOrFail(ShipmentMethodConditionsTransfer $shipmentMethodConditions)
    {
        return $this->setShipmentMethodConditions($shipmentMethodConditions);
    }
     ...
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return \Generated\Shared\Transfer\ShipmentMethodConditionsTransfer
     */
    public function getShipmentMethodConditionsOrFail(): ShipmentMethodConditionsTransfer
    {
        if ($this->shipmentMethodConditions === null) {
            $this->throwNullValueException(static::SHIPMENT_METHOD_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requireShipmentMethodConditions()
    {
        $this->assertPropertyIsSet(self::SHIPMENT_METHOD_CONDITIONS);
    ...
    {
        return [
            'shipmentMethodConditions' => $this->shipmentMethodConditions,
    ...
    {
        return [
            'shipment_method_conditions' => $this->shipmentMethodConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'shipment_method_conditions' => $this->shipmentMethodConditions instanceof AbstractTransfer ? $this->shipmentMethodConditions->toArray(true, false) : $this->shipmentMethodConditions,
    ...
    {
        return [
            'shipmentMethodConditions' => $this->shipmentMethodConditions instanceof AbstractTransfer ? $this->shipmentMethodConditions->toArray(true, true) : $this->shipmentMethodConditions,
