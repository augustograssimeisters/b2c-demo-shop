 ...
 */
class CartPreCheckResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module AvailabilityCartConnector|Cart|ConfigurableBundleCart|DiscountPromotion|PriceCartConnector|ProductBundle|ProductCartConnector|ProductDiscontinued|ProductList|ProductOptionCartConnector|ProductQuantity|ShipmentCartConnector
     *
