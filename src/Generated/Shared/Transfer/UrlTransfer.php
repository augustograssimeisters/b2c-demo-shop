...
class UrlTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CategoryDataImport|CategoryGui|Category|CmsGui|Cms|NavigationGui|ProductCartConnector|ProductSetGui|ProductSet|Product|ProductsBackendApi|UrlStorage|Url
     *
    ...
    /**
     * @module Category|Cms|NavigationGui|ProductSet|Product|ProductsBackendApi|Url
     *
    ...
    /**
     * @module Category|Cms|NavigationGui|Navigation|ProductSet|Product|Url
     *
    ...
    /**
     * @module ProductCartConnector|Product|ProductsBackendApi
     *
