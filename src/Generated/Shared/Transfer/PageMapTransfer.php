...
class PageMapTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CategoryPageSearch|CmsPageSearch|ProductPageSearch|ProductSetPageSearch|Search
     *
    ...
    /**
     * @module CategoryPageSearch|CmsPageSearch|ConfigurableBundlePageSearch|ProductPageSearch|ProductSetPageSearch|Search
     *
    ...
    /**
     * @module CategoryPageSearch|CmsPageSearch|ProductPageSearch|Search
     *
    ...
    /**
     * @module ConfigurableBundlePageSearch|ProductPageSearch|Search
     *
     ...
     *
     * @param \Generated\Shared\Transfer\ProductListMapTransfer|null $productLists
     *
     * @return $this
     */
    public function setProductLists(ProductListMapTransfer $productLists = null)
    {
     ...
     * @module ProductListSearch
     *
     * @param \Generated\Shared\Transfer\ProductListMapTransfer $productLists
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setProductListsOrFail(ProductListMapTransfer $productLists)
    {
        return $this->setProductLists($productLists);
    }
     ...
     */
    public function getProductListsOrFail()
    {
        if ($this->productLists === null) {
            $this->throwNullValueException(static::PRODUCT_LISTS);
        }
    ...
    /**
     * @module ProductPageSearch|Search
     *
