...
class SpySalesPaymentEntityTransfer extends AbstractEntityTransfer
{
     ...
     * @var string
     */
    public const SPY_PAYMENT_GIFT_CARDS = 'spyPaymentGiftCards';
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\SpyPaymentGiftCardEntityTransfer>
     */
    protected $spyPaymentGiftCards;
    ...
    protected $transferPropertyNameMap = [
        ...
        'SalesPaymentMethodType' => 'salesPaymentMethodType',
        'spy_payment_gift_cards' => 'spyPaymentGiftCards',
        'spyPaymentGiftCards' => 'spyPaymentGiftCards',
        'SpyPaymentGiftCards' => 'spyPaymentGiftCards',
    ];
    ...
    protected $transferMetadata = [
        ...
        self::SPY_PAYMENT_GIFT_CARDS => [
            'type' => 'Generated\Shared\Transfer\SpyPaymentGiftCardEntityTransfer',
            'type_shim' => null,
            'name_underscore' => 'spy_payment_gift_cards',
            'is_collection' => true,
            'is_transfer' => true,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
     ...
     * @module 
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\SpyPaymentGiftCardEntityTransfer> $spyPaymentGiftCards
     *
     * @return $this
     */
    public function setSpyPaymentGiftCards(ArrayObject $spyPaymentGiftCards)
    {
        $this->spyPaymentGiftCards = $spyPaymentGiftCards;
        $this->modifiedProperties[self::SPY_PAYMENT_GIFT_CARDS] = true;
     ...
     * @module 
     *
     * @return \ArrayObject<\Generated\Shared\Transfer\SpyPaymentGiftCardEntityTransfer>
     */
    public function getSpyPaymentGiftCards()
    {
        return $this->spyPaymentGiftCards;
    }

    /**
     * @module 
     *
     * @param \Generated\Shared\Transfer\SpyPaymentGiftCardEntityTransfer $spyPaymentGiftCards
     *
     * @return $this
     */
    public function addSpyPaymentGiftCards(SpyPaymentGiftCardEntityTransfer $spyPaymentGiftCards)
    {
        $this->spyPaymentGiftCards[] = $spyPaymentGiftCards;
        $this->modifiedProperties[self::SPY_PAYMENT_GIFT_CARDS] = true;
     ...
     * @return $this
     */
    public function requireSpyPaymentGiftCards()
    {
        $this->assertCollectionPropertyIsSet(self::SPY_PAYMENT_GIFT_CARDS);
    ...
    {
        $this->spyPaymentGiftCards = $this->spyPaymentGiftCards ?: new ArrayObject();
    }
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'spyPaymentGiftCards' => $this->spyPaymentGiftCards,
        ];
    }
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'spy_payment_gift_cards' => $this->spyPaymentGiftCards,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'spy_payment_gift_cards' => $this->spyPaymentGiftCards instanceof AbstractTransfer ? $this->spyPaymentGiftCards->toArray(true, false) : $this->addValuesToCollection($this->spyPaymentGiftCards, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'spyPaymentGiftCards' => $this->spyPaymentGiftCards instanceof AbstractTransfer ? $this->spyPaymentGiftCards->toArray(true, true) : $this->addValuesToCollection($this->spyPaymentGiftCards, true, true),
        ];
    }
}
