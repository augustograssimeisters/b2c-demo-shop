...
class EventEntityTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AssetStorage|Asset|CmsSlotBlockStorage|CmsSlotBlock|EventBehavior
     *
    ...
    /**
     * @module AssetStorage|Asset|Category|CmsBlock|CmsSlotBlockStorage|CmsSlotBlock|ConfigurableBundle|CustomerStorage|DataImport|EventBehavior|PriceProduct|ProductCategory|ProductLabel|ProductOption|ProductSearch|Product|StoreContextStorage
     *
     * @param int|null $id
     *
     * @return $this
    ...
    /**
     * @module AssetStorage|EventBehavior|ProductCategory|ProductLabel|ProductOption|ProductReview|ProductSearch|Product
     *
    ...
    /**
     * @module CustomerStorage|EventBehavior|ProductPageSearch|ProductStorage
     *
    ...
    /**
     * @module EventBehavior|ProductCategory|ProductLabel|Product
     *
