 ...
 */
class ProductConcreteCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module Product|ProductsBackendApi
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\ProductConcreteTransfer> $products
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function addProduct(ProductConcreteTransfer $product)
    {
