...
class SpyPaymentMethodEntityTransfer extends AbstractEntityTransfer
{
     ...
     * @module 
     *
     * @param string|null $paymentMethodAppConfiguration
     *
     * @return $this
     */
    public function setPaymentMethodAppConfiguration($paymentMethodAppConfiguration)
    {
     ...
     * @return $this
     */
    public function setPaymentMethodAppConfigurationOrFail($paymentMethodAppConfiguration)
    {
        if ($paymentMethodAppConfiguration === null) {
