 ...
 */
class SpyStoreContextEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
    public const ID_STORE_CONTEXT = 'idStoreContext';
    ...
    protected $transferPropertyNameMap = [
        'id_store_context' => 'idStoreContext',
        'idStoreContext' => 'idStoreContext',
        'IdStoreContext' => 'idStoreContext',
        'fk_store' => 'fkStore',
        'fkStore' => 'fkStore',
        'FkStore' => 'fkStore',
    ...
    protected $transferMetadata = [
        self::ID_STORE_CONTEXT => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'id_store_context',
            'is_collection' => false,
            'is_transfer' => false,
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\StoreContext\Persistence\SpyStoreContext';


    /**
     * @module 
     *
     * @param integer|null $idStoreContext
     *
     * @return $this
     */
    public function setIdStoreContext($idStoreContext)
    {
        $this->idStoreContext = $idStoreContext;
        $this->modifiedProperties[self::ID_STORE_CONTEXT] = true;
     ...
     * @return $this
     */
    public function setIdStoreContextOrFail($idStoreContext)
    {
        if ($idStoreContext === null) {
            $this->throwNullValueException(static::ID_STORE_CONTEXT);
        }

        return $this->setIdStoreContext($idStoreContext);
    }
     ...
     * @return integer
     */
    public function getIdStoreContextOrFail()
    {
        if ($this->idStoreContext === null) {
            $this->throwNullValueException(static::ID_STORE_CONTEXT);
        }
     ...
     * @return $this
     */
    public function requireIdStoreContext()
    {
        $this->assertPropertyIsSet(self::ID_STORE_CONTEXT);
     ...
     * @module 
     *
     * @param string|null $applicationContextCollection
     *
     * @return $this
     */
    public function setApplicationContextCollection($applicationContextCollection)
    {
     ...
     * @return $this
     */
    public function setApplicationContextCollectionOrFail($applicationContextCollection)
    {
        if ($applicationContextCollection === null) {
     ...
     * @return string
     */
    public function getApplicationContextCollectionOrFail()
    {
    ...
    {
        return [
            'idStoreContext' => $this->idStoreContext,
    ...
    {
        return [
            'id_store_context' => $this->idStoreContext,
    ...
    {
        return [
            'id_store_context' => $this->idStoreContext instanceof AbstractTransfer ? $this->idStoreContext->toArray(true, false) : $this->idStoreContext,
    ...
    {
        return [
            'idStoreContext' => $this->idStoreContext instanceof AbstractTransfer ? $this->idStoreContext->toArray(true, true) : $this->idStoreContext,
