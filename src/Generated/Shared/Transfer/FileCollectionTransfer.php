 ...
 */
class FileCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\FileTransfer>
     */
    protected $files;
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\FileTransfer> $files
     *
     * @return $this
     */
    public function setFiles(ArrayObject $files)
    {
        ...
        foreach ($files as $key => $value) {
            ...
            if ($this->transferMetadata[static::FILES]['is_associative']) {
                $args = [$key, $value];
            }
        ...
        $this->modifiedProperties[self::FILES] = true;
     ...
     * @return $this
     */
    public function addFile(FileTransfer $file)
    {
        $this->files[] = $file;
        $this->modifiedProperties[self::FILES] = true;
    ...
    {
        $this->assertCollectionPropertyIsSet(self::FILES);
    ...
    {
        $this->files = $this->files ?: new ArrayObject();
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'files' => $this->files instanceof AbstractTransfer ? $this->files->toArray(true, false) : $this->addValuesToCollection($this->files, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'files' => $this->files instanceof AbstractTransfer ? $this->files->toArray(true, true) : $this->addValuesToCollection($this->files, true, true),
        ];
    }
}
