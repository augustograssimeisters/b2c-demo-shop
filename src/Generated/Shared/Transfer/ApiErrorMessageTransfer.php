 ...
 */
class ApiErrorMessageTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @return $this
     */
    public function setStatusOrFail(int $status)
    {
     ...
     * @return int
     */
    public function getStatusOrFail(): int
    {
        if ($this->status === null) {
     ...
     * @return $this
     */
    public function setCodeOrFail(string $code)
    {
     ...
     * @return string
     */
    public function getCodeOrFail(): string
    {
        if ($this->code === null) {
     ...
     * @return $this
     */
    public function setDetailOrFail(string $detail)
    {
     ...
     * @return string
     */
    public function getDetailOrFail(): string
    {
        if ($this->detail === null) {
