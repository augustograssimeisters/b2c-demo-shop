...
class SalesPaymentTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const FK_PAYMENT_METHOD_TYPE = 'fkPaymentMethodType';
    ...
    protected $transferPropertyNameMap = [
        ...
        'IdSalesPayment' => 'idSalesPayment',
        'fk_payment_method_type' => 'fkPaymentMethodType',
        'fkPaymentMethodType' => 'fkPaymentMethodType',
        'FkPaymentMethodType' => 'fkPaymentMethodType',
        'amount' => 'amount',
        'Amount' => 'amount',
    ];
    ...
    protected $transferMetadata = [
        ...
        self::FK_PAYMENT_METHOD_TYPE => [
            'type' => 'int',
            'type_shim' => null,
            'name_underscore' => 'fk_payment_method_type',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
     ...
     * @module SalesPayment
     *
     * @param int|null $fkPaymentMethodType
     *
     * @return $this
     */
    public function setFkPaymentMethodType($fkPaymentMethodType)
    {
        $this->fkPaymentMethodType = $fkPaymentMethodType;
        $this->modifiedProperties[self::FK_PAYMENT_METHOD_TYPE] = true;
     ...
     * @return int|null
     */
    public function getFkPaymentMethodType()
    {
     ...
     * @return $this
     */
    public function setFkPaymentMethodTypeOrFail($fkPaymentMethodType)
    {
        if ($fkPaymentMethodType === null) {
            $this->throwNullValueException(static::FK_PAYMENT_METHOD_TYPE);
        }

        return $this->setFkPaymentMethodType($fkPaymentMethodType);
    }
     ...
     * @return int
     */
    public function getFkPaymentMethodTypeOrFail()
    {
        if ($this->fkPaymentMethodType === null) {
            $this->throwNullValueException(static::FK_PAYMENT_METHOD_TYPE);
        }
     ...
     * @return $this
     */
    public function requireFkPaymentMethodType()
    {
        $this->assertPropertyIsSet(self::FK_PAYMENT_METHOD_TYPE);
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'fkPaymentMethodType' => $this->fkPaymentMethodType,
            'amount' => $this->amount,
        ];
    }
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'fk_payment_method_type' => $this->fkPaymentMethodType,
            'amount' => $this->amount,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'fk_payment_method_type' => $this->fkPaymentMethodType instanceof AbstractTransfer ? $this->fkPaymentMethodType->toArray(true, false) : $this->fkPaymentMethodType,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'fkPaymentMethodType' => $this->fkPaymentMethodType instanceof AbstractTransfer ? $this->fkPaymentMethodType->toArray(true, true) : $this->fkPaymentMethodType,
