...
class SpyCustomerEntityTransfer extends AbstractEntityTransfer
{
     ...
     * @var string
     */
    public const SPY_WISHLISTS = 'spyWishlists';
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\SpyWishlistEntityTransfer>
     */
    protected $spyWishlists;
    ...
    protected $transferPropertyNameMap = [
        ...
        'SpyCustomerAddresses' => 'spyCustomerAddresses',
        'spy_wishlists' => 'spyWishlists',
        'spyWishlists' => 'spyWishlists',
        'SpyWishlists' => 'spyWishlists',
     ...
     * @module 
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\SpyWishlistEntityTransfer> $spyWishlists
     *
     * @return $this
     */
    public function setSpyWishlists(ArrayObject $spyWishlists)
    {
        $this->spyWishlists = $spyWishlists;
        $this->modifiedProperties[self::SPY_WISHLISTS] = true;
     ...
     * @module 
     *
     * @return \ArrayObject<\Generated\Shared\Transfer\SpyWishlistEntityTransfer>
     */
    public function getSpyWishlists()
    {
        return $this->spyWishlists;
    }

    /**
     * @module 
     *
     * @param \Generated\Shared\Transfer\SpyWishlistEntityTransfer $spyWishlists
     *
     * @return $this
     */
    public function addSpyWishlists(SpyWishlistEntityTransfer $spyWishlists)
    {
        $this->spyWishlists[] = $spyWishlists;
        $this->modifiedProperties[self::SPY_WISHLISTS] = true;
     ...
     * @return $this
     */
    public function requireSpyWishlists()
    {
        $this->assertCollectionPropertyIsSet(self::SPY_WISHLISTS);
    ...
    protected function initCollectionProperties(): void
    {
        ...
        $this->spyWishlists = $this->spyWishlists ?: new ArrayObject();
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'spyWishlists' => $this->spyWishlists,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'spy_wishlists' => $this->spyWishlists,
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'spy_wishlists' => $this->spyWishlists instanceof AbstractTransfer ? $this->spyWishlists->toArray(true, false) : $this->addValuesToCollection($this->spyWishlists, true, false),
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'spyWishlists' => $this->spyWishlists instanceof AbstractTransfer ? $this->spyWishlists->toArray(true, true) : $this->addValuesToCollection($this->spyWishlists, true, true),
