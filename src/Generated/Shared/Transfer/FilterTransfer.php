...
class FilterTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CustomerPage|SalesReturnPage|AssetStorage|CategoryImageStorage|CategoryPageSearch|CategoryStorage|CmsSlotBlockGui|CmsSlotBlockStorage|CmsSlotBlock|CmsSlotStorage|CmsSlot|ConfigurableBundlePageSearch|ConfigurableBundleStorage|ConfigurableBundle|ContentStorage|CustomerAccessStorage|FileManagerStorage|GlossaryStorage|Kernel|OrdersRestApi|PriceProductSchedule|ProductAlternativeStorage|ProductAttribute|ProductAttributesRestApi|ProductBundleStorage|ProductBundle|ProductCategoryStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductLabelStorage|ProductLabel|ProductListStorage|ProductPageSearch|ProductQuantityStorage|ProductRelationStorage|ProductRelation|ProductReview|ProductReviewsRestApi|Propel|SalesInvoice|SalesReturnSearch|SalesReturn|SalesReturnsRestApi|Sales|SearchHttp|ShipmentTypeStorage|TaxProductStorage
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|AssetStorage|CategoryImageStorage|CategoryPageSearch|CategoryStorage|CmsSlotBlockStorage|CmsSlotBlock|CmsSlotStorage|CmsSlot|ConfigurableBundlePageSearch|ConfigurableBundleStorage|ConfigurableBundle|ContentStorage|CustomerAccessStorage|FileManagerStorage|GlossaryStorage|Kernel|OrdersRestApi|ProductAlternativeStorage|ProductAttribute|ProductAttributesRestApi|ProductBundleStorage|ProductBundle|ProductCategoryStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductLabelStorage|ProductLabel|ProductListStorage|ProductPageSearch|ProductQuantityStorage|ProductRelationStorage|ProductRelation|ProductReview|ProductReviewsRestApi|Propel|SalesInvoice|SalesReturnSearch|SalesReturn|SalesReturnsRestApi|Sales|SearchHttp|ShipmentTypeStorage|TaxProductStorage
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|CategoryPageSearch|CategoryStorage|CmsSlotBlockGui|CmsSlotBlockStorage|CmsSlotBlock|CmsSlotStorage|CmsSlot|ConfigurableBundleStorage|ConfigurableBundle|CustomerAccessStorage|FileManagerStorage|GlossaryStorage|Kernel|OrdersRestApi|ProductAttribute|ProductAttributesRestApi|ProductBundleStorage|ProductBundle|ProductCategoryStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductLabelStorage|ProductListStorage|ProductPageSearch|ProductQuantityStorage|ProductRelationStorage|Propel|SalesInvoice|SalesReturn|Sales|TaxProductStorage
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|CmsSlotBlock|FileManagerStorage|Kernel|OrdersRestApi|ProductAttribute|ProductAttributesRestApi|Propel|SalesInvoice|SalesReturn|Sales
     *
