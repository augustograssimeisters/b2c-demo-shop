 ...
 */
class RestNavigationAttributesTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\RestNavigationNodeTransfer> $nodes
     *
     * @return $this
     */
     ...
     * @module NavigationsCategoryNodesResourceRelationship|NavigationsRestApi
     *
     * @param \Generated\Shared\Transfer\RestNavigationNodeTransfer $node
     *
     * @return $this
     */
    public function addNode(RestNavigationNodeTransfer $node)
    {
        $this->nodes[] = $node;
        $this->modifiedProperties[self::NODES] = true;
