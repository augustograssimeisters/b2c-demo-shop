...
class PaymentMethodTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const PAYMENT_METHOD_APP_CONFIGURATION = 'paymentMethodAppConfiguration';
    ...
    /**
     * @var \Generated\Shared\Transfer\PaymentMethodAppConfigurationTransfer|null
     */
    protected $paymentMethodAppConfiguration;
    ...
    protected $transferPropertyNameMap = [
        ...
        'LastMessageTimestamp' => 'lastMessageTimestamp',
        'payment_method_app_configuration' => 'paymentMethodAppConfiguration',
    ...
    protected $transferMetadata = [
        ...
        self::PAYMENT_METHOD_APP_CONFIGURATION => [
            'type' => 'Generated\Shared\Transfer\PaymentMethodAppConfigurationTransfer',
            'type_shim' => null,
            'name_underscore' => 'payment_method_app_configuration',
            'is_collection' => false,
            'is_transfer' => true,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module CheckoutPage|PaymentPage|CheckoutRestApi|GiftCard|Nopayment|Payment|PaymentsRestApi
     *
     * @deprecated Use paymentMethodKey instead.
     *
     ...
     * @module Payment
     *
     * @param \Generated\Shared\Transfer\PaymentMethodAppConfigurationTransfer|null $paymentMethodAppConfiguration
     *
     * @return $this
     */
    public function setPaymentMethodAppConfiguration(PaymentMethodAppConfigurationTransfer $paymentMethodAppConfiguration = null)
    {
        $this->paymentMethodAppConfiguration = $paymentMethodAppConfiguration;
        $this->modifiedProperties[self::PAYMENT_METHOD_APP_CONFIGURATION] = true;
     ...
     * @module Payment
     *
     * @return \Generated\Shared\Transfer\PaymentMethodAppConfigurationTransfer|null
     */
    public function getPaymentMethodAppConfiguration()
    {
        return $this->paymentMethodAppConfiguration;
    }

    /**
     * @module Payment
     *
     * @param \Generated\Shared\Transfer\PaymentMethodAppConfigurationTransfer $paymentMethodAppConfiguration
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setPaymentMethodAppConfigurationOrFail(PaymentMethodAppConfigurationTransfer $paymentMethodAppConfiguration)
    {
        return $this->setPaymentMethodAppConfiguration($paymentMethodAppConfiguration);
    }
     ...
     */
    public function getPaymentMethodAppConfigurationOrFail()
    {
        if ($this->paymentMethodAppConfiguration === null) {
            $this->throwNullValueException(static::PAYMENT_METHOD_APP_CONFIGURATION);
        }
     ...
     * @return $this
     */
    public function requirePaymentMethodAppConfiguration()
    {
        $this->assertPropertyIsSet(self::PAYMENT_METHOD_APP_CONFIGURATION);
    ...
    public function fromArray(array $data, $ignoreMissingProperty = false)
    {
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                ...
                case 'storeRelation':
                case 'paymentMethodAppConfiguration':
                    if (is_array($value)) {
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'paymentMethodAppConfiguration' => $this->paymentMethodAppConfiguration,
        ];
    }
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'payment_method_app_configuration' => $this->paymentMethodAppConfiguration,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'payment_method_app_configuration' => $this->paymentMethodAppConfiguration instanceof AbstractTransfer ? $this->paymentMethodAppConfiguration->toArray(true, false) : $this->paymentMethodAppConfiguration,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'paymentMethodAppConfiguration' => $this->paymentMethodAppConfiguration instanceof AbstractTransfer ? $this->paymentMethodAppConfiguration->toArray(true, true) : $this->paymentMethodAppConfiguration,
        ];
    }
}
