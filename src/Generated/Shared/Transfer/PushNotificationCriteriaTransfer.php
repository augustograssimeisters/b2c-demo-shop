 ...
 */
class PushNotificationCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const PUSH_NOTIFICATION_CONDITIONS = 'pushNotificationConditions';
    ...
    /**
     * @var \Generated\Shared\Transfer\PushNotificationConditionsTransfer|null
     */
    protected $pushNotificationConditions;
    ...
    protected $transferPropertyNameMap = [
        'push_notification_conditions' => 'pushNotificationConditions',
    ...
    protected $transferMetadata = [
        self::PUSH_NOTIFICATION_CONDITIONS => [
            'type' => 'Generated\Shared\Transfer\PushNotificationConditionsTransfer',
            'type_shim' => null,
            'name_underscore' => 'push_notification_conditions',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     *
     * @param \Generated\Shared\Transfer\PushNotificationConditionsTransfer|null $pushNotificationConditions
     *
     * @return $this
     */
    public function setPushNotificationConditions(?PushNotificationConditionsTransfer $pushNotificationConditions = null)
    {
        $this->pushNotificationConditions = $pushNotificationConditions;
        $this->modifiedProperties[self::PUSH_NOTIFICATION_CONDITIONS] = true;
     ...
     * @module PushNotification
     *
     * @return \Generated\Shared\Transfer\PushNotificationConditionsTransfer|null
     */
    public function getPushNotificationConditions(): ?PushNotificationConditionsTransfer
    {
        return $this->pushNotificationConditions;
    }

    /**
     * @module PushNotification
     *
     * @param \Generated\Shared\Transfer\PushNotificationConditionsTransfer $pushNotificationConditions
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setPushNotificationConditionsOrFail(PushNotificationConditionsTransfer $pushNotificationConditions)
    {
        return $this->setPushNotificationConditions($pushNotificationConditions);
    }
     ...
     */
    public function getPushNotificationConditionsOrFail(): PushNotificationConditionsTransfer
    {
        if ($this->pushNotificationConditions === null) {
            $this->throwNullValueException(static::PUSH_NOTIFICATION_CONDITIONS);
        }
     ...
     * @return $this
     */
    public function requirePushNotificationConditions()
    {
        $this->assertPropertyIsSet(self::PUSH_NOTIFICATION_CONDITIONS);
    ...
    public function fromArray(array $data, $ignoreMissingProperty = false)
    {
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                case 'pushNotificationConditions':
                case 'pagination':
                    if (is_array($value)) {
    ...
    {
        return [
            'pushNotificationConditions' => $this->pushNotificationConditions,
    ...
    {
        return [
            'push_notification_conditions' => $this->pushNotificationConditions,
            'pagination' => $this->pagination,
    ...
    {
        return [
            'push_notification_conditions' => $this->pushNotificationConditions instanceof AbstractTransfer ? $this->pushNotificationConditions->toArray(true, false) : $this->pushNotificationConditions,
    ...
    {
        return [
            'pushNotificationConditions' => $this->pushNotificationConditions instanceof AbstractTransfer ? $this->pushNotificationConditions->toArray(true, true) : $this->pushNotificationConditions,
