...
class SaveOrderTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CustomerPage|CartNote|Discount|GiftCardBalance|OrderCustomReference|Payment|ProductOption|SalesOrderThreshold|SalesPayment|Sales|Shipment
     *
    ...
    /**
     * @module CustomerPage|Checkout|Discount|Oms|ProductBundle|ProductOption|SalesShipmentType|Sales|Shipment
     *
