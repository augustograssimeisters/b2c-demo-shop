 ...
 */
class SalesPaymentConditionsTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @module SalesPayment
     *
     * @param array|null $salesOrderIds
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function addIdSalesOrder($idSalesOrder)
    {
        $this->salesOrderIds[] = $idSalesOrder;
        $this->modifiedProperties[self::SALES_ORDER_IDS] = true;
