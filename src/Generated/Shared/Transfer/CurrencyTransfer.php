...
class CurrencyTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CurrencyWidget|MoneyWidget|PriceProductVolumeWidget|CartCurrencyConnector|CartsRestApi|CatalogPriceProductConnector|CheckoutRestApi|ConfigurableBundleCartsRestApi|CurrencyGui|Currency|Discount|GiftCard|Money|Payment|PriceCartConnector|PriceProductScheduleGui|PriceProductSchedule|PriceProductStorage|PriceProduct|ProductBundle|ProductConfigurationStorage|ProductConfiguration|ProductManagement|ProductOptionCartConnector|ProductOptionStorage|ProductOption|ProductOptionsRestApi|Quote|SalesOrderThresholdGui|SalesOrderThreshold|Sales|ShipmentCartConnector|Shipment|ShipmentsRestApi|ZedRequest
     *
    ...
    /**
     * @module MoneyWidget|Currency|MoneyGui|Money
     *
    ...
    /**
     * @module CurrencyGui|Currency|Discount|PriceProduct|ProductConfigurationsPriceProductVolumesRestApi|SalesOrderThresholdGui
     *
    ...
    /**
     * @module Currency|MoneyGui|Money|PriceProductScheduleGui|PriceProductSchedule|PriceProductVolumeGui|PriceProduct|ProductManagement|ProductOption|SalesOrderThresholdGui|SalesOrderThreshold|Shipment
     *
