 ...
 */
class DiscountConfiguratorResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const DISCOUNT_CONFIGURATOR = 'discountConfigurator';
    ...
    protected $transferPropertyNameMap = [
        'discount_configurator' => 'discountConfigurator',
    ...
    protected $transferMetadata = [
        self::DISCOUNT_CONFIGURATOR => [
            'type' => 'Generated\Shared\Transfer\DiscountConfiguratorTransfer',
            'type_shim' => null,
            'name_underscore' => 'discount_configurator',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     * @return $this
     */
    public function setDiscountConfigurator(DiscountConfiguratorTransfer $discountConfigurator = null)
    {
        $this->discountConfigurator = $discountConfigurator;
        $this->modifiedProperties[self::DISCOUNT_CONFIGURATOR] = true;
     ...
     */
    public function getDiscountConfigurator()
    {
        return $this->discountConfigurator;
    }
     ...
     * @return $this
     */
    public function setDiscountConfiguratorOrFail(DiscountConfiguratorTransfer $discountConfigurator)
    {
        return $this->setDiscountConfigurator($discountConfigurator);
    }
     ...
     */
    public function getDiscountConfiguratorOrFail()
    {
        if ($this->discountConfigurator === null) {
            $this->throwNullValueException(static::DISCOUNT_CONFIGURATOR);
        }
     ...
     * @return $this
     */
    public function requireDiscountConfigurator()
    {
        $this->assertPropertyIsSet(self::DISCOUNT_CONFIGURATOR);
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'discountConfigurator' => $this->discountConfigurator,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'discount_configurator' => $this->discountConfigurator,
            'messages' => $this->messages,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'discount_configurator' => $this->discountConfigurator instanceof AbstractTransfer ? $this->discountConfigurator->toArray(true, false) : $this->discountConfigurator,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'discountConfigurator' => $this->discountConfigurator instanceof AbstractTransfer ? $this->discountConfigurator->toArray(true, true) : $this->discountConfigurator,
