...
class ProductViewTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const PRODUCT_SET_IDS = 'productSetIds';
    ...
    protected $transferMetadata = [
        ...
        self::PRODUCT_SET_IDS => [
            'type' => 'array',
            'type_shim' => null,
            'name_underscore' => 'product_set_ids',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module AvailabilityNotificationWidget|CartPage|ConfigurableBundlePage|ContentProductWidget|ProductBarcodeWidget|ProductComparisonPage|ProductConfigurationWidget|ProductDetailPage|WishlistPage|AvailabilityStorage|ProductAlternativeStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductStorage
     *
    ...
    /**
     * @module ConfigurableBundlePage|ContentProductWidget|ProductComparisonPage|ProductBundleStorage|ProductStorage
     *
    ...
    /**
     * @module ConfigurableBundlePage|ContentProductWidget|ProductComparisonPage|WishlistPage|ProductBundleStorage|ProductImageStorage
     *
    ...
    /**
     * @module ConfigurableBundlePage|ProductDetailPage|PriceProductStorage
     *
    ...
    /**
     * @module ConfigurableBundlePage|PriceProductWidget|PriceProductStorage
     *
    ...
    /**
     * @module ConfigurableBundlePage|ContentProductWidget|DiscountPromotionWidget|PriceProductVolumeWidget|PriceProductWidget|ProductCategoryWidget|ProductComparisonPage|ProductDetailPage|ProductLabelWidget|ProductOptionWidget|ProductRelationWidget|ProductReviewWidget|ProductSearchWidget|ProductSetDetailPage|AvailabilityStorage|PriceProductStorage|ProductImageStorage|ProductLabelStorage|ProductReview|ProductStorage
     *
    ...
    /**
     * @module ContentProductWidget|ProductComparisonPage|ProductDetailPage|ProductBundleStorage|ProductStorage
     *
    ...
    /**
     * @module ContentProductWidget|DiscountPromotionWidget|ProductComparisonPage|ProductDetailPage|PriceProductStorage
     *
    ...
    /**
     * @module DiscountPromotionWidget|ProductDetailPage|ProductSetDetailPage|WishlistPage|ProductAlternativeStorage|ProductDiscontinuedStorage|ProductListStorage|ProductStorage
     *
    ...
    /**
     * @module DiscountPromotionWidget|ProductDetailPage|AvailabilityStorage|ProductAlternativeStorage|ProductConfigurationStorage|ProductDiscontinuedStorage
     *
    ...
    /**
     * @module PriceProductVolumeWidget|ProductDetailPage|PriceProductStorage
     *
    ...
    /**
     * @module ProductBundleWidget|ProductComparisonPage|ProductDetailPage|ProductStorage
     *
    ...
    /**
     * @module ProductConfigurationWidget|ProductConfigurationWishlistWidget|ProductConfigurationStorage|ProductConfigurationWishlist
     *
     ...
     * @module ProductStorage
     *
     * @param array|null $productSetIds
     *
     * @return $this
     */
    public function setProductSetIds(array $productSetIds = null)
    {
        ...
        $this->modifiedProperties[self::PRODUCT_SET_IDS] = true;
     ...
     * @module ProductStorage
     *
     * @param mixed $productSetIds
     *
     * @return $this
     */
    public function addProductSetIds($productSetIds)
    {
        $this->productSetIds[] = $productSetIds;
        $this->modifiedProperties[self::PRODUCT_SET_IDS] = true;
     ...
     * @return $this
     */
    public function requireProductSetIds()
    {
        $this->assertPropertyIsSet(self::PRODUCT_SET_IDS);
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'product_set_ids' => $this->productSetIds,
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'product_set_ids' => $this->productSetIds instanceof AbstractTransfer ? $this->productSetIds->toArray(true, false) : $this->productSetIds,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'productSetIds' => $this->productSetIds instanceof AbstractTransfer ? $this->productSetIds->toArray(true, true) : $this->productSetIds,
