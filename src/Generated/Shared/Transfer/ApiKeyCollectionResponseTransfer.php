 ...
 */
class ApiKeyCollectionResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\ApiKeyTransfer>
     */
    protected $apiKeys;
    ...
    protected $transferMetadata = [
        ...
        self::API_KEYS => [
            'type' => 'Generated\Shared\Transfer\ApiKeyTransfer',
            'type_shim' => null,
     ...
     * @module ApiKeyGui|ApiKey
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\ApiKeyTransfer> $apiKeys
     *
     * @return $this
     */
    public function setApiKeys(ArrayObject $apiKeys)
    {
        $this->apiKeys = new ArrayObject();
     ...
     * @module ApiKeyGui|ApiKey
     *
     * @return \ArrayObject<\Generated\Shared\Transfer\ApiKeyTransfer>
     */
    public function getApiKeys(): ArrayObject
    {
        return $this->apiKeys;
    }
     ...
     * @module ApiKeyGui|ApiKey
     *
     * @param \Generated\Shared\Transfer\ApiKeyTransfer $apiKey
     *
     * @return $this
     */
    public function addApiKey(ApiKeyTransfer $apiKey)
    {
        $this->apiKeys[] = $apiKey;
        $this->modifiedProperties[self::API_KEYS] = true;
    ...
    {
        $this->assertCollectionPropertyIsSet(self::API_KEYS);
    ...
    protected function initCollectionProperties(): void
    {
        ...
        $this->apiKeys = $this->apiKeys ?: new ArrayObject();
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'api_keys' => $this->apiKeys instanceof AbstractTransfer ? $this->apiKeys->toArray(true, false) : $this->addValuesToCollection($this->apiKeys, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'apiKeys' => $this->apiKeys instanceof AbstractTransfer ? $this->apiKeys->toArray(true, true) : $this->addValuesToCollection($this->apiKeys, true, true),
        ];
    }
}
