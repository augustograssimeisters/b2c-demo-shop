...
class DataExportConfigurationsTransfer extends AbstractTransfer
{
     ...
     * @return $this
     */
    public function setThrowException(?bool $throwException = null)
    {
     ...
     * @return $this
     */
    public function setThrowExceptionOrFail(bool $throwException)
    {
     ...
     * @return bool
     */
    public function getThrowExceptionOrFail(): bool
    {
