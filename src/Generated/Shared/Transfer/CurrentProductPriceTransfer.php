...
class CurrentProductPriceTransfer extends AbstractTransfer
{
    ...
    /**
     * @module ConfigurableBundlePage|PriceProduct
     *
    ...
    /**
     * @module CatalogPriceProductConnector|PriceProductStorage|PriceProduct|ProductPricesRestApi|ProductRelation|Wishlist
     *
