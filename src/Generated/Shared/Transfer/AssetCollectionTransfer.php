 ...
 */
class AssetCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @var \ArrayObject<\Generated\Shared\Transfer\AssetTransfer>
     */
    protected $assets;
    ...
    protected $transferMetadata = [
        self::ASSETS => [
            'type' => 'Generated\Shared\Transfer\AssetTransfer',
            'type_shim' => null,
            'name_underscore' => 'assets',
            'is_collection' => true,
            'is_transfer' => true,
     ...
     *
     * @param \ArrayObject<\Generated\Shared\Transfer\AssetTransfer> $assets
     *
     * @return $this
     */
    public function setAssets(ArrayObject $assets)
    {
        $this->assets = new ArrayObject();

        foreach ($assets as $key => $value) {
            $args = [$value];

            if ($this->transferMetadata[static::ASSETS]['is_associative']) {
                $args = [$key, $value];
            }
        ...
        $this->modifiedProperties[self::ASSETS] = true;
     ...
     * @module AssetStorage|Asset
     *
     * @return \ArrayObject<\Generated\Shared\Transfer\AssetTransfer>
     */
     ...
     * @module AssetStorage|Asset
     *
     * @param \Generated\Shared\Transfer\AssetTransfer $asset
     *
     * @return $this
     */
    public function addAsset(AssetTransfer $asset)
    {
        $this->assets[] = $asset;
        $this->modifiedProperties[self::ASSETS] = true;
    ...
    {
        $this->assertCollectionPropertyIsSet(self::ASSETS);
    ...
    {
        $this->assets = $this->assets ?: new ArrayObject();
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'assets' => $this->assets instanceof AbstractTransfer ? $this->assets->toArray(true, false) : $this->addValuesToCollection($this->assets, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'assets' => $this->assets instanceof AbstractTransfer ? $this->assets->toArray(true, true) : $this->addValuesToCollection($this->assets, true, true),
        ];
    }
}
