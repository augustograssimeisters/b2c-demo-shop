 ...
 */
class CollectedDiscountTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module DiscountPromotion|Discount|GiftCard
     *
     ...
     * @return $this
     */
    public function addDiscountableItems(DiscountableItemTransfer $discountableItems)
    {
        $this->discountableItems[] = $discountableItems;
        $this->modifiedProperties[self::DISCOUNTABLE_ITEMS] = true;
