...
class PaginationTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|AvailabilityNotificationsRestApi|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|Currency|Customer|PickingList|ProductAttribute|ProductConfiguration|ProductImage|Product|PushNotification|SalesReturn|Sales|ShipmentType|Shipment|StoreStorage|Store|WarehouseUser
     *
     * @param int|null $page
     *
     * @return $this
    ...
    /**
     * @module CustomerPage|SalesReturnPage|AgentAuthRestApi|Agent|AvailabilityNotification|AvailabilityNotificationsRestApi|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|Currency|Customer|PickingList|ProductAttribute|ProductConfiguration|ProductImage|Product|PushNotification|SalesReturn|Sales|ShipmentType|Shipment|StoreStorage|Store|WarehouseUser
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|AgentAuthRestApi|Agent|Asset|AvailabilityNotification|AvailabilityNotificationsRestApi|Category|Currency|Customer|FileManager|OrdersRestApi|PickingList|ProductAlternative|ProductAttribute|ProductAttributesRestApi|ProductConfiguration|ProductDiscontinued|ProductImage|ProductLabel|ProductList|Product|PublishAndSynchronizeHealthCheck|PushNotification|SalesReturn|SalesReturnsRestApi|Sales|ShipmentType|Shipment|StoreStorage|Store|TaxApp|TaxProductStorage|Tax|Url|WarehouseUser
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|Currency|Customer|PickingList|ProductAttribute|ProductConfiguration|ProductImage|Product|PushNotification|SalesReturn|Sales|ShipmentType|Shipment|StoreStorage|Store|WarehouseUser
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|Currency|Customer|GlueApplication|GlueJsonApiConvention|PickingList|ProductAttribute|ProductConfiguration|ProductImage|Product|PushNotification|SalesReturn|Sales|ShipmentType|Shipment|StoreStorage|Store|WarehouseUser
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|Currency|Customer|PickingList|ProductAttribute|ProductConfiguration|ProductImage|Product|PushNotification|SalesReturn|Sales|ShipmentType|Shipment|StoreStorage|Store|WarehouseUser
     *
    ...
    /**
     * @module AssetStorage|Asset|CategoryImageStorage|Category|Currency|CustomerStorage|DynamicEntityBackendApi|DynamicEntity|FileManagerStorage|FileManager|GlueApplication|GlueJsonApiConvention|Oms|OrderMatrix|PickingList|ProductAlternativeStorage|ProductAlternative|ProductAttribute|ProductConfigurationStorage|ProductConfiguration|ProductDiscontinuedStorage|ProductDiscontinued|ProductImage|ProductLabelSearch|ProductLabel|ProductListSearch|ProductListStorage|ProductList|Product|PublishAndSynchronizeHealthCheckSearch|PublishAndSynchronizeHealthCheckStorage|PublishAndSynchronizeHealthCheck|PushNotification|ShipmentTypeStorage|ShipmentType|Shipment|StoreStorage|Store|TaxApp|TaxProductStorage|TaxStorage|Tax|Url|WarehouseUser
     *
