...
class DataImporterReaderConfigurationTransfer extends AbstractTransfer
{
     ...
     * @return $this
     */
    public function setFileSystem(?string $fileSystem = null)
    {
        $this->fileSystem = $fileSystem;
        $this->modifiedProperties[self::FILE_SYSTEM] = true;
     ...
     * @return $this
     */
    public function setFileSystemOrFail(string $fileSystem)
    {
     ...
     * @return string
     */
    public function getFileSystemOrFail(): string
    {
        if ($this->fileSystem === null) {
            $this->throwNullValueException(static::FILE_SYSTEM);
        }
     ...
     * @return $this
     */
    public function requireFileSystem()
    {
        $this->assertPropertyIsSet(self::FILE_SYSTEM);
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'file_system' => $this->fileSystem instanceof AbstractTransfer ? $this->fileSystem->toArray(true, false) : $this->fileSystem,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'fileSystem' => $this->fileSystem instanceof AbstractTransfer ? $this->fileSystem->toArray(true, true) : $this->fileSystem,
        ];
    }
}
