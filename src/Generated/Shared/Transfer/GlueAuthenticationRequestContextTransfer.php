 ...
 */
class GlueAuthenticationRequestContextTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module AuthenticationOauth|OauthApi|OauthBackendApi|OauthWarehouse|Oauth|WarehouseOauthBackendApi
     *
