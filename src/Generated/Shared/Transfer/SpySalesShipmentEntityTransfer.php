...
class SpySalesShipmentEntityTransfer extends AbstractEntityTransfer
{
     ...
     * @var string
     */
    public const FK_SALES_SHIPMENT_TYPE = 'fkSalesShipmentType';
     ...
     * @var string
     */
    public const SALES_SHIPMENT_TYPE = 'salesShipmentType';
    ...
    /**
     * @var \Generated\Shared\Transfer\SpySalesShipmentTypeEntityTransfer|null
     */
    protected $salesShipmentType;
    ...
    protected $transferPropertyNameMap = [
        ...
        'FkSalesOrderAddress' => 'fkSalesOrderAddress',
        'fk_sales_shipment_type' => 'fkSalesShipmentType',
        'fkSalesShipmentType' => 'fkSalesShipmentType',
        'FkSalesShipmentType' => 'fkSalesShipmentType',
        ...
        'RequestedDeliveryDate' => 'requestedDeliveryDate',
        'sales_shipment_type' => 'salesShipmentType',
        'salesShipmentType' => 'salesShipmentType',
        'SalesShipmentType' => 'salesShipmentType',
        'order' => 'order',
        'Order' => 'order',
        'expense' => 'expense',
    ...
    protected $transferMetadata = [
        ...
        self::FK_SALES_SHIPMENT_TYPE => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'fk_sales_shipment_type',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
        ...
        self::SALES_SHIPMENT_TYPE => [
            'type' => 'Generated\Shared\Transfer\SpySalesShipmentTypeEntityTransfer',
            'type_shim' => null,
            'name_underscore' => 'sales_shipment_type',
            'is_collection' => false,
            'is_transfer' => true,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
     ...
     * @module 
     *
     * @param integer|null $fkSalesShipmentType
     *
     * @return $this
     */
    public function setFkSalesShipmentType($fkSalesShipmentType)
    {
        $this->fkSalesShipmentType = $fkSalesShipmentType;
        $this->modifiedProperties[self::FK_SALES_SHIPMENT_TYPE] = true;
    ...
    {
        return $this->fkSalesShipmentType;
    }
     ...
     * @return $this
     */
    public function setFkSalesShipmentTypeOrFail($fkSalesShipmentType)
    {
        if ($fkSalesShipmentType === null) {
            $this->throwNullValueException(static::FK_SALES_SHIPMENT_TYPE);
        }

        return $this->setFkSalesShipmentType($fkSalesShipmentType);
    }
     ...
     * @return integer
     */
    public function getFkSalesShipmentTypeOrFail()
    {
        if ($this->fkSalesShipmentType === null) {
            $this->throwNullValueException(static::FK_SALES_SHIPMENT_TYPE);
        }
     ...
     * @return $this
     */
    public function requireFkSalesShipmentType()
    {
        $this->assertPropertyIsSet(self::FK_SALES_SHIPMENT_TYPE);
     ...
     * @module 
     *
     * @param \Generated\Shared\Transfer\SpySalesShipmentTypeEntityTransfer|null $salesShipmentType
     *
     * @return $this
     */
    public function setSalesShipmentType(SpySalesShipmentTypeEntityTransfer $salesShipmentType = null)
    {
        $this->salesShipmentType = $salesShipmentType;
        $this->modifiedProperties[self::SALES_SHIPMENT_TYPE] = true;
     ...
     * @module 
     *
     * @return \Generated\Shared\Transfer\SpySalesShipmentTypeEntityTransfer|null
     */
    public function getSalesShipmentType()
    {
        return $this->salesShipmentType;
    }

    /**
     * @module 
     *
     * @param \Generated\Shared\Transfer\SpySalesShipmentTypeEntityTransfer $salesShipmentType
     *
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return $this
     */
    public function setSalesShipmentTypeOrFail(SpySalesShipmentTypeEntityTransfer $salesShipmentType)
    {
        return $this->setSalesShipmentType($salesShipmentType);
    }
     ...
     * @throws \Spryker\Shared\Kernel\Transfer\Exception\NullValueException
     *
     * @return \Generated\Shared\Transfer\SpySalesShipmentTypeEntityTransfer
     */
    public function getSalesShipmentTypeOrFail()
    {
        if ($this->salesShipmentType === null) {
            $this->throwNullValueException(static::SALES_SHIPMENT_TYPE);
        }
     ...
     * @return $this
     */
    public function requireSalesShipmentType()
    {
        $this->assertPropertyIsSet(self::SALES_SHIPMENT_TYPE);
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'fkSalesShipmentType' => $this->fkSalesShipmentType,
            'carrierName' => $this->carrierName,
            'deliveryTime' => $this->deliveryTime,
            'name' => $this->name,
            'requestedDeliveryDate' => $this->requestedDeliveryDate,
            'salesShipmentType' => $this->salesShipmentType,
            'order' => $this->order,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'fk_sales_shipment_type' => $this->fkSalesShipmentType,
            'carrier_name' => $this->carrierName,
            'delivery_time' => $this->deliveryTime,
            'name' => $this->name,
            'requested_delivery_date' => $this->requestedDeliveryDate,
            'sales_shipment_type' => $this->salesShipmentType,
            'order' => $this->order,
            'expense' => $this->expense,
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'fk_sales_shipment_type' => $this->fkSalesShipmentType instanceof AbstractTransfer ? $this->fkSalesShipmentType->toArray(true, false) : $this->fkSalesShipmentType,
            ...
            'sales_shipment_type' => $this->salesShipmentType instanceof AbstractTransfer ? $this->salesShipmentType->toArray(true, false) : $this->salesShipmentType,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'fkSalesShipmentType' => $this->fkSalesShipmentType instanceof AbstractTransfer ? $this->fkSalesShipmentType->toArray(true, true) : $this->fkSalesShipmentType,
            ...
            'salesShipmentType' => $this->salesShipmentType instanceof AbstractTransfer ? $this->salesShipmentType->toArray(true, true) : $this->salesShipmentType,
