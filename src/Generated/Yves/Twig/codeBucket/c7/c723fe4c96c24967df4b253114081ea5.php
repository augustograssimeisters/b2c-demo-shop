...
class __TwigTemplate_00d66b7c0c4aa6d76f7c787ccea25b4d extends Template
{
...
if (!array_key_exists('attributes', $context)) {$context['attributes'] = [];}$context['attributes'] = array_replace_recursive(["viewport-class-name" => "", "viewport-margin" => "0px", "visibility-threshold" => 0, "observe-visible-targets" => false, "target-class-name" => (("js-" . CoreExtension::getAttribute($this->env, $this->source,         // line 13
(isset($context["config"]) || array_key_exists("config", $context) ? $context["config"] : (function () { throw new RuntimeError('Variable "config" does not exist.', 13, $this->source); })()), "name", [], "any", false, false, false, 13)) . "__target")], $context['attributes']);        // line 1
    ...
    {
        return array (  49 => 1,  48 => 13,  47 => 8,  46 => 3,  39 => 1,);
    }
