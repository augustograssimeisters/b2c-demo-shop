...
class __TwigTemplate_35647dc384f7e28eb6e8aa48f441bfe8 extends Template
{
...
(isset($context["required"]) || array_key_exists("required", $context) ? $context["required"] : (function () { throw new RuntimeError('Variable "required" does not exist.', 8, $this->source); })()), "isMultiSelect" => ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 9
($context["data"] ?? null), "filter", [], "any", false, true, false, 9), "config", [], "any", false, true, false, 9), "isMultiValued", [], "any", true, true, false, 9)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["data"] ?? null), "filter", [], "any", false, true, false, 9), "config", [], "any", false, true, false, 9), "isMultiValued", [], "any", false, false, false, 9), false)) : (false))], $context['data']);        // line 12
        $context["values"] = ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 12, $this->source); })()), "isMultiSelect", [], "any", false, false, false, 12)) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 12, $this->source); })()), "filter", [], "any", false, false, false, 12), "activeValue", [], "any", false, false, false, 12)) : ([CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 12, $this->source); })()), "filter", [], "any", false, false, false, 12), "activeValue", [], "any", false, false, false, 12)]));
        // line 1
    ...
    public function block_component(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            // line 16
            yield "        ";
            yield from             $this->loadTemplate($this->env->getFunction('molecule')->getCallable()("active-filter", "CatalogPage"), "@CatalogPage/components/molecules/active-filter-enumeration/active-filter-enumeration.twig", 16)->unwrap()->yield(CoreExtension::toArray(["class" =>             // line 17
...
(isset($context["attributes"]) || array_key_exists("attributes", $context) ? $context["attributes"] : (function () { throw new RuntimeError('Variable "attributes" does not exist.', 18, $this->source); })()), "data" => ["filter" => CoreExtension::getAttribute($this->env, $this->source,             // line 20
...
$context["value"]]]));
    ...
    {
        return array (  76 => 24,  74 => 21,  73 => 20,  72 => 18,  71 => 17,  69 => 16,  64 => 15,  57 => 14,  53 => 1,  51 => 12,  50 => 9,  49 => 8,  48 => 7,  47 => 3,  40 => 1,);
    }
