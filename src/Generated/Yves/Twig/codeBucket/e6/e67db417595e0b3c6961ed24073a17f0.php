...
class __TwigTemplate_8dc18b0bc77d2ea5a0352dd93fa75985 extends Template
{
    ...
    {
        // line 1
        return $this->loadTemplate($this->env->getFunction('model')->getCallable()("component"), "@ShopUi/components/molecules/form-submitter/form-submitter.twig", 1);
    }
...
(isset($context["required"]) || array_key_exists("required", $context) ? $context["required"] : (function () { throw new RuntimeError('Variable "required" does not exist.', 9, $this->source); })()), "event" => "change"], $context['attributes']);        // line 1
    ...
    {
        return array (  61 => 14,  54 => 13,  50 => 1,  49 => 9,  48 => 8,  47 => 3,  40 => 1,);
    }
...
{%- endblock -%}
", "@ShopUi/components/molecules/form-submitter/form-submitter.twig", "/data/vendor/spryker-shop/shop-ui/src/SprykerShop/Yves/ShopUi/Theme/default/components/molecules/form-submitter/form-submitter.twig");
    }
}
