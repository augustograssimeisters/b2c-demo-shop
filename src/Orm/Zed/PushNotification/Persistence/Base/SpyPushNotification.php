...
/**
 * Base class that represents a row from the 'spy_push_notification' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.PushNotification.Persistence.Base
 */
abstract class SpyPushNotification implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\PushNotification\\Persistence\\Map\\SpyPushNotificationTableMap';
    ...
    /**
     * The value for the id_push_notification field.
     *
     * @var        int
     */
    protected $id_push_notification;
    ...
    /**
     * Initializes internal state of Orm\Zed\PushNotification\Persistence\Base\SpyPushNotification object.
     */
    ...
    /**
     * Compares this with another <code>SpyPushNotification</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyPushNotification</code>, delegates to
     * <code>equals(SpyPushNotification)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_push_notification] column value.
     *
     * @return int
     */
    public function getIdPushNotification()
    {
        return $this->id_push_notification;
    }
    ...
    /**
     * Set the value of [id_push_notification] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setIdPushNotification($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_push_notification !== $v) {
            $this->id_push_notification = $v;
            $this->modifiedColumns[SpyPushNotificationTableMap::COL_ID_PUSH_NOTIFICATION] = true;
        }
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyPushNotificationTableMap::COL_UUID] = true;
        }
    ...
    public function setFkPushNotificationGroup($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_push_notification_group !== $v) {
            ...
            $this->modifiedColumns[SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_GROUP] = true;
        }
    ...
    public function setFkPushNotificationProvider($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_push_notification_provider !== $v) {
            ...
            $this->modifiedColumns[SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_PROVIDER] = true;
        }
    ...
    public function setPayload($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->payload !== $v) {
            $this->payload = $v;
            $this->modifiedColumns[SpyPushNotificationTableMap::COL_PAYLOAD] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyPushNotificationTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyPushNotificationTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyPushNotificationTableMap::translateFieldName('IdPushNotification', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_push_notification = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyPushNotificationTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyPushNotificationTableMap::translateFieldName('FkPushNotificationGroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_push_notification_group = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyPushNotificationTableMap::translateFieldName('FkPushNotificationProvider', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_push_notification_provider = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyPushNotificationTableMap::translateFieldName('Payload', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payload = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyPushNotificationTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyPushNotificationTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = SpyPushNotificationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\PushNotification\\Persistence\\SpyPushNotification'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpyPushNotificationTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpyPushNotificationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SpyPushNotification::setDeleted()
     * @see SpyPushNotification::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyPushNotificationQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyPushNotificationTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyPushNotificationTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyPushNotificationTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyPushNotificationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[SpyPushNotificationTableMap::COL_ID_PUSH_NOTIFICATION] = true;
        if (null !== $this->id_push_notification) {
        ...
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_ID_PUSH_NOTIFICATION)) {
            $modifiedColumns[':p' . $index++]  = 'id_push_notification';
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_UUID)) {
            $modifiedColumns[':p' . $index++]  = 'uuid';
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_GROUP)) {
            $modifiedColumns[':p' . $index++]  = 'fk_push_notification_group';
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_PROVIDER)) {
            $modifiedColumns[':p' . $index++]  = 'fk_push_notification_provider';
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_PAYLOAD)) {
        ...
        $sql = sprintf(
            'INSERT INTO spy_push_notification (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_push_notification':
                        $stmt->bindValue($identifier, $this->id_push_notification, PDO::PARAM_INT);
        ...
        try {
            $pk = $con->lastInsertId('id_push_notification_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        $this->setIdPushNotification($pk);
    ...
    {
        $pos = SpyPushNotificationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdPushNotification();
    ...
    {
        if (isset($alreadyDumpedObjects['SpyPushNotification'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SpyPushNotification'][$this->hashCode()] = true;
        $keys = SpyPushNotificationTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getIdPushNotification(),
            $keys[1] => $this->getUuid(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdPushNotification($value);
                break;
            case 1:
                $this->setUuid($value);
                break;
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdPushNotification($arr[$keys[0]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_ID_PUSH_NOTIFICATION)) {
            $criteria->add(SpyPushNotificationTableMap::COL_ID_PUSH_NOTIFICATION, $this->id_push_notification);
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_UUID)) {
            $criteria->add(SpyPushNotificationTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_GROUP)) {
            $criteria->add(SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_GROUP, $this->fk_push_notification_group);
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_PROVIDER)) {
            $criteria->add(SpyPushNotificationTableMap::COL_FK_PUSH_NOTIFICATION_PROVIDER, $this->fk_push_notification_provider);
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_PAYLOAD)) {
            $criteria->add(SpyPushNotificationTableMap::COL_PAYLOAD, $this->payload);
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyPushNotificationTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyPushNotificationTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyPushNotificationTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpyPushNotificationQuery::create();
        $criteria->add(SpyPushNotificationTableMap::COL_ID_PUSH_NOTIFICATION, $this->id_push_notification);
    ...
    {
        $validPk = null !== $this->getIdPushNotification();
    ...
    /**
     * Generic method to set the primary key (id_push_notification column).
     *
    ...
    {
        $this->setIdPushNotification($key);
    }
    ...
    {
        return null === $this->getIdPushNotification();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\PushNotification\Persistence\SpyPushNotification (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdPushNotification(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\PushNotification\Persistence\SpyPushNotification Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getSpyPushNotificationGroup(?ConnectionInterface $con = null)
    {
        if ($this->aSpyPushNotificationGroup === null && ($this->fk_push_notification_group != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSpyPushNotificationGroup->addSpyPushNotifications($this);
             */
        }
    ...
    public function getSpyPushNotificationProvider(?ConnectionInterface $con = null)
    {
        if ($this->aSpyPushNotificationProvider === null && ($this->fk_push_notification_provider != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpyPushNotificationProvider->addSpyPushNotifications($this);
             */
        }
     ...
     * If this ChildSpyPushNotification is new, it will return
        ...
        if (null === $this->collSpyPushNotificationSubscriptionDeliveryLogs || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpyPushNotificationSubscriptionDeliveryLogs = ChildSpyPushNotificationSubscriptionDeliveryLogQuery::create(null, $criteria)
                    ->filterBySpyPushNotification($this)
                    ->find($con);
    ...
    public function setSpyPushNotificationSubscriptionDeliveryLogs(Collection $spyPushNotificationSubscriptionDeliveryLogs, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($spyPushNotificationSubscriptionDeliveryLogsToDelete as $spyPushNotificationSubscriptionDeliveryLogRemoved) {
            $spyPushNotificationSubscriptionDeliveryLogRemoved->setSpyPushNotification(null);
        }
    ...
    protected function doAddSpyPushNotificationSubscriptionDeliveryLog(ChildSpyPushNotificationSubscriptionDeliveryLog $spyPushNotificationSubscriptionDeliveryLog): void
    {
        ...
        $spyPushNotificationSubscriptionDeliveryLog->setSpyPushNotification($this);
    }
    ...
    public function removeSpyPushNotificationSubscriptionDeliveryLog(ChildSpyPushNotificationSubscriptionDeliveryLog $spyPushNotificationSubscriptionDeliveryLog)
    {
        if ($this->getSpyPushNotificationSubscriptionDeliveryLogs()->contains($spyPushNotificationSubscriptionDeliveryLog)) {
            ...
            $spyPushNotificationSubscriptionDeliveryLog->setSpyPushNotification(null);
        }
     ...
     * Otherwise if this SpyPushNotification is new, it will return
     * an empty collection; or if this SpyPushNotification has previously
     * been saved, it will retrieve related SpyPushNotificationSubscriptionDeliveryLogs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyPushNotification.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyPushNotificationSubscriptionDeliveryLog}> List of ChildSpyPushNotificationSubscriptionDeliveryLog objects
     */
    public function getSpyPushNotificationSubscriptionDeliveryLogsJoinSpyPushNotificationSubscription(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyPushNotificationSubscriptionDeliveryLogQuery::create(null, $criteria);
        $query->joinWith('SpyPushNotificationSubscription', $joinBehavior);
    ...
    {
        if (null !== $this->aSpyPushNotificationGroup) {
            $this->aSpyPushNotificationGroup->removeSpyPushNotification($this);
        }
        if (null !== $this->aSpyPushNotificationProvider) {
            $this->aSpyPushNotificationProvider->removeSpyPushNotification($this);
        }
        $this->id_push_notification = null;
        $this->uuid = null;
    ...
    {
        return (string) $this->exportTo(SpyPushNotificationTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_push_notification' . '.' . $this->getIdPushNotification() . '.' . $this->getFkPushNotificationGroup() . '.' . $this->getFkPushNotificationProvider();
