...
class SpySalesOrderNoteTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_sales_order_note.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesOrderNote', 'FkSalesOrder', 'Command', 'Message', 'Success', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSalesOrderNote', 'fkSalesOrder', 'command', 'message', 'success', 'uuid', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySalesOrderNoteTableMap::COL_ID_SALES_ORDER_NOTE, SpySalesOrderNoteTableMap::COL_FK_SALES_ORDER, SpySalesOrderNoteTableMap::COL_COMMAND, SpySalesOrderNoteTableMap::COL_MESSAGE, SpySalesOrderNoteTableMap::COL_SUCCESS, SpySalesOrderNoteTableMap::COL_UUID, SpySalesOrderNoteTableMap::COL_CREATED_AT, SpySalesOrderNoteTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_sales_order_note', 'fk_sales_order', 'command', 'message', 'success', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesOrderNote' => 0, 'FkSalesOrder' => 1, 'Command' => 2, 'Message' => 3, 'Success' => 4, 'Uuid' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ],
        self::TYPE_CAMELNAME     => ['idSalesOrderNote' => 0, 'fkSalesOrder' => 1, 'command' => 2, 'message' => 3, 'success' => 4, 'uuid' => 5, 'createdAt' => 6, 'updatedAt' => 7, ],
        self::TYPE_COLNAME       => [SpySalesOrderNoteTableMap::COL_ID_SALES_ORDER_NOTE => 0, SpySalesOrderNoteTableMap::COL_FK_SALES_ORDER => 1, SpySalesOrderNoteTableMap::COL_COMMAND => 2, SpySalesOrderNoteTableMap::COL_MESSAGE => 3, SpySalesOrderNoteTableMap::COL_SUCCESS => 4, SpySalesOrderNoteTableMap::COL_UUID => 5, SpySalesOrderNoteTableMap::COL_CREATED_AT => 6, SpySalesOrderNoteTableMap::COL_UPDATED_AT => 7, ],
        self::TYPE_FIELDNAME     => ['id_sales_order_note' => 0, 'fk_sales_order' => 1, 'command' => 2, 'message' => 3, 'success' => 4, 'uuid' => 5, 'created_at' => 6, 'updated_at' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpySalesOrderNote.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spySalesOrderNote.uuid' => 'UUID',
        'SpySalesOrderNoteTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_sales_order_note.uuid' => 'UUID',
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_sales_order_note.fk_sales_order'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpySalesOrderNoteTableMap::COL_UUID);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpySalesOrderNoteTableMap::COL_UUID);
