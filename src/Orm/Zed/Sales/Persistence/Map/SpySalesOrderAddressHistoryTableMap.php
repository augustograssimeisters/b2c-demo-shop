...
class SpySalesOrderAddressHistoryTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_sales_order_address_history.uuid';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpySalesOrderAddressHistory.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spySalesOrderAddressHistory.uuid' => 'UUID',
        'SpySalesOrderAddressHistoryTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_sales_order_address_history.uuid' => 'UUID',
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_sales_order_address_history.fk_sales_order_address'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpySalesOrderAddressHistoryTableMap::COL_UUID);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpySalesOrderAddressHistoryTableMap::COL_UUID);
