...
class SpySalesOrderCommentTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_sales_order_comment.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesOrderComment', 'FkSalesOrder', 'Message', 'Username', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSalesOrderComment', 'fkSalesOrder', 'message', 'username', 'uuid', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySalesOrderCommentTableMap::COL_ID_SALES_ORDER_COMMENT, SpySalesOrderCommentTableMap::COL_FK_SALES_ORDER, SpySalesOrderCommentTableMap::COL_MESSAGE, SpySalesOrderCommentTableMap::COL_USERNAME, SpySalesOrderCommentTableMap::COL_UUID, SpySalesOrderCommentTableMap::COL_CREATED_AT, SpySalesOrderCommentTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_sales_order_comment', 'fk_sales_order', 'message', 'username', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesOrderComment' => 0, 'FkSalesOrder' => 1, 'Message' => 2, 'Username' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idSalesOrderComment' => 0, 'fkSalesOrder' => 1, 'message' => 2, 'username' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpySalesOrderCommentTableMap::COL_ID_SALES_ORDER_COMMENT => 0, SpySalesOrderCommentTableMap::COL_FK_SALES_ORDER => 1, SpySalesOrderCommentTableMap::COL_MESSAGE => 2, SpySalesOrderCommentTableMap::COL_USERNAME => 3, SpySalesOrderCommentTableMap::COL_UUID => 4, SpySalesOrderCommentTableMap::COL_CREATED_AT => 5, SpySalesOrderCommentTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_sales_order_comment' => 0, 'fk_sales_order' => 1, 'message' => 2, 'username' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpySalesOrderComment.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spySalesOrderComment.uuid' => 'UUID',
        'SpySalesOrderCommentTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_sales_order_comment.uuid' => 'UUID',
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_sales_order_comment.fk_sales_order'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpySalesOrderCommentTableMap::COL_UUID);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpySalesOrderCommentTableMap::COL_UUID);
