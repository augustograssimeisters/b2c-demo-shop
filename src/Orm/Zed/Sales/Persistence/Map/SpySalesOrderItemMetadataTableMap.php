...
class SpySalesOrderItemMetadataTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_sales_order_item_metadata.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesOrderItemMetadata', 'FkSalesOrderItem', 'Image', 'SuperAttributes', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSalesOrderItemMetadata', 'fkSalesOrderItem', 'image', 'superAttributes', 'uuid', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySalesOrderItemMetadataTableMap::COL_ID_SALES_ORDER_ITEM_METADATA, SpySalesOrderItemMetadataTableMap::COL_FK_SALES_ORDER_ITEM, SpySalesOrderItemMetadataTableMap::COL_IMAGE, SpySalesOrderItemMetadataTableMap::COL_SUPER_ATTRIBUTES, SpySalesOrderItemMetadataTableMap::COL_UUID, SpySalesOrderItemMetadataTableMap::COL_CREATED_AT, SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_sales_order_item_metadata', 'fk_sales_order_item', 'image', 'super_attributes', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesOrderItemMetadata' => 0, 'FkSalesOrderItem' => 1, 'Image' => 2, 'SuperAttributes' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idSalesOrderItemMetadata' => 0, 'fkSalesOrderItem' => 1, 'image' => 2, 'superAttributes' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpySalesOrderItemMetadataTableMap::COL_ID_SALES_ORDER_ITEM_METADATA => 0, SpySalesOrderItemMetadataTableMap::COL_FK_SALES_ORDER_ITEM => 1, SpySalesOrderItemMetadataTableMap::COL_IMAGE => 2, SpySalesOrderItemMetadataTableMap::COL_SUPER_ATTRIBUTES => 3, SpySalesOrderItemMetadataTableMap::COL_UUID => 4, SpySalesOrderItemMetadataTableMap::COL_CREATED_AT => 5, SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_sales_order_item_metadata' => 0, 'fk_sales_order_item' => 1, 'image' => 2, 'super_attributes' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpySalesOrderItemMetadata.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spySalesOrderItemMetadata.uuid' => 'UUID',
        'SpySalesOrderItemMetadataTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_sales_order_item_metadata.uuid' => 'UUID',
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_sales_order_item_metadata.fk_sales_order_item'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpySalesOrderItemMetadataTableMap::COL_UUID);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpySalesOrderItemMetadataTableMap::COL_UUID);
