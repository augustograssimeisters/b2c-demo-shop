 ...
 * @method     ChildSpySalesShipmentQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 *
 ...
 * @method     ChildSpySalesShipmentQuery groupByUuid() Group by the uuid column
 *
 ...
 * @method     ChildSpySalesShipment|null findOneByUuid(string $uuid) Return the first ChildSpySalesShipment filtered by the uuid column
 *
 ...
 * @method     ChildSpySalesShipment requireOneByUuid(string $uuid) Return the first ChildSpySalesShipment filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpySalesShipment[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesShipment objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesShipment> findByUuid(string|array<string> $uuid) Return ChildSpySalesShipment objects filtered by the uuid column
 *
...
abstract class SpySalesShipmentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_shipment, fk_sales_expense, fk_sales_order, fk_sales_order_address, fk_sales_shipment_type, carrier_name, delivery_time, name, requested_delivery_date, created_at, updated_at, uuid FROM spy_sales_shipment WHERE id_sales_shipment = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesShipmentTableMap::COL_UUID, $uuid, $comparison);
