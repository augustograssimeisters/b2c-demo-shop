...
abstract class SpySalesOrderAddressHistory implements ActiveRecordInterface
{
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpySalesOrderAddressHistoryTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : SpySalesOrderAddressHistoryTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : SpySalesOrderAddressHistoryTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : SpySalesOrderAddressHistoryTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 24; // 24 = SpySalesOrderAddressHistoryTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpySalesOrderAddressHistoryTableMap::COL_UUID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpySalesOrderAddressHistoryTableMap::COL_UUID)) {
            $criteria->add(SpySalesOrderAddressHistoryTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpySalesOrderAddressHistoryTableMap::COL_CREATED_AT)) {
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_sales_order_address_history' . '.' . $this->getIdSalesOrderAddressHistory() . '.' . $this->getFkSalesOrderAddress();
