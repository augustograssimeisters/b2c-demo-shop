 ...
 * @method     ChildSpySalesOrderAddressQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderAddressQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpySalesOrderAddress|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrderAddress filtered by the uuid column
 ...
 * @method     ChildSpySalesOrderAddress requireOneByUuid(string $uuid) Return the first ChildSpySalesOrderAddress filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrderAddress[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderAddress objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderAddress> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderAddress objects filtered by the uuid column
...
abstract class SpySalesOrderAddressQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_address, fk_country, fk_region, address1, address2, address3, cell_phone, city, comment, company, description, email, first_name, last_name, middle_name, phone, po_box, salutation, zip_code, uuid, created_at, updated_at FROM spy_sales_order_address WHERE id_sales_order_address = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderAddressTableMap::COL_UUID, $uuid, $comparison);
