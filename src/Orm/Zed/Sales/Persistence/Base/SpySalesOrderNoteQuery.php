 ...
 * @method     ChildSpySalesOrderNoteQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderNoteQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpySalesOrderNote|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrderNote filtered by the uuid column
 ...
 * @method     ChildSpySalesOrderNote requireOneByUuid(string $uuid) Return the first ChildSpySalesOrderNote filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrderNote[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderNote objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderNote> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderNote objects filtered by the uuid column
...
abstract class SpySalesOrderNoteQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_note, fk_sales_order, command, message, success, uuid, created_at, updated_at FROM spy_sales_order_note WHERE id_sales_order_note = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_UUID, $uuid, $comparison);
