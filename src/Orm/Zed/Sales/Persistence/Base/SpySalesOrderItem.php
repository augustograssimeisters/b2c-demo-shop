...
abstract class SpySalesOrderItem implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|ChildSpySalesOrderItemGiftCard[] Collection to store aggregation of ChildSpySalesOrderItemGiftCard objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildSpySalesOrderItemGiftCard> Collection to store aggregation of ChildSpySalesOrderItemGiftCard objects.
     */
    protected $collSpySalesOrderItemGiftCards;
    protected $collSpySalesOrderItemGiftCardsPartial;
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|ChildSpySalesOrderItemGiftCard[]
     * @phpstan-var ObjectCollection&\Traversable<ChildSpySalesOrderItemGiftCard>
     */
    protected $spySalesOrderItemGiftCardsScheduledForDeletion = null;
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpySalesOrderItemTableMap::translateFieldName('CanceledAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->canceled_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpySalesOrderItemTableMap::translateFieldName('CartNote', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cart_note = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SpySalesOrderItemTableMap::translateFieldName('DiscountAmountAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount_amount_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SpySalesOrderItemTableMap::translateFieldName('DiscountAmountFullAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount_amount_full_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SpySalesOrderItemTableMap::translateFieldName('ExpensePriceAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->expense_price_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SpySalesOrderItemTableMap::translateFieldName('GrossPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gross_price = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SpySalesOrderItemTableMap::translateFieldName('GroupKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SpySalesOrderItemTableMap::translateFieldName('IsQuantitySplittable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_quantity_splittable = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : SpySalesOrderItemTableMap::translateFieldName('LastStateChange', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->last_state_change = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : SpySalesOrderItemTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SpySalesOrderItemTableMap::translateFieldName('NetPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->net_price = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SpySalesOrderItemTableMap::translateFieldName('OrderItemReference', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_item_reference = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : SpySalesOrderItemTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : SpySalesOrderItemTableMap::translateFieldName('PriceToPayAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_to_pay_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : SpySalesOrderItemTableMap::translateFieldName('ProductOptionPriceAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_option_price_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : SpySalesOrderItemTableMap::translateFieldName('Quantity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quantity = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : SpySalesOrderItemTableMap::translateFieldName('RefundableAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->refundable_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : SpySalesOrderItemTableMap::translateFieldName('RemunerationAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remuneration_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : SpySalesOrderItemTableMap::translateFieldName('Sku', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sku = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : SpySalesOrderItemTableMap::translateFieldName('SubtotalAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : SpySalesOrderItemTableMap::translateFieldName('TaxAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : SpySalesOrderItemTableMap::translateFieldName('TaxAmountAfterCancellation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_amount_after_cancellation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : SpySalesOrderItemTableMap::translateFieldName('TaxAmountFullAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_amount_full_aggregation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : SpySalesOrderItemTableMap::translateFieldName('TaxRate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_rate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : SpySalesOrderItemTableMap::translateFieldName('TaxRateAverageAggregation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_rate_average_aggregation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : SpySalesOrderItemTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : SpySalesOrderItemTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : SpySalesOrderItemTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 34; // 34 = SpySalesOrderItemTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collSpySalesOrderItemGiftCards = null;
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spySalesOrderItemGiftCardsScheduledForDeletion !== null) {
                if (!$this->spySalesOrderItemGiftCardsScheduledForDeletion->isEmpty()) {
                    \Orm\Zed\Sales\Persistence\SpySalesOrderItemGiftCardQuery::create()
                        ->filterByPrimaryKeys($this->spySalesOrderItemGiftCardsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->spySalesOrderItemGiftCardsScheduledForDeletion = null;
                }
            }

            if ($this->collSpySalesOrderItemGiftCards !== null) {
                foreach ($this->collSpySalesOrderItemGiftCards as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[6] => $this->getCanceledAmount(),
            $keys[7] => $this->getCartNote(),
            $keys[8] => $this->getDiscountAmountAggregation(),
            $keys[9] => $this->getDiscountAmountFullAggregation(),
            $keys[10] => $this->getExpensePriceAggregation(),
            $keys[11] => $this->getGrossPrice(),
            $keys[12] => $this->getGroupKey(),
            $keys[13] => $this->getIsQuantitySplittable(),
            $keys[14] => $this->getLastStateChange(),
            $keys[15] => $this->getName(),
            $keys[16] => $this->getNetPrice(),
            $keys[17] => $this->getOrderItemReference(),
            $keys[18] => $this->getPrice(),
            $keys[19] => $this->getPriceToPayAggregation(),
            $keys[20] => $this->getProductOptionPriceAggregation(),
            $keys[21] => $this->getQuantity(),
            $keys[22] => $this->getRefundableAmount(),
            $keys[23] => $this->getRemunerationAmount(),
            $keys[24] => $this->getSku(),
            $keys[25] => $this->getSubtotalAggregation(),
            $keys[26] => $this->getTaxAmount(),
            $keys[27] => $this->getTaxAmountAfterCancellation(),
            $keys[28] => $this->getTaxAmountFullAggregation(),
            $keys[29] => $this->getTaxRate(),
            $keys[30] => $this->getTaxRateAverageAggregation(),
            $keys[31] => $this->getUuid(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collSpySalesOrderItemGiftCards) {

                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = 'spySalesOrderItemGiftCards';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'spy_sales_order_item_gift_cards';
                        break;
                    default:
                        $key = 'SpySalesOrderItemGiftCards';
                }

                $result[$key] = $this->collSpySalesOrderItemGiftCards->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setCanceledAmount($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setCartNote($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDiscountAmountAggregation($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setDiscountAmountFullAggregation($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setExpensePriceAggregation($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setGrossPrice($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setGroupKey($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setIsQuantitySplittable($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setLastStateChange($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setName($arr[$keys[15]]);
        }
        if (array_key_exists($keys[16], $arr)) {
            $this->setNetPrice($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setOrderItemReference($arr[$keys[17]]);
        }
        if (array_key_exists($keys[18], $arr)) {
            $this->setPrice($arr[$keys[18]]);
        }
        if (array_key_exists($keys[19], $arr)) {
            $this->setPriceToPayAggregation($arr[$keys[19]]);
        }
        if (array_key_exists($keys[20], $arr)) {
            $this->setProductOptionPriceAggregation($arr[$keys[20]]);
        }
        if (array_key_exists($keys[21], $arr)) {
            $this->setQuantity($arr[$keys[21]]);
        }
        if (array_key_exists($keys[22], $arr)) {
            $this->setRefundableAmount($arr[$keys[22]]);
        }
        if (array_key_exists($keys[23], $arr)) {
            $this->setRemunerationAmount($arr[$keys[23]]);
        }
        if (array_key_exists($keys[24], $arr)) {
            $this->setSku($arr[$keys[24]]);
        }
        if (array_key_exists($keys[25], $arr)) {
            $this->setSubtotalAggregation($arr[$keys[25]]);
        }
        if (array_key_exists($keys[26], $arr)) {
            $this->setTaxAmount($arr[$keys[26]]);
        }
        if (array_key_exists($keys[27], $arr)) {
            $this->setTaxAmountAfterCancellation($arr[$keys[27]]);
        }
        if (array_key_exists($keys[28], $arr)) {
            $this->setTaxAmountFullAggregation($arr[$keys[28]]);
        }
        if (array_key_exists($keys[29], $arr)) {
            $this->setTaxRate($arr[$keys[29]]);
        }
        if (array_key_exists($keys[30], $arr)) {
            $this->setTaxRateAverageAggregation($arr[$keys[30]]);
        }
        if (array_key_exists($keys[31], $arr)) {
            $this->setUuid($arr[$keys[31]]);
        }
        if (array_key_exists($keys[32], $arr)) {
            $this->setCreatedAt($arr[$keys[32]]);
        }
        if (array_key_exists($keys[33], $arr)) {
            $this->setUpdatedAt($arr[$keys[33]]);
        }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($deepCopy) {
            ...
            foreach ($this->getSpySalesOrderItemGiftCards() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addSpySalesOrderItemGiftCard($relObj->copy($deepCopy));
                }
            }
    ...
    public function initRelation($relationName): void
    {
        ...
        if ('SpySalesOrderItemGiftCard' === $relationName) {
            $this->initSpySalesOrderItemGiftCards();
            return;
        }
    ...
    /**
     * Clears out the collSpySalesOrderItemGiftCards collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return $this
     * @see addSpySalesOrderItemGiftCards()
     */
    public function clearSpySalesOrderItemGiftCards()
    {
        $this->collSpySalesOrderItemGiftCards = null; // important to set this to NULL since that means it is uninitialized

        return $this;
    }

    /**
     * Reset is the collSpySalesOrderItemGiftCards collection loaded partially.
     *
     * @return void
     */
    public function resetPartialSpySalesOrderItemGiftCards($v = true): void
    {
        $this->collSpySalesOrderItemGiftCardsPartial = $v;
    }

    /**
     * Initializes the collSpySalesOrderItemGiftCards collection.
     *
     * By default this just sets the collSpySalesOrderItemGiftCards collection to an empty array (like clearcollSpySalesOrderItemGiftCards());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param bool $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initSpySalesOrderItemGiftCards(bool $overrideExisting = true): void
    {
        if (null !== $this->collSpySalesOrderItemGiftCards && !$overrideExisting) {
            return;
        }

        $collectionClassName = SpySalesOrderItemGiftCardTableMap::getTableMap()->getCollectionClassName();

        $this->collSpySalesOrderItemGiftCards = new $collectionClassName;
        $this->collSpySalesOrderItemGiftCards->setModel('\Orm\Zed\Sales\Persistence\SpySalesOrderItemGiftCard');
    }

    /**
     * Gets an array of ChildSpySalesOrderItemGiftCard objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildSpySalesOrderItemGiftCard[] List of ChildSpySalesOrderItemGiftCard objects
     * @phpstan-return ObjectCollection&\Traversable<ChildSpySalesOrderItemGiftCard> List of ChildSpySalesOrderItemGiftCard objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getSpySalesOrderItemGiftCards(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        $partial = $this->collSpySalesOrderItemGiftCardsPartial && !$this->isNew();
        if (null === $this->collSpySalesOrderItemGiftCards || null !== $criteria || $partial) {
            if ($this->isNew()) {
                // return empty collection
                if (null === $this->collSpySalesOrderItemGiftCards) {
                    $this->initSpySalesOrderItemGiftCards();
                    ...
                    $collSpySalesOrderItemGiftCards = new $collectionClassName;
                    $collSpySalesOrderItemGiftCards->setModel('\Orm\Zed\Sales\Persistence\SpySalesOrderItemGiftCard');

                    return $collSpySalesOrderItemGiftCards;
                }
            } else {
                $collSpySalesOrderItemGiftCards = ChildSpySalesOrderItemGiftCardQuery::create(null, $criteria)
                    ->filterBySpySalesOrderItem($this)
                    ->find($con);

                if (null !== $criteria) {
                    if (false !== $this->collSpySalesOrderItemGiftCardsPartial && count($collSpySalesOrderItemGiftCards)) {
                        $this->initSpySalesOrderItemGiftCards(false);

                        foreach ($collSpySalesOrderItemGiftCards as $obj) {
                            if (false == $this->collSpySalesOrderItemGiftCards->contains($obj)) {
                                $this->collSpySalesOrderItemGiftCards->append($obj);
                            }
                        }

                        $this->collSpySalesOrderItemGiftCardsPartial = true;
                    }

                    return $collSpySalesOrderItemGiftCards;
                }

                if ($partial && $this->collSpySalesOrderItemGiftCards) {
                    foreach ($this->collSpySalesOrderItemGiftCards as $obj) {
                        if ($obj->isNew()) {
                            $collSpySalesOrderItemGiftCards[] = $obj;
                        }
                    }
                }

                $this->collSpySalesOrderItemGiftCards = $collSpySalesOrderItemGiftCards;
                $this->collSpySalesOrderItemGiftCardsPartial = false;
            }
        }

        return $this->collSpySalesOrderItemGiftCards;
    }

    /**
     * Sets a collection of ChildSpySalesOrderItemGiftCard objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param Collection $spySalesOrderItemGiftCards A Propel collection.
     * @param ConnectionInterface $con Optional connection object
     * @return $this The current object (for fluent API support)
     */
    public function setSpySalesOrderItemGiftCards(Collection $spySalesOrderItemGiftCards, ?ConnectionInterface $con = null)
    {
        /** @var ChildSpySalesOrderItemGiftCard[] $spySalesOrderItemGiftCardsToDelete */
        $spySalesOrderItemGiftCardsToDelete = $this->getSpySalesOrderItemGiftCards(new Criteria(), $con)->diff($spySalesOrderItemGiftCards);


        $this->spySalesOrderItemGiftCardsScheduledForDeletion = $spySalesOrderItemGiftCardsToDelete;

        foreach ($spySalesOrderItemGiftCardsToDelete as $spySalesOrderItemGiftCardRemoved) {
            $spySalesOrderItemGiftCardRemoved->setSpySalesOrderItem(null);
        }

        $this->collSpySalesOrderItemGiftCards = null;
        foreach ($spySalesOrderItemGiftCards as $spySalesOrderItemGiftCard) {
            $this->addSpySalesOrderItemGiftCard($spySalesOrderItemGiftCard);
        }

        $this->collSpySalesOrderItemGiftCards = $spySalesOrderItemGiftCards;
        $this->collSpySalesOrderItemGiftCardsPartial = false;
    ...
    /**
     * Returns the number of related SpySalesOrderItemGiftCard objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related SpySalesOrderItemGiftCard objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpySalesOrderItemGiftCards(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpySalesOrderItemGiftCardsPartial && !$this->isNew();
        if (null === $this->collSpySalesOrderItemGiftCards || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collSpySalesOrderItemGiftCards) {
                return 0;
            }

            if ($partial && !$criteria) {
                return count($this->getSpySalesOrderItemGiftCards());
            }

            $query = ChildSpySalesOrderItemGiftCardQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collSpySalesOrderItemGiftCards);
    }

    /**
     * Method called to associate a ChildSpySalesOrderItemGiftCard object to this object
     * through the ChildSpySalesOrderItemGiftCard foreign key attribute.
     *
     * @param ChildSpySalesOrderItemGiftCard $l ChildSpySalesOrderItemGiftCard
     * @return $this The current object (for fluent API support)
     */
    public function addSpySalesOrderItemGiftCard(ChildSpySalesOrderItemGiftCard $l)
    {
        if ($this->collSpySalesOrderItemGiftCards === null) {
            $this->initSpySalesOrderItemGiftCards();
            $this->collSpySalesOrderItemGiftCardsPartial = true;
        ...
        if (!$this->collSpySalesOrderItemGiftCards->contains($l)) {
            $this->doAddSpySalesOrderItemGiftCard($l);

            if ($this->spySalesOrderItemGiftCardsScheduledForDeletion and $this->spySalesOrderItemGiftCardsScheduledForDeletion->contains($l)) {
                $this->spySalesOrderItemGiftCardsScheduledForDeletion->remove($this->spySalesOrderItemGiftCardsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param ChildSpySalesOrderItemGiftCard $spySalesOrderItemGiftCard The ChildSpySalesOrderItemGiftCard object to add.
     */
    protected function doAddSpySalesOrderItemGiftCard(ChildSpySalesOrderItemGiftCard $spySalesOrderItemGiftCard): void
    {
        $this->collSpySalesOrderItemGiftCards[]= $spySalesOrderItemGiftCard;
        $spySalesOrderItemGiftCard->setSpySalesOrderItem($this);
    }

    /**
     * @param ChildSpySalesOrderItemGiftCard $spySalesOrderItemGiftCard The ChildSpySalesOrderItemGiftCard object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpySalesOrderItemGiftCard(ChildSpySalesOrderItemGiftCard $spySalesOrderItemGiftCard)
    {
        if ($this->getSpySalesOrderItemGiftCards()->contains($spySalesOrderItemGiftCard)) {
            $pos = $this->collSpySalesOrderItemGiftCards->search($spySalesOrderItemGiftCard);
            $this->collSpySalesOrderItemGiftCards->remove($pos);
            if (null === $this->spySalesOrderItemGiftCardsScheduledForDeletion) {
                $this->spySalesOrderItemGiftCardsScheduledForDeletion = clone $this->collSpySalesOrderItemGiftCards;
                $this->spySalesOrderItemGiftCardsScheduledForDeletion->clear();
            }
            $this->spySalesOrderItemGiftCardsScheduledForDeletion[]= clone $spySalesOrderItemGiftCard;
            $spySalesOrderItemGiftCard->setSpySalesOrderItem(null);
        }
    ...
    public function clearAllReferences(bool $deep = false)
    {
        if ($deep) {
            ...
            if ($this->collSpySalesOrderItemGiftCards) {
                foreach ($this->collSpySalesOrderItemGiftCards as $o) {
                    $o->clearAllReferences($deep);
                }
            }
            if ($this->collOptions) {
