 ...
 * @method     ChildSpySalesOrderCommentQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderCommentQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpySalesOrderComment|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrderComment filtered by the uuid column
 ...
 * @method     ChildSpySalesOrderComment requireOneByUuid(string $uuid) Return the first ChildSpySalesOrderComment filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrderComment[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderComment objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderComment objects filtered by the uuid column
...
abstract class SpySalesOrderCommentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_comment, fk_sales_order, message, username, uuid, created_at, updated_at FROM spy_sales_order_comment WHERE id_sales_order_comment = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderCommentTableMap::COL_UUID, $uuid, $comparison);
