 ...
 * @method     ChildSpySalesOrderAddressHistoryQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderAddressHistoryQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpySalesOrderAddressHistory|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrderAddressHistory filtered by the uuid column
 ...
 * @method     ChildSpySalesOrderAddressHistory requireOneByUuid(string $uuid) Return the first ChildSpySalesOrderAddressHistory filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrderAddressHistory[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderAddressHistory objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderAddressHistory> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderAddressHistory objects filtered by the uuid column
...
abstract class SpySalesOrderAddressHistoryQuery extends ModelCriteria
{
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderAddressHistoryTableMap::COL_UUID, $uuid, $comparison);
