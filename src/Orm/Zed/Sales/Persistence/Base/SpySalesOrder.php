...
abstract class SpySalesOrder implements ActiveRecordInterface
{
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpySalesOrderTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpySalesOrderTableMap::translateFieldName('CurrencyIsoCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->currency_iso_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpySalesOrderTableMap::translateFieldName('CustomerReference', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_reference = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpySalesOrderTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SpySalesOrderTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SpySalesOrderTableMap::translateFieldName('IsTest', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_test = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SpySalesOrderTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SpySalesOrderTableMap::translateFieldName('OmsProcessorIdentifier', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oms_processor_identifier = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SpySalesOrderTableMap::translateFieldName('OrderCustomReference', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_custom_reference = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SpySalesOrderTableMap::translateFieldName('OrderReference', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_reference = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : SpySalesOrderTableMap::translateFieldName('PriceMode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_mode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : SpySalesOrderTableMap::translateFieldName('Salutation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salutation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SpySalesOrderTableMap::translateFieldName('Store', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SpySalesOrderTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : SpySalesOrderTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : SpySalesOrderTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 20; // 20 = SpySalesOrderTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpySalesOrderTableMap::COL_UUID)) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[5] => $this->getCurrencyIsoCode(),
            $keys[6] => $this->getCustomerReference(),
            $keys[7] => $this->getEmail(),
            $keys[8] => $this->getFirstName(),
            $keys[9] => $this->getIsTest(),
            $keys[10] => $this->getLastName(),
            $keys[11] => $this->getOmsProcessorIdentifier(),
            $keys[12] => $this->getOrderCustomReference(),
            $keys[13] => $this->getOrderReference(),
            $keys[14] => $this->getPriceMode(),
            $keys[15] => $this->getSalutation(),
            $keys[16] => $this->getStore(),
            $keys[17] => $this->getUuid(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setCurrencyIsoCode($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setCustomerReference($arr[$keys[6]]);
        }
        ...
        if (array_key_exists($keys[9], $arr)) {
            $this->setIsTest($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setLastName($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setOmsProcessorIdentifier($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setOrderCustomReference($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setOrderReference($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setPriceMode($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setSalutation($arr[$keys[15]]);
        }
        if (array_key_exists($keys[16], $arr)) {
            $this->setStore($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setUuid($arr[$keys[17]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpySalesOrderTableMap::COL_UUID)) {
            $criteria->add(SpySalesOrderTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpySalesOrderTableMap::COL_CREATED_AT)) {
    ...
    public function setSpyGiftCardBalanceLogs(Collection $spyGiftCardBalanceLogs, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($spyGiftCardBalanceLogsToDelete as $spyGiftCardBalanceLogRemoved) {
            $spyGiftCardBalanceLogRemoved->setSpySalesOrder(null);
        }
    ...
    protected function doAddSpyGiftCardBalanceLog(SpyGiftCardBalanceLog $spyGiftCardBalanceLog): void
    {
        ...
        $spyGiftCardBalanceLog->setSpySalesOrder($this);
    }
    ...
    public function removeSpyGiftCardBalanceLog(SpyGiftCardBalanceLog $spyGiftCardBalanceLog)
    {
        if ($this->getSpyGiftCardBalanceLogs()->contains($spyGiftCardBalanceLog)) {
            ...
            $spyGiftCardBalanceLog->setSpySalesOrder(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpyGiftCardBalanceLog}> List of SpyGiftCardBalanceLog objects
     */
    public function getSpyGiftCardBalanceLogsJoinSpyGiftCard(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpyGiftCardBalanceLogQuery::create(null, $criteria);
        $query->joinWith('SpyGiftCard', $joinBehavior);
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_sales_order' . '.' . $this->getIdSalesOrder() . '.' . $this->getOrderReference() . '.' . $this->getStore();
