 ...
 * @method     ChildSpySalesOrderItemMetadataQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderItemMetadataQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpySalesOrderItemMetadata|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrderItemMetadata filtered by the uuid column
 ...
 * @method     ChildSpySalesOrderItemMetadata requireOneByUuid(string $uuid) Return the first ChildSpySalesOrderItemMetadata filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrderItemMetadata[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderItemMetadata objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderItemMetadata> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderItemMetadata objects filtered by the uuid column
...
abstract class SpySalesOrderItemMetadataQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_item_metadata, fk_sales_order_item, image, super_attributes, uuid, created_at, updated_at FROM spy_sales_order_item_metadata WHERE id_sales_order_item_metadata = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderItemMetadataTableMap::COL_UUID, $uuid, $comparison);
