 ...
 * @method     ChildSpySalesOrderQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderQuery groupByUuid() Group by the uuid column
 ...
 *
 * @method     ChildSpySalesOrderQuery leftJoinSpyGiftCardBalanceLog($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyGiftCardBalanceLog relation
 * @method     ChildSpySalesOrderQuery rightJoinSpyGiftCardBalanceLog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyGiftCardBalanceLog relation
 * @method     ChildSpySalesOrderQuery innerJoinSpyGiftCardBalanceLog($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyGiftCardBalanceLog relation
 *
 * @method     ChildSpySalesOrderQuery joinWithSpyGiftCardBalanceLog($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyGiftCardBalanceLog relation
 *
 * @method     ChildSpySalesOrderQuery leftJoinWithSpyGiftCardBalanceLog() Adds a LEFT JOIN clause and with to the query using the SpyGiftCardBalanceLog relation
 * @method     ChildSpySalesOrderQuery rightJoinWithSpyGiftCardBalanceLog() Adds a RIGHT JOIN clause and with to the query using the SpyGiftCardBalanceLog relation
 * @method     ChildSpySalesOrderQuery innerJoinWithSpyGiftCardBalanceLog() Adds a INNER JOIN clause and with to the query using the SpyGiftCardBalanceLog relation
 *
 ...
 * @method     ChildSpySalesOrder|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrder filtered by the uuid column
 ...
 * @method     ChildSpySalesOrder requireOneByUuid(string $uuid) Return the first ChildSpySalesOrder filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrder[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrder objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrder> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrder objects filtered by the uuid column
...
abstract class SpySalesOrderQuery extends ModelCriteria
{
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderTableMap::COL_UUID, $uuid, $comparison);
    ...
    public function filterBySpyGiftCardBalanceLog($spyGiftCardBalanceLog, ?string $comparison = null)
    {
        if ($spyGiftCardBalanceLog instanceof \Orm\Zed\GiftCardBalance\Persistence\SpyGiftCardBalanceLog) {
            $this
                ->addUsingAlias(SpySalesOrderTableMap::COL_ID_SALES_ORDER, $spyGiftCardBalanceLog->getFkSalesOrder(), $comparison);
