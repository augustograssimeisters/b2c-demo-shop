 ...
 * @method     ChildSpySalesOrderTotalsQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpySalesOrderTotalsQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpySalesOrderTotals|null findOneByUuid(string $uuid) Return the first ChildSpySalesOrderTotals filtered by the uuid column
 ...
 * @method     ChildSpySalesOrderTotals requireOneByUuid(string $uuid) Return the first ChildSpySalesOrderTotals filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpySalesOrderTotals[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderTotals objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByUuid(string|array<string> $uuid) Return ChildSpySalesOrderTotals objects filtered by the uuid column
...
abstract class SpySalesOrderTotalsQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_totals, fk_sales_order, canceled_total, discount_total, grand_total, order_expense_total, refund_total, subtotal, tax_total, uuid, created_at, updated_at FROM spy_sales_order_totals WHERE id_sales_order_totals = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_UUID, $uuid, $comparison);
