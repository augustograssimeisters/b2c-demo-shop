...
class SpySearchHttpConfigTableMap extends TableMap
{
     ...
     */
    public const COL_STORE = 'spy_search_http_config.store';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSearchHttpConfig', 'Store', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSearchHttpConfig', 'store', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySearchHttpConfigTableMap::COL_ID_SEARCH_HTTP_CONFIG, SpySearchHttpConfigTableMap::COL_STORE, SpySearchHttpConfigTableMap::COL_DATA, SpySearchHttpConfigTableMap::COL_ALIAS_KEYS, SpySearchHttpConfigTableMap::COL_KEY, SpySearchHttpConfigTableMap::COL_CREATED_AT, SpySearchHttpConfigTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_search_http_config', 'store', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSearchHttpConfig' => 0, 'Store' => 1, 'Data' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idSearchHttpConfig' => 0, 'store' => 1, 'data' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpySearchHttpConfigTableMap::COL_ID_SEARCH_HTTP_CONFIG => 0, SpySearchHttpConfigTableMap::COL_STORE => 1, SpySearchHttpConfigTableMap::COL_DATA => 2, SpySearchHttpConfigTableMap::COL_ALIAS_KEYS => 3, SpySearchHttpConfigTableMap::COL_KEY => 4, SpySearchHttpConfigTableMap::COL_CREATED_AT => 5, SpySearchHttpConfigTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_search_http_config' => 0, 'store' => 1, 'data' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Store' => 'STORE',
        'SpySearchHttpConfig.Store' => 'STORE',
        'store' => 'STORE',
        'spySearchHttpConfig.store' => 'STORE',
        'SpySearchHttpConfigTableMap::COL_STORE' => 'STORE',
        'COL_STORE' => 'STORE',
        'spy_search_http_config.store' => 'STORE',
        'Data' => 'DATA',
    ...
    {
        return [
            'synchronization' => ['resource' => ['value' => 'search_http_config'], 'queue_group' => ['value' => 'sync.http.search.config'], 'queue_pool' => NULL, 'store' => ['required' => 'true']],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpySearchHttpConfigTableMap::COL_STORE);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpySearchHttpConfigTableMap::COL_STORE);
