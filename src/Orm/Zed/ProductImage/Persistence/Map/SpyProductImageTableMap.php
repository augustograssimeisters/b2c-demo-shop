...
class SpyProductImageTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_product_image.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductImage', 'ExternalUrlLarge', 'ExternalUrlSmall', 'ProductImageKey', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductImage', 'externalUrlLarge', 'externalUrlSmall', 'productImageKey', 'uuid', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE, SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL, SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY, SpyProductImageTableMap::COL_UUID, SpyProductImageTableMap::COL_CREATED_AT, SpyProductImageTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_image', 'external_url_large', 'external_url_small', 'product_image_key', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductImage' => 0, 'ExternalUrlLarge' => 1, 'ExternalUrlSmall' => 2, 'ProductImageKey' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idProductImage' => 0, 'externalUrlLarge' => 1, 'externalUrlSmall' => 2, 'productImageKey' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE => 0, SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE => 1, SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL => 2, SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY => 3, SpyProductImageTableMap::COL_UUID => 4, SpyProductImageTableMap::COL_CREATED_AT => 5, SpyProductImageTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_product_image' => 0, 'external_url_large' => 1, 'external_url_small' => 2, 'product_image_key' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpyProductImage.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spyProductImage.uuid' => 'UUID',
        'SpyProductImageTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_product_image.uuid' => 'UUID',
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_product_image'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyProductImageTableMap::COL_UUID);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyProductImageTableMap::COL_UUID);
