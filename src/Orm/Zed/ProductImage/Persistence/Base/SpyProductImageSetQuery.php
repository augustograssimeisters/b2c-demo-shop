 ...
 * @method     ChildSpyProductImageSetQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpyProductImageSetQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpyProductImageSet|null findOneByUuid(string $uuid) Return the first ChildSpyProductImageSet filtered by the uuid column
 ...
 * @method     ChildSpyProductImageSet requireOneByUuid(string $uuid) Return the first ChildSpyProductImageSet filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpyProductImageSet[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyProductImageSet objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyProductImageSet> findByUuid(string|array<string> $uuid) Return ChildSpyProductImageSet objects filtered by the uuid column
...
abstract class SpyProductImageSetQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_product_image_set, fk_locale, fk_product, fk_product_abstract, fk_resource_configurable_bundle_template, fk_resource_product_set, name, product_image_set_key, uuid, created_at, updated_at FROM spy_product_image_set WHERE id_product_image_set = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyProductImageSetTableMap::COL_UUID, $uuid, $comparison);
