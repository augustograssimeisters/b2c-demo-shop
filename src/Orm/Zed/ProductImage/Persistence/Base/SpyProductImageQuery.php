 ...
 * @method     ChildSpyProductImageQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpyProductImageQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpyProductImage|null findOneByUuid(string $uuid) Return the first ChildSpyProductImage filtered by the uuid column
 ...
 * @method     ChildSpyProductImage requireOneByUuid(string $uuid) Return the first ChildSpyProductImage filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpyProductImage[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyProductImage objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyProductImage> findByUuid(string|array<string> $uuid) Return ChildSpyProductImage objects filtered by the uuid column
...
abstract class SpyProductImageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_product_image, external_url_large, external_url_small, product_image_key, uuid, created_at, updated_at FROM spy_product_image WHERE id_product_image = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyProductImageTableMap::COL_UUID, $uuid, $comparison);
