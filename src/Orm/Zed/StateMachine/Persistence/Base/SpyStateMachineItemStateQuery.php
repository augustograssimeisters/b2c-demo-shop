...
abstract class SpyStateMachineItemStateQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItem object
     *
     * @param \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItem|ObjectCollection $exampleStateMachineItem the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByStateMachineItemState($exampleStateMachineItem, ?string $comparison = null)
    {
        if ($exampleStateMachineItem instanceof \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItem) {
            $this
                ->addUsingAlias(SpyStateMachineItemStateTableMap::COL_ID_STATE_MACHINE_ITEM_STATE, $exampleStateMachineItem->getFkStateMachineItemState(), $comparison);

            return $this;
        } elseif ($exampleStateMachineItem instanceof ObjectCollection) {
            $this
                ->useStateMachineItemStateQuery()
                ->filterByPrimaryKeys($exampleStateMachineItem->getPrimaryKeys())
                ->endUse();

            return $this;
        } else {
            throw new PropelException('filterByStateMachineItemState() only accepts arguments of type \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItem or Collection');
        }
    }
    ...
    /**
     * Use the StateMachineItemState relation ExampleStateMachineItem object
     *
     * @see useQuery()
     *
     * @param string $relationAlias optional alias for the relation,
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery A secondary query class using the current class as primary query
     */
    public function useStateMachineItemStateQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'StateMachineItemState', '\Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery');
    }

    /**
     * Use the StateMachineItemState relation ExampleStateMachineItem object
     *
     * @param callable(\Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery):\Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
    ...
    /**
     * Use the StateMachineItemState relation to the ExampleStateMachineItem table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery The inner query object of the EXISTS statement
     */
    public function useStateMachineItemStateExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery */
        $q = $this->useExistsQuery('StateMachineItemState', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the StateMachineItemState relation to the ExampleStateMachineItem table for a NOT EXISTS query.
     *
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery The inner query object of the NOT EXISTS statement
     */
    ...
    /**
     * Use the StateMachineItemState relation to the ExampleStateMachineItem table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery The inner query object of the IN statement
     */
    ...
    /**
     * Use the StateMachineItemState relation to the ExampleStateMachineItem table for a NOT IN query.
     *
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItemQuery The inner query object of the NOT IN statement
     */
