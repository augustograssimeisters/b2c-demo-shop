...
abstract class SpyStateMachineItemState implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|ExampleStateMachineItem[] Collection to store aggregation of ExampleStateMachineItem objects.
     * @phpstan-var ObjectCollection&\Traversable<ExampleStateMachineItem> Collection to store aggregation of ExampleStateMachineItem objects.
     */
     ...
     * @var ObjectCollection|ExampleStateMachineItem[]
     * @phpstan-var ObjectCollection&\Traversable<ExampleStateMachineItem>
     */
    ...
    public function initStateMachineItemStates(bool $overrideExisting = true): void
    {
        ...
        $collectionClassName = ExampleStateMachineItemTableMap::getTableMap()->getCollectionClassName();

        $this->collStateMachineItemStates = new $collectionClassName;
        $this->collStateMachineItemStates->setModel('\Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItem');
    }

    /**
     * Gets an array of ExampleStateMachineItem objects which contain a foreign key that references this object.
     *
     ...
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|ExampleStateMachineItem[] List of ExampleStateMachineItem objects
     * @phpstan-return ObjectCollection&\Traversable<ExampleStateMachineItem> List of ExampleStateMachineItem objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collStateMachineItemStates || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collStateMachineItemStates) {
                    ...
                    $collStateMachineItemStates->setModel('\Orm\Zed\ExampleStateMachine\Persistence\ExampleStateMachineItem');

                    return $collStateMachineItemStates;
                }
            } else {
                $collStateMachineItemStates = ExampleStateMachineItemQuery::create(null, $criteria)
                    ->filterByState($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ExampleStateMachineItem objects related by a one-to-many relationship
    ...
    {
        /** @var ExampleStateMachineItem[] $stateMachineItemStatesToDelete */
    ...
    /**
     * Returns the number of related BaseExampleStateMachineItem objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related BaseExampleStateMachineItem objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countStateMachineItemStates(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        ...
        if (null === $this->collStateMachineItemStates || null !== $criteria || $partial) {
            ...
            $query = ExampleStateMachineItemQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ExampleStateMachineItem object to this object
     * through the ExampleStateMachineItem foreign key attribute.
     *
     * @param ExampleStateMachineItem $l ExampleStateMachineItem
     * @return $this The current object (for fluent API support)
     */
    public function addStateMachineItemState(ExampleStateMachineItem $l)
    {
        if ($this->collStateMachineItemStates === null) {
            $this->initStateMachineItemStates();
            $this->collStateMachineItemStatesPartial = true;
    ...
    /**
     * @param ExampleStateMachineItem $stateMachineItemState The ExampleStateMachineItem object to add.
     */
    protected function doAddStateMachineItemState(ExampleStateMachineItem $stateMachineItemState): void
    {
    ...
    /**
     * @param ExampleStateMachineItem $stateMachineItemState The ExampleStateMachineItem object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeStateMachineItemState(ExampleStateMachineItem $stateMachineItemState)
    {
