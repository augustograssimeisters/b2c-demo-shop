 ...
 * @method     ChildSpyUserQuery orderByIsWarehouseUser($order = Criteria::ASC) Order by the is_warehouse_user column
 ...
 * @method     ChildSpyUserQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpyUserQuery groupByIsWarehouseUser() Group by the is_warehouse_user column
 ...
 * @method     ChildSpyUserQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpyUser|null findOneByIsWarehouseUser(boolean $is_warehouse_user) Return the first ChildSpyUser filtered by the is_warehouse_user column
 ...
 * @method     ChildSpyUser|null findOneByUuid(string $uuid) Return the first ChildSpyUser filtered by the uuid column
 ...
 * @method     ChildSpyUser requireOneByIsWarehouseUser(boolean $is_warehouse_user) Return the first ChildSpyUser filtered by the is_warehouse_user column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpyUser requireOneByUuid(string $uuid) Return the first ChildSpyUser filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpyUser[]|Collection findByIsWarehouseUser(boolean|array<boolean> $is_warehouse_user) Return ChildSpyUser objects filtered by the is_warehouse_user column
 * @psalm-method Collection&\Traversable<ChildSpyUser> findByIsWarehouseUser(boolean|array<boolean> $is_warehouse_user) Return ChildSpyUser objects filtered by the is_warehouse_user column
 ...
 * @method     ChildSpyUser[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyUser objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyUser> findByUuid(string|array<string> $uuid) Return ChildSpyUser objects filtered by the uuid column
...
abstract class SpyUserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_user, fk_locale, first_name, is_agent, is_warehouse_user, last_login, last_name, password, status, username, uuid, created_at, updated_at FROM spy_user WHERE id_user = :p0';
        try {
    ...
    public function filterByIsWarehouseUser($isWarehouseUser = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyUserTableMap::COL_IS_WAREHOUSE_USER, $isWarehouseUser, $comparison);
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyUserTableMap::COL_UUID, $uuid, $comparison);
