...
abstract class SpyUser implements ActiveRecordInterface
{
    ...
    public function setIsWarehouseUser($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->is_warehouse_user !== $v) {
            ...
            $this->modifiedColumns[SpyUserTableMap::COL_IS_WAREHOUSE_USER] = true;
        }
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyUserTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyUserTableMap::translateFieldName('IsWarehouseUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SpyUserTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SpyUserTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SpyUserTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 13; // 13 = SpyUserTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyUserTableMap::COL_IS_WAREHOUSE_USER)) {
        ...
        if ($this->isColumnModified(SpyUserTableMap::COL_UUID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyUserTableMap::COL_IS_WAREHOUSE_USER)) {
            $criteria->add(SpyUserTableMap::COL_IS_WAREHOUSE_USER, $this->is_warehouse_user);
        }
        if ($this->isColumnModified(SpyUserTableMap::COL_LAST_LOGIN)) {
        ...
        if ($this->isColumnModified(SpyUserTableMap::COL_UUID)) {
            $criteria->add(SpyUserTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpyUserTableMap::COL_CREATED_AT)) {
    ...
    public function populateFromArchive($archive, bool $populateAutoIncrementPrimaryKeys = false)
    {
        ...
        $this->setIsWarehouseUser($archive->getIsWarehouseUser());
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_user' . '.' . $this->getIdUser() . '.' . $this->getUsername();
