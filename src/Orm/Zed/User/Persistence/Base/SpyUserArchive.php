...
abstract class SpyUserArchive implements ActiveRecordInterface
{
    ...
    /**
     * The value for the is_warehouse_user field.
     *
     * @var        boolean|null
     */
    protected $is_warehouse_user;
    ...
    /**
     * Get the [is_warehouse_user] column value.
     *
     * @return boolean|null
     */
    public function getIsWarehouseUser()
    {
        return $this->is_warehouse_user;
    }
    ...
    {
        return $this->getIsWarehouseUser();
    }
    ...
    /**
     * Sets the value of the [is_warehouse_user] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setIsWarehouseUser($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->is_warehouse_user !== $v) {
            $this->is_warehouse_user = $v;
            $this->modifiedColumns[SpyUserArchiveTableMap::COL_IS_WAREHOUSE_USER] = true;
        }
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyUserArchiveTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyUserArchiveTableMap::translateFieldName('IsWarehouseUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_warehouse_user = (null !== $col) ? (boolean) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SpyUserArchiveTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SpyUserArchiveTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SpyUserArchiveTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SpyUserArchiveTableMap::translateFieldName('ArchivedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 14; // 14 = SpyUserArchiveTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyUserArchiveTableMap::COL_IS_WAREHOUSE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'is_warehouse_user';
        }
        ...
        if ($this->isColumnModified(SpyUserArchiveTableMap::COL_UUID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'is_agent':
                        ...
                        break;
                    case 'is_warehouse_user':
                        $stmt->bindValue($identifier, (int) $this->is_warehouse_user, PDO::PARAM_INT);
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[4] => $this->getIsWarehouseUser(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setIsWarehouseUser($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyUserArchiveTableMap::COL_IS_WAREHOUSE_USER)) {
            $criteria->add(SpyUserArchiveTableMap::COL_IS_WAREHOUSE_USER, $this->is_warehouse_user);
        }
        if ($this->isColumnModified(SpyUserArchiveTableMap::COL_LAST_LOGIN)) {
        ...
        if ($this->isColumnModified(SpyUserArchiveTableMap::COL_UUID)) {
            $criteria->add(SpyUserArchiveTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpyUserArchiveTableMap::COL_CREATED_AT)) {
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setIsWarehouseUser($this->getIsWarehouseUser());
