 ...
 * @method     ChildSpyUserArchiveQuery orderByIsWarehouseUser($order = Criteria::ASC) Order by the is_warehouse_user column
 ...
 * @method     ChildSpyUserArchiveQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpyUserArchiveQuery groupByIsWarehouseUser() Group by the is_warehouse_user column
 ...
 * @method     ChildSpyUserArchiveQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpyUserArchive|null findOneByIsWarehouseUser(boolean $is_warehouse_user) Return the first ChildSpyUserArchive filtered by the is_warehouse_user column
 ...
 * @method     ChildSpyUserArchive|null findOneByUuid(string $uuid) Return the first ChildSpyUserArchive filtered by the uuid column
 ...
 * @method     ChildSpyUserArchive requireOneByIsWarehouseUser(boolean $is_warehouse_user) Return the first ChildSpyUserArchive filtered by the is_warehouse_user column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpyUserArchive requireOneByUuid(string $uuid) Return the first ChildSpyUserArchive filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSpyUserArchive[]|Collection findByIsWarehouseUser(boolean|array<boolean> $is_warehouse_user) Return ChildSpyUserArchive objects filtered by the is_warehouse_user column
 * @psalm-method Collection&\Traversable<ChildSpyUserArchive> findByIsWarehouseUser(boolean|array<boolean> $is_warehouse_user) Return ChildSpyUserArchive objects filtered by the is_warehouse_user column
 ...
 * @method     ChildSpyUserArchive[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyUserArchive objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyUserArchive> findByUuid(string|array<string> $uuid) Return ChildSpyUserArchive objects filtered by the uuid column
...
abstract class SpyUserArchiveQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_user, fk_locale, first_name, is_agent, is_warehouse_user, last_login, last_name, password, status, username, uuid, created_at, updated_at, archived_at FROM spy_user_archive WHERE id_user = :p0';
        try {
    ...
    /**
     * Filter the query on the is_warehouse_user column
     *
     * Example usage:
     * <code>
     * $query->filterByIsWarehouseUser(true); // WHERE is_warehouse_user = true
     * $query->filterByIsWarehouseUser('yes'); // WHERE is_warehouse_user = true
     * </code>
     *
     * @param     bool|string $isWarehouseUser The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @throws \Spryker\Zed\Propel\Business\Exception\AmbiguousComparisonException
     */
    public function filterByIsWarehouseUser($isWarehouseUser = null, $comparison = Criteria::EQUAL)
    {
        if (is_string($isWarehouseUser)) {
            $isWarehouseUser = in_array(strtolower($isWarehouseUser), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        $query = $this->addUsingAlias(SpyUserArchiveTableMap::COL_IS_WAREHOUSE_USER, $isWarehouseUser, $comparison);
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyUserArchiveTableMap::COL_UUID, $uuid, $comparison);
