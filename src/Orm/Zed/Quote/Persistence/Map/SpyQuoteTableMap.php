...
class SpyQuoteTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdQuote', 'FkStore', 'CustomerReference', 'QuoteData', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idQuote', 'fkStore', 'customerReference', 'quoteData', 'uuid', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyQuoteTableMap::COL_ID_QUOTE, SpyQuoteTableMap::COL_FK_STORE, SpyQuoteTableMap::COL_CUSTOMER_REFERENCE, SpyQuoteTableMap::COL_QUOTE_DATA, SpyQuoteTableMap::COL_UUID, SpyQuoteTableMap::COL_CREATED_AT, SpyQuoteTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_quote', 'fk_store', 'customer_reference', 'quote_data', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdQuote' => 0, 'FkStore' => 1, 'CustomerReference' => 2, 'QuoteData' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idQuote' => 0, 'fkStore' => 1, 'customerReference' => 2, 'quoteData' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpyQuoteTableMap::COL_ID_QUOTE => 0, SpyQuoteTableMap::COL_FK_STORE => 1, SpyQuoteTableMap::COL_CUSTOMER_REFERENCE => 2, SpyQuoteTableMap::COL_QUOTE_DATA => 3, SpyQuoteTableMap::COL_UUID => 4, SpyQuoteTableMap::COL_CREATED_AT => 5, SpyQuoteTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_quote' => 0, 'fk_store' => 1, 'customer_reference' => 2, 'quote_data' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
