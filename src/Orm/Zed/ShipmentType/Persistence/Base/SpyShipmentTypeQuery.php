 ...
 *
 * @method     \Orm\Zed\Shipment\Persistence\SpyShipmentMethodQuery|\Orm\Zed\ShipmentType\Persistence\SpyShipmentTypeStoreQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyShipmentTypeQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_shipment_type`, `uuid`, `name`, `key`, `is_active` FROM `spy_shipment_type` WHERE `id_shipment_type` = :p0';
        try {
