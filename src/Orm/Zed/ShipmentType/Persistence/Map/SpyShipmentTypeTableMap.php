...
class SpyShipmentTypeTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdShipmentType', 'Uuid', 'Name', 'Key', 'IsActive', ],
        self::TYPE_CAMELNAME     => ['idShipmentType', 'uuid', 'name', 'key', 'isActive', ],
        self::TYPE_COLNAME       => [SpyShipmentTypeTableMap::COL_ID_SHIPMENT_TYPE, SpyShipmentTypeTableMap::COL_UUID, SpyShipmentTypeTableMap::COL_NAME, SpyShipmentTypeTableMap::COL_KEY, SpyShipmentTypeTableMap::COL_IS_ACTIVE, ],
        self::TYPE_FIELDNAME     => ['id_shipment_type', 'uuid', 'name', 'key', 'is_active', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdShipmentType' => 0, 'Uuid' => 1, 'Name' => 2, 'Key' => 3, 'IsActive' => 4, ],
        self::TYPE_CAMELNAME     => ['idShipmentType' => 0, 'uuid' => 1, 'name' => 2, 'key' => 3, 'isActive' => 4, ],
        self::TYPE_COLNAME       => [SpyShipmentTypeTableMap::COL_ID_SHIPMENT_TYPE => 0, SpyShipmentTypeTableMap::COL_UUID => 1, SpyShipmentTypeTableMap::COL_NAME => 2, SpyShipmentTypeTableMap::COL_KEY => 3, SpyShipmentTypeTableMap::COL_IS_ACTIVE => 4, ],
        self::TYPE_FIELDNAME     => ['id_shipment_type' => 0, 'uuid' => 1, 'name' => 2, 'key' => 3, 'is_active' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
