...
class SpyProductListTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductList', 'Key', 'Title', 'Type', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductList', 'key', 'title', 'type', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductListTableMap::COL_ID_PRODUCT_LIST, SpyProductListTableMap::COL_KEY, SpyProductListTableMap::COL_TITLE, SpyProductListTableMap::COL_TYPE, SpyProductListTableMap::COL_CREATED_AT, SpyProductListTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_list', 'key', 'title', 'type', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductList' => 0, 'Key' => 1, 'Title' => 2, 'Type' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idProductList' => 0, 'key' => 1, 'title' => 2, 'type' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [SpyProductListTableMap::COL_ID_PRODUCT_LIST => 0, SpyProductListTableMap::COL_KEY => 1, SpyProductListTableMap::COL_TITLE => 2, SpyProductListTableMap::COL_TYPE => 3, SpyProductListTableMap::COL_CREATED_AT => 4, SpyProductListTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_product_list' => 0, 'key' => 1, 'title' => 2, 'type' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
