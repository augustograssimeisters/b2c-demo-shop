...
class PyzAntelopeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Antelope.Persistence.Map.PyzAntelopeTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Antelope.Persistence.PyzAntelope';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAntelope', 'Name', 'FkLocation', ],
        self::TYPE_CAMELNAME     => ['idAntelope', 'name', 'fkLocation', ],
        self::TYPE_COLNAME       => [PyzAntelopeTableMap::COL_ID_ANTELOPE, PyzAntelopeTableMap::COL_NAME, PyzAntelopeTableMap::COL_FK_LOCATION, ],
        self::TYPE_FIELDNAME     => ['id_antelope', 'name', 'fk_location', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAntelope' => 0, 'Name' => 1, 'FkLocation' => 2, ],
        self::TYPE_CAMELNAME     => ['idAntelope' => 0, 'name' => 1, 'fkLocation' => 2, ],
        self::TYPE_COLNAME       => [PyzAntelopeTableMap::COL_ID_ANTELOPE => 0, PyzAntelopeTableMap::COL_NAME => 1, PyzAntelopeTableMap::COL_FK_LOCATION => 2, ],
        self::TYPE_FIELDNAME     => ['id_antelope' => 0, 'name' => 1, 'fk_location' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setPackage('src.Orm.Zed.Antelope.Persistence');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('pyz_antelope_pk_seq');
        // columns
