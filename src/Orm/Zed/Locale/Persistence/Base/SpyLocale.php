...
abstract class SpyLocale implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|SpyPushNotificationSubscription[] Collection to store aggregation of SpyPushNotificationSubscription objects.
     * @phpstan-var ObjectCollection&\Traversable<SpyPushNotificationSubscription> Collection to store aggregation of SpyPushNotificationSubscription objects.
     */
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|SpyPushNotificationSubscription[]
     * @phpstan-var ObjectCollection&\Traversable<SpyPushNotificationSubscription>
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyPushNotificationSubscriptionsScheduledForDeletion !== null) {
                if (!$this->spyPushNotificationSubscriptionsScheduledForDeletion->isEmpty()) {
                    foreach ($this->spyPushNotificationSubscriptionsScheduledForDeletion as $spyPushNotificationSubscription) {
                        // need to save related object because we set the relation to null
                        $spyPushNotificationSubscription->save($con);
                    }
    ...
    /**
     * Gets an array of SpyPushNotificationSubscription objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|SpyPushNotificationSubscription[] List of SpyPushNotificationSubscription objects
     * @phpstan-return ObjectCollection&\Traversable<SpyPushNotificationSubscription> List of SpyPushNotificationSubscription objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getSpyPushNotificationSubscriptions(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpyPushNotificationSubscriptions || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpyPushNotificationSubscriptions = SpyPushNotificationSubscriptionQuery::create(null, $criteria)
                    ->filterBySpyLocale($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of SpyPushNotificationSubscription objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        /** @var SpyPushNotificationSubscription[] $spyPushNotificationSubscriptionsToDelete */
        ...
        foreach ($spyPushNotificationSubscriptionsToDelete as $spyPushNotificationSubscriptionRemoved) {
            $spyPushNotificationSubscriptionRemoved->setSpyLocale(null);
        }
    ...
    /**
     * Returns the number of related BaseSpyPushNotificationSubscription objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related BaseSpyPushNotificationSubscription objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyPushNotificationSubscriptions(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        ...
        if (null === $this->collSpyPushNotificationSubscriptions || null !== $criteria || $partial) {
            ...
            $query = SpyPushNotificationSubscriptionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a SpyPushNotificationSubscription object to this object
     * through the SpyPushNotificationSubscription foreign key attribute.
     *
     * @param SpyPushNotificationSubscription $l SpyPushNotificationSubscription
     * @return $this The current object (for fluent API support)
     */
    public function addSpyPushNotificationSubscription(SpyPushNotificationSubscription $l)
    {
        if ($this->collSpyPushNotificationSubscriptions === null) {
            $this->initSpyPushNotificationSubscriptions();
            $this->collSpyPushNotificationSubscriptionsPartial = true;
    ...
    /**
     * @param SpyPushNotificationSubscription $spyPushNotificationSubscription The SpyPushNotificationSubscription object to add.
     */
    protected function doAddSpyPushNotificationSubscription(SpyPushNotificationSubscription $spyPushNotificationSubscription): void
    {
        $this->collSpyPushNotificationSubscriptions[]= $spyPushNotificationSubscription;
        $spyPushNotificationSubscription->setSpyLocale($this);
    }

    /**
     * @param SpyPushNotificationSubscription $spyPushNotificationSubscription The SpyPushNotificationSubscription object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpyPushNotificationSubscription(SpyPushNotificationSubscription $spyPushNotificationSubscription)
    {
        if ($this->getSpyPushNotificationSubscriptions()->contains($spyPushNotificationSubscription)) {
            ...
            $this->spyPushNotificationSubscriptionsScheduledForDeletion[]= $spyPushNotificationSubscription;
            $spyPushNotificationSubscription->setSpyLocale(null);
        }
