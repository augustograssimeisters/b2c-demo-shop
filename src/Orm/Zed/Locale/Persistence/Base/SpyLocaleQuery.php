 ...
 *
 * @method     ChildSpyLocaleQuery leftJoinSpyPushNotificationSubscription($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyPushNotificationSubscription relation
 * @method     ChildSpyLocaleQuery rightJoinSpyPushNotificationSubscription($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyPushNotificationSubscription relation
 * @method     ChildSpyLocaleQuery innerJoinSpyPushNotificationSubscription($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyPushNotificationSubscription relation
 *
 * @method     ChildSpyLocaleQuery joinWithSpyPushNotificationSubscription($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyPushNotificationSubscription relation
 *
 * @method     ChildSpyLocaleQuery leftJoinWithSpyPushNotificationSubscription() Adds a LEFT JOIN clause and with to the query using the SpyPushNotificationSubscription relation
 * @method     ChildSpyLocaleQuery rightJoinWithSpyPushNotificationSubscription() Adds a RIGHT JOIN clause and with to the query using the SpyPushNotificationSubscription relation
 * @method     ChildSpyLocaleQuery innerJoinWithSpyPushNotificationSubscription() Adds a INNER JOIN clause and with to the query using the SpyPushNotificationSubscription relation
 *
...
abstract class SpyLocaleQuery extends ModelCriteria
{
    ...
    public function filterBySpyPushNotificationSubscription($spyPushNotificationSubscription, ?string $comparison = null)
    {
        if ($spyPushNotificationSubscription instanceof \Orm\Zed\PushNotification\Persistence\SpyPushNotificationSubscription) {
            $this
                ->addUsingAlias(SpyLocaleTableMap::COL_ID_LOCALE, $spyPushNotificationSubscription->getFkLocale(), $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyPushNotificationSubscription(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useSpyPushNotificationSubscriptionQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
