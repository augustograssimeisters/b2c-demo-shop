 ...
 */
abstract class SpyWishlistItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Wishlist\\Persistence\\Map\\SpyWishlistItemTableMap';
    ...
    /**
     * Initializes internal state of Orm\Zed\Wishlist\Persistence\Base\SpyWishlistItem object.
     */
    ...
    public function setIdWishlistItem($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_wishlist_item !== $v) {
    ...
    public function setFkWishlist($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_wishlist !== $v) {
            $this->fk_wishlist = $v;
    ...
    public function setProductConfigurationInstanceData($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->product_configuration_instance_data !== $v) {
            ...
            $this->modifiedColumns[SpyWishlistItemTableMap::COL_PRODUCT_CONFIGURATION_INSTANCE_DATA] = true;
        }
    ...
    public function setSku($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->sku !== $v) {
            $this->sku = $v;
            $this->modifiedColumns[SpyWishlistItemTableMap::COL_SKU] = true;
        }

        if ($this->aSpyProduct !== null && $this->aSpyProduct->getSku() !== $v) {
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyWishlistItemTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyWishlistItemTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyWishlistItemTableMap::translateFieldName('FkWishlist', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_wishlist = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyWishlistItemTableMap::translateFieldName('ProductConfigurationInstanceData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_configuration_instance_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyWishlistItemTableMap::translateFieldName('Sku', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sku = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyWishlistItemTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyWishlistItemTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = SpyWishlistItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\Wishlist\\Persistence\\SpyWishlistItem'), 0, $e);
        }
    }
    ...
    public function ensureConsistency(): void
    {
        ...
        if ($this->aSpyProduct !== null && $this->sku !== $this->aSpyProduct->getSku()) {
            $this->aSpyProduct = null;
        }
    }
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyWishlistItemTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyWishlistItemTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyWishlistItemTableMap::COL_UPDATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyWishlistItemTableMap::COL_PRODUCT_CONFIGURATION_INSTANCE_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'product_configuration_instance_data';
        }
        if ($this->isColumnModified(SpyWishlistItemTableMap::COL_SKU)) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[1] => $this->getFkWishlist(),
            $keys[2] => $this->getProductConfigurationInstanceData(),
            $keys[3] => $this->getSku(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setFkWishlist($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setProductConfigurationInstanceData($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyWishlistItemTableMap::COL_PRODUCT_CONFIGURATION_INSTANCE_DATA)) {
            $criteria->add(SpyWishlistItemTableMap::COL_PRODUCT_CONFIGURATION_INSTANCE_DATA, $this->product_configuration_instance_data);
        }
        if ($this->isColumnModified(SpyWishlistItemTableMap::COL_SKU)) {
            $criteria->add(SpyWishlistItemTableMap::COL_SKU, $this->sku);
        }
        if ($this->isColumnModified(SpyWishlistItemTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyWishlistItemTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyWishlistItemTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyWishlistItemTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\Wishlist\Persistence\SpyWishlistItem (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\Wishlist\Persistence\SpyWishlistItem Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aSpyWishlist === null && ($this->fk_wishlist != 0)) {
    ...
    {
        if ($this->aSpyProduct === null && (($this->sku !== "" && $this->sku !== null))) {
            $this->aSpyProduct = SpyProductQuery::create()
                ->filterBySpyWishlistItem($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
