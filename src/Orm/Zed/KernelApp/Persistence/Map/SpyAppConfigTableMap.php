...
class SpyAppConfigTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAppConfig', 'AppIdentifier', 'Status', 'IsActive', 'Config', ],
        self::TYPE_CAMELNAME     => ['idAppConfig', 'appIdentifier', 'status', 'isActive', 'config', ],
        self::TYPE_COLNAME       => [SpyAppConfigTableMap::COL_ID_APP_CONFIG, SpyAppConfigTableMap::COL_APP_IDENTIFIER, SpyAppConfigTableMap::COL_STATUS, SpyAppConfigTableMap::COL_IS_ACTIVE, SpyAppConfigTableMap::COL_CONFIG, ],
        self::TYPE_FIELDNAME     => ['id_app_config', 'app_identifier', 'status', 'is_active', 'config', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAppConfig' => 0, 'AppIdentifier' => 1, 'Status' => 2, 'IsActive' => 3, 'Config' => 4, ],
        self::TYPE_CAMELNAME     => ['idAppConfig' => 0, 'appIdentifier' => 1, 'status' => 2, 'isActive' => 3, 'config' => 4, ],
        self::TYPE_COLNAME       => [SpyAppConfigTableMap::COL_ID_APP_CONFIG => 0, SpyAppConfigTableMap::COL_APP_IDENTIFIER => 1, SpyAppConfigTableMap::COL_STATUS => 2, SpyAppConfigTableMap::COL_IS_ACTIVE => 3, SpyAppConfigTableMap::COL_CONFIG => 4, ],
        self::TYPE_FIELDNAME     => ['id_app_config' => 0, 'app_identifier' => 1, 'status' => 2, 'is_active' => 3, 'config' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
