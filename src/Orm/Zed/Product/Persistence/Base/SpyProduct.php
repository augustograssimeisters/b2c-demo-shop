...
abstract class SpyProduct implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|SpyGiftCardProductConfigurationLink[] Collection to store aggregation of SpyGiftCardProductConfigurationLink objects.
     * @phpstan-var ObjectCollection&\Traversable<SpyGiftCardProductConfigurationLink> Collection to store aggregation of SpyGiftCardProductConfigurationLink objects.
     */
    ...
    /**
     * @var        ObjectCollection|SpyWishlistItem[] Collection to store aggregation of SpyWishlistItem objects.
     * @phpstan-var ObjectCollection&\Traversable<SpyWishlistItem> Collection to store aggregation of SpyWishlistItem objects.
     */
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|SpyGiftCardProductConfigurationLink[]
     * @phpstan-var ObjectCollection&\Traversable<SpyGiftCardProductConfigurationLink>
     */
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|SpyWishlistItem[]
     * @phpstan-var ObjectCollection&\Traversable<SpyWishlistItem>
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyWishlistItemsScheduledForDeletion !== null) {
                if (!$this->spyWishlistItemsScheduledForDeletion->isEmpty()) {
                    \Orm\Zed\Wishlist\Persistence\SpyWishlistItemQuery::create()
    ...
    /**
     * Gets an array of SpyGiftCardProductConfigurationLink objects which contain a foreign key that references this object.
     *
     ...
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|SpyGiftCardProductConfigurationLink[] List of SpyGiftCardProductConfigurationLink objects
     * @phpstan-return ObjectCollection&\Traversable<SpyGiftCardProductConfigurationLink> List of SpyGiftCardProductConfigurationLink objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getSpyGiftCardProductConfigurationLinks(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpyGiftCardProductConfigurationLinks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpyGiftCardProductConfigurationLinks = SpyGiftCardProductConfigurationLinkQuery::create(null, $criteria)
    ...
    /**
     * Sets a collection of SpyGiftCardProductConfigurationLink objects related by a one-to-many relationship
    ...
    {
        /** @var SpyGiftCardProductConfigurationLink[] $spyGiftCardProductConfigurationLinksToDelete */
        ...
        foreach ($spyGiftCardProductConfigurationLinksToDelete as $spyGiftCardProductConfigurationLinkRemoved) {
            $spyGiftCardProductConfigurationLinkRemoved->setSpyProduct(null);
        }
    ...
    /**
     * Returns the number of related BaseSpyGiftCardProductConfigurationLink objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related BaseSpyGiftCardProductConfigurationLink objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyGiftCardProductConfigurationLinks(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        ...
        if (null === $this->collSpyGiftCardProductConfigurationLinks || null !== $criteria || $partial) {
            ...
            $query = SpyGiftCardProductConfigurationLinkQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a SpyGiftCardProductConfigurationLink object to this object
     * through the SpyGiftCardProductConfigurationLink foreign key attribute.
     *
     * @param SpyGiftCardProductConfigurationLink $l SpyGiftCardProductConfigurationLink
     * @return $this The current object (for fluent API support)
     */
    public function addSpyGiftCardProductConfigurationLink(SpyGiftCardProductConfigurationLink $l)
    {
        if ($this->collSpyGiftCardProductConfigurationLinks === null) {
            $this->initSpyGiftCardProductConfigurationLinks();
            $this->collSpyGiftCardProductConfigurationLinksPartial = true;
    ...
    /**
     * @param SpyGiftCardProductConfigurationLink $spyGiftCardProductConfigurationLink The SpyGiftCardProductConfigurationLink object to add.
     */
    protected function doAddSpyGiftCardProductConfigurationLink(SpyGiftCardProductConfigurationLink $spyGiftCardProductConfigurationLink): void
    {
        $this->collSpyGiftCardProductConfigurationLinks[]= $spyGiftCardProductConfigurationLink;
        $spyGiftCardProductConfigurationLink->setSpyProduct($this);
    }

    /**
     * @param SpyGiftCardProductConfigurationLink $spyGiftCardProductConfigurationLink The SpyGiftCardProductConfigurationLink object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpyGiftCardProductConfigurationLink(SpyGiftCardProductConfigurationLink $spyGiftCardProductConfigurationLink)
    {
        if ($this->getSpyGiftCardProductConfigurationLinks()->contains($spyGiftCardProductConfigurationLink)) {
            ...
            $spyGiftCardProductConfigurationLink->setSpyProduct(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpyGiftCardProductConfigurationLink}> List of SpyGiftCardProductConfigurationLink objects
     */
    public function getSpyGiftCardProductConfigurationLinksJoinSpyGiftCardProductConfiguration(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpyGiftCardProductConfigurationLinkQuery::create(null, $criteria);
        $query->joinWith('SpyGiftCardProductConfiguration', $joinBehavior);
     ...
     * @return void
     */
    public function resetPartialSpyProductBundlesRelatedByFkBundledProduct($v = true): void
    {
     ...
     * @return void
     */
    public function initSpyProductBundlesRelatedByFkBundledProduct(bool $overrideExisting = true): void
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyProductBundlesRelatedByFkBundledProduct(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyProductBundlesRelatedByFkBundledProductPartial && !$this->isNew();
        if (null === $this->collSpyProductBundlesRelatedByFkBundledProduct || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductBundleRelatedByFkBundledProduct(SpyProductBundle $spyProductBundleRelatedByFkBundledProduct): void
    {
     ...
     * @return void
     */
    public function resetPartialSpyWishlistItems($v = true): void
    {
     ...
     * @return void
     */
    public function initSpyWishlistItems(bool $overrideExisting = true): void
    {
        if (null !== $this->collSpyWishlistItems && !$overrideExisting) {
            return;
        }

        $collectionClassName = SpyWishlistItemTableMap::getTableMap()->getCollectionClassName();

        $this->collSpyWishlistItems = new $collectionClassName;
        $this->collSpyWishlistItems->setModel('\Orm\Zed\Wishlist\Persistence\SpyWishlistItem');
    }

    /**
     * Gets an array of SpyWishlistItem objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|SpyWishlistItem[] List of SpyWishlistItem objects
     * @phpstan-return ObjectCollection&\Traversable<SpyWishlistItem> List of SpyWishlistItem objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collSpyWishlistItems || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collSpyWishlistItems) {
                    ...
                    $collSpyWishlistItems = new $collectionClassName;
                    $collSpyWishlistItems->setModel('\Orm\Zed\Wishlist\Persistence\SpyWishlistItem');

                    return $collSpyWishlistItems;
                }
            } else {
                $collSpyWishlistItems = SpyWishlistItemQuery::create(null, $criteria)
                    ->filterBySpyProduct($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of SpyWishlistItem objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        /** @var SpyWishlistItem[] $spyWishlistItemsToDelete */
    ...
    /**
     * Returns the number of related BaseSpyWishlistItem objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related BaseSpyWishlistItem objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyWishlistItems(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyWishlistItemsPartial && !$this->isNew();
        if (null === $this->collSpyWishlistItems || null !== $criteria || $partial) {
            ...
            $query = SpyWishlistItemQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a SpyWishlistItem object to this object
     * through the SpyWishlistItem foreign key attribute.
     *
     * @param SpyWishlistItem $l SpyWishlistItem
     * @return $this The current object (for fluent API support)
     */
    public function addSpyWishlistItem(SpyWishlistItem $l)
    {
        if ($this->collSpyWishlistItems === null) {
            $this->initSpyWishlistItems();
            $this->collSpyWishlistItemsPartial = true;
        ...
        if (!$this->collSpyWishlistItems->contains($l)) {
            ...
            if ($this->spyWishlistItemsScheduledForDeletion and $this->spyWishlistItemsScheduledForDeletion->contains($l)) {
                $this->spyWishlistItemsScheduledForDeletion->remove($this->spyWishlistItemsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param SpyWishlistItem $spyWishlistItem The SpyWishlistItem object to add.
     */
    protected function doAddSpyWishlistItem(SpyWishlistItem $spyWishlistItem): void
    {
    ...
    /**
     * @param SpyWishlistItem $spyWishlistItem The SpyWishlistItem object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpyWishlistItem(SpyWishlistItem $spyWishlistItem)
    {
