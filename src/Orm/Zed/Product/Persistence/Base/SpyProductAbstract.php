...
use Orm\Zed\GiftCard\Persistence\Base\SpyGiftCardProductAbstractConfigurationLink as BaseSpyGiftCardProductAbstractConfigurationLink;
...
abstract class SpyProductAbstract implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|SpyGiftCardProductAbstractConfigurationLink[] Collection to store aggregation of SpyGiftCardProductAbstractConfigurationLink objects.
     * @phpstan-var ObjectCollection&\Traversable<SpyGiftCardProductAbstractConfigurationLink> Collection to store aggregation of SpyGiftCardProductAbstractConfigurationLink objects.
     */
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|SpyGiftCardProductAbstractConfigurationLink[]
     * @phpstan-var ObjectCollection&\Traversable<SpyGiftCardProductAbstractConfigurationLink>
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyProductAbstractTableMap::translateFieldName('ColorCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->color_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyProductAbstractTableMap::translateFieldName('NewFrom', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->new_from = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyProductAbstractTableMap::translateFieldName('NewTo', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[3] => $this->getColorCode(),
            $keys[4] => $this->getNewFrom(),
            $keys[5] => $this->getNewTo(),
            $keys[6] => $this->getSku(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setColorCode($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setNewFrom($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setNewTo($arr[$keys[5]]);
        }
    ...
    /**
     * Gets an array of SpyGiftCardProductAbstractConfigurationLink objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|SpyGiftCardProductAbstractConfigurationLink[] List of SpyGiftCardProductAbstractConfigurationLink objects
     * @phpstan-return ObjectCollection&\Traversable<SpyGiftCardProductAbstractConfigurationLink> List of SpyGiftCardProductAbstractConfigurationLink objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getSpyGiftCardProductAbstractConfigurationLinks(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpyGiftCardProductAbstractConfigurationLinks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpyGiftCardProductAbstractConfigurationLinks = SpyGiftCardProductAbstractConfigurationLinkQuery::create(null, $criteria)
    ...
    /**
     * Sets a collection of SpyGiftCardProductAbstractConfigurationLink objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        /** @var SpyGiftCardProductAbstractConfigurationLink[] $spyGiftCardProductAbstractConfigurationLinksToDelete */
        ...
        foreach ($spyGiftCardProductAbstractConfigurationLinksToDelete as $spyGiftCardProductAbstractConfigurationLinkRemoved) {
            $spyGiftCardProductAbstractConfigurationLinkRemoved->setSpyProductAbstract(null);
        }
    ...
    /**
     * Returns the number of related BaseSpyGiftCardProductAbstractConfigurationLink objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related BaseSpyGiftCardProductAbstractConfigurationLink objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyGiftCardProductAbstractConfigurationLinks(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        ...
        if (null === $this->collSpyGiftCardProductAbstractConfigurationLinks || null !== $criteria || $partial) {
            ...
            $query = SpyGiftCardProductAbstractConfigurationLinkQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a SpyGiftCardProductAbstractConfigurationLink object to this object
     * through the SpyGiftCardProductAbstractConfigurationLink foreign key attribute.
     *
     * @param SpyGiftCardProductAbstractConfigurationLink $l SpyGiftCardProductAbstractConfigurationLink
     * @return $this The current object (for fluent API support)
     */
    public function addSpyGiftCardProductAbstractConfigurationLink(SpyGiftCardProductAbstractConfigurationLink $l)
    {
        if ($this->collSpyGiftCardProductAbstractConfigurationLinks === null) {
            $this->initSpyGiftCardProductAbstractConfigurationLinks();
            $this->collSpyGiftCardProductAbstractConfigurationLinksPartial = true;
    ...
    /**
     * @param SpyGiftCardProductAbstractConfigurationLink $spyGiftCardProductAbstractConfigurationLink The SpyGiftCardProductAbstractConfigurationLink object to add.
     */
    protected function doAddSpyGiftCardProductAbstractConfigurationLink(SpyGiftCardProductAbstractConfigurationLink $spyGiftCardProductAbstractConfigurationLink): void
    {
        $this->collSpyGiftCardProductAbstractConfigurationLinks[]= $spyGiftCardProductAbstractConfigurationLink;
        $spyGiftCardProductAbstractConfigurationLink->setSpyProductAbstract($this);
    }

    /**
     * @param SpyGiftCardProductAbstractConfigurationLink $spyGiftCardProductAbstractConfigurationLink The SpyGiftCardProductAbstractConfigurationLink object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpyGiftCardProductAbstractConfigurationLink(SpyGiftCardProductAbstractConfigurationLink $spyGiftCardProductAbstractConfigurationLink)
    {
        if ($this->getSpyGiftCardProductAbstractConfigurationLinks()->contains($spyGiftCardProductAbstractConfigurationLink)) {
            ...
            $spyGiftCardProductAbstractConfigurationLink->setSpyProductAbstract(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpyGiftCardProductAbstractConfigurationLink}> List of SpyGiftCardProductAbstractConfigurationLink objects
     */
    public function getSpyGiftCardProductAbstractConfigurationLinksJoinSpyGiftCardProductAbstractConfiguration(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpyGiftCardProductAbstractConfigurationLinkQuery::create(null, $criteria);
        $query->joinWith('SpyGiftCardProductAbstractConfiguration', $joinBehavior);
