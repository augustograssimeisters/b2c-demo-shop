 ...
 *
 * @method     ChildSpyProductAbstractQuery leftJoinSpyGiftCardProductAbstractConfigurationLink($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 * @method     ChildSpyProductAbstractQuery rightJoinSpyGiftCardProductAbstractConfigurationLink($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 * @method     ChildSpyProductAbstractQuery innerJoinSpyGiftCardProductAbstractConfigurationLink($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 *
 * @method     ChildSpyProductAbstractQuery joinWithSpyGiftCardProductAbstractConfigurationLink($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 *
 * @method     ChildSpyProductAbstractQuery leftJoinWithSpyGiftCardProductAbstractConfigurationLink() Adds a LEFT JOIN clause and with to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 * @method     ChildSpyProductAbstractQuery rightJoinWithSpyGiftCardProductAbstractConfigurationLink() Adds a RIGHT JOIN clause and with to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 * @method     ChildSpyProductAbstractQuery innerJoinWithSpyGiftCardProductAbstractConfigurationLink() Adds a INNER JOIN clause and with to the query using the SpyGiftCardProductAbstractConfigurationLink relation
 *
...
abstract class SpyProductAbstractQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_product_abstract, fk_tax_set, attributes, color_code, new_from, new_to, sku, created_at, updated_at FROM spy_product_abstract WHERE id_product_abstract = :p0';
        try {
    ...
    public function filterBySpyGiftCardProductAbstractConfigurationLink($spyGiftCardProductAbstractConfigurationLink, ?string $comparison = null)
    {
        if ($spyGiftCardProductAbstractConfigurationLink instanceof \Orm\Zed\GiftCard\Persistence\SpyGiftCardProductAbstractConfigurationLink) {
            $this
                ->addUsingAlias(SpyProductAbstractTableMap::COL_ID_PRODUCT_ABSTRACT, $spyGiftCardProductAbstractConfigurationLink->getFkProductAbstract(), $comparison);
