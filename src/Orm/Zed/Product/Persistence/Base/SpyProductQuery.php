 ...
 *
 * @method     ChildSpyProductQuery leftJoinSpyGiftCardProductConfigurationLink($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyGiftCardProductConfigurationLink relation
 * @method     ChildSpyProductQuery rightJoinSpyGiftCardProductConfigurationLink($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyGiftCardProductConfigurationLink relation
 * @method     ChildSpyProductQuery innerJoinSpyGiftCardProductConfigurationLink($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyGiftCardProductConfigurationLink relation
 *
 * @method     ChildSpyProductQuery joinWithSpyGiftCardProductConfigurationLink($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyGiftCardProductConfigurationLink relation
 *
 * @method     ChildSpyProductQuery leftJoinWithSpyGiftCardProductConfigurationLink() Adds a LEFT JOIN clause and with to the query using the SpyGiftCardProductConfigurationLink relation
 * @method     ChildSpyProductQuery rightJoinWithSpyGiftCardProductConfigurationLink() Adds a RIGHT JOIN clause and with to the query using the SpyGiftCardProductConfigurationLink relation
 * @method     ChildSpyProductQuery innerJoinWithSpyGiftCardProductConfigurationLink() Adds a INNER JOIN clause and with to the query using the SpyGiftCardProductConfigurationLink relation
 *
 ...
 *
 * @method     ChildSpyProductQuery joinWithSpyWishlistItem($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyWishlistItem relation
 *
 * @method     ChildSpyProductQuery leftJoinWithSpyWishlistItem() Adds a LEFT JOIN clause and with to the query using the SpyWishlistItem relation
 * @method     ChildSpyProductQuery rightJoinWithSpyWishlistItem() Adds a RIGHT JOIN clause and with to the query using the SpyWishlistItem relation
 * @method     ChildSpyProductQuery innerJoinWithSpyWishlistItem() Adds a INNER JOIN clause and with to the query using the SpyWishlistItem relation
 *
...
abstract class SpyProductQuery extends ModelCriteria
{
    ...
    public function filterBySpyGiftCardProductConfigurationLink($spyGiftCardProductConfigurationLink, ?string $comparison = null)
    {
        if ($spyGiftCardProductConfigurationLink instanceof \Orm\Zed\GiftCard\Persistence\SpyGiftCardProductConfigurationLink) {
            $this
                ->addUsingAlias(SpyProductTableMap::COL_ID_PRODUCT, $spyGiftCardProductConfigurationLink->getFkProduct(), $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySpyProductBundleRelatedByFkBundledProduct($spyProductBundle, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyProductBundleRelatedByFkBundledProduct(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    public function useSpyProductBundleRelatedByFkBundledProductExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        ...
        $q = $this->useExistsQuery('SpyProductBundleRelatedByFkBundledProduct', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\ProductBundle\Persistence\SpyProductBundleQuery */
        $q = $this->useExistsQuery('SpyProductBundleRelatedByFkBundledProduct', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the SpyProductBundleRelatedByFkBundledProduct relation to the SpyProductBundle table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useInSpyProductBundleRelatedByFkBundledProductQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\ProductBundle\Persistence\SpyProductBundleQuery */
        $q = $this->useInQuery('SpyProductBundleRelatedByFkBundledProduct', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the SpyProductBundleRelatedByFkBundledProduct relation to the SpyProductBundle table for a NOT IN query.
     *
     * @see useSpyProductBundleRelatedByFkBundledProductInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useNotInSpyProductBundleRelatedByFkBundledProductQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\ProductBundle\Persistence\SpyProductBundleQuery */
        $q = $this->useInQuery('SpyProductBundleRelatedByFkBundledProduct', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
    ...
    public function filterBySpyWishlistItem($spyWishlistItem, ?string $comparison = null)
    {
        if ($spyWishlistItem instanceof \Orm\Zed\Wishlist\Persistence\SpyWishlistItem) {
            $this
                ->addUsingAlias(SpyProductTableMap::COL_SKU, $spyWishlistItem->getSku(), $comparison);
