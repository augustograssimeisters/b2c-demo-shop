...
class SpyProductAbstractTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductAbstract', 'FkTaxSet', 'Attributes', 'ColorCode', 'NewFrom', 'NewTo', 'Sku', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductAbstract', 'fkTaxSet', 'attributes', 'colorCode', 'newFrom', 'newTo', 'sku', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductAbstractTableMap::COL_ID_PRODUCT_ABSTRACT, SpyProductAbstractTableMap::COL_FK_TAX_SET, SpyProductAbstractTableMap::COL_ATTRIBUTES, SpyProductAbstractTableMap::COL_COLOR_CODE, SpyProductAbstractTableMap::COL_NEW_FROM, SpyProductAbstractTableMap::COL_NEW_TO, SpyProductAbstractTableMap::COL_SKU, SpyProductAbstractTableMap::COL_CREATED_AT, SpyProductAbstractTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_abstract', 'fk_tax_set', 'attributes', 'color_code', 'new_from', 'new_to', 'sku', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductAbstract' => 0, 'FkTaxSet' => 1, 'Attributes' => 2, 'ColorCode' => 3, 'NewFrom' => 4, 'NewTo' => 5, 'Sku' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ],
        self::TYPE_CAMELNAME     => ['idProductAbstract' => 0, 'fkTaxSet' => 1, 'attributes' => 2, 'colorCode' => 3, 'newFrom' => 4, 'newTo' => 5, 'sku' => 6, 'createdAt' => 7, 'updatedAt' => 8, ],
        self::TYPE_COLNAME       => [SpyProductAbstractTableMap::COL_ID_PRODUCT_ABSTRACT => 0, SpyProductAbstractTableMap::COL_FK_TAX_SET => 1, SpyProductAbstractTableMap::COL_ATTRIBUTES => 2, SpyProductAbstractTableMap::COL_COLOR_CODE => 3, SpyProductAbstractTableMap::COL_NEW_FROM => 4, SpyProductAbstractTableMap::COL_NEW_TO => 5, SpyProductAbstractTableMap::COL_SKU => 6, SpyProductAbstractTableMap::COL_CREATED_AT => 7, SpyProductAbstractTableMap::COL_UPDATED_AT => 8, ],
        self::TYPE_FIELDNAME     => ['id_product_abstract' => 0, 'fk_tax_set' => 1, 'attributes' => 2, 'color_code' => 3, 'new_from' => 4, 'new_to' => 5, 'sku' => 6, 'created_at' => 7, 'updated_at' => 8, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, 8, ]
    ];
