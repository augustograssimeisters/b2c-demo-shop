 ...
 * @method     ChildSpyStockQuery orderByPickingListStrategy($order = Criteria::ASC) Order by the picking_list_strategy column
 * @method     ChildSpyStockQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 *
 ...
 * @method     ChildSpyStockQuery groupByPickingListStrategy() Group by the picking_list_strategy column
 * @method     ChildSpyStockQuery groupByUuid() Group by the uuid column
 *
 ...
 *
 * @method     ChildSpyStockQuery leftJoinSpyPickingList($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyPickingList relation
 * @method     ChildSpyStockQuery rightJoinSpyPickingList($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyPickingList relation
 * @method     ChildSpyStockQuery innerJoinSpyPickingList($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyPickingList relation
 *
 * @method     ChildSpyStockQuery joinWithSpyPickingList($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyPickingList relation
 *
 * @method     ChildSpyStockQuery leftJoinWithSpyPickingList() Adds a LEFT JOIN clause and with to the query using the SpyPickingList relation
 * @method     ChildSpyStockQuery rightJoinWithSpyPickingList() Adds a RIGHT JOIN clause and with to the query using the SpyPickingList relation
 * @method     ChildSpyStockQuery innerJoinWithSpyPickingList() Adds a INNER JOIN clause and with to the query using the SpyPickingList relation
 *
 ...
 *
 * @method     ChildSpyStockQuery leftJoinSpyWarehouseUserAssignment($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyWarehouseUserAssignment relation
 * @method     ChildSpyStockQuery rightJoinSpyWarehouseUserAssignment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyWarehouseUserAssignment relation
 * @method     ChildSpyStockQuery innerJoinSpyWarehouseUserAssignment($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyWarehouseUserAssignment relation
 *
 * @method     ChildSpyStockQuery joinWithSpyWarehouseUserAssignment($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyWarehouseUserAssignment relation
 *
 * @method     ChildSpyStockQuery leftJoinWithSpyWarehouseUserAssignment() Adds a LEFT JOIN clause and with to the query using the SpyWarehouseUserAssignment relation
 * @method     ChildSpyStockQuery rightJoinWithSpyWarehouseUserAssignment() Adds a RIGHT JOIN clause and with to the query using the SpyWarehouseUserAssignment relation
 * @method     ChildSpyStockQuery innerJoinWithSpyWarehouseUserAssignment() Adds a INNER JOIN clause and with to the query using the SpyWarehouseUserAssignment relation
 *
 * @method     \Orm\Zed\PickingList\Persistence\SpyPickingListQuery|\Orm\Zed\Stock\Persistence\SpyStockProductQuery|\Orm\Zed\Stock\Persistence\SpyStockStoreQuery|\Orm\Zed\StockAddress\Persistence\SpyStockAddressQuery|\Orm\Zed\WarehouseAllocation\Persistence\SpyWarehouseAllocationQuery|\Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildSpyStock|null findOneByPickingListStrategy(string $picking_list_strategy) Return the first ChildSpyStock filtered by the picking_list_strategy column
 * @method     ChildSpyStock|null findOneByUuid(string $uuid) Return the first ChildSpyStock filtered by the uuid column
 *
 ...
 * @method     ChildSpyStock requireOneByPickingListStrategy(string $picking_list_strategy) Return the first ChildSpyStock filtered by the picking_list_strategy column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSpyStock requireOneByUuid(string $uuid) Return the first ChildSpyStock filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpyStock[]|Collection findByPickingListStrategy(string|array<string> $picking_list_strategy) Return ChildSpyStock objects filtered by the picking_list_strategy column
 * @psalm-method Collection&\Traversable<ChildSpyStock> findByPickingListStrategy(string|array<string> $picking_list_strategy) Return ChildSpyStock objects filtered by the picking_list_strategy column
 * @method     ChildSpyStock[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyStock objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyStock> findByUuid(string|array<string> $uuid) Return ChildSpyStock objects filtered by the uuid column
 *
...
abstract class SpyStockQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_stock, is_active, name, picking_list_strategy, uuid FROM spy_stock WHERE id_stock = :p0';
        try {
     ...
     * Applies Criteria::IN filtering criteria for the column.
     *
     * @param array $pickingListStrategys Filter value.
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByPickingListStrategy_In(array $pickingListStrategys)
    {
        return $this->filterByPickingListStrategy($pickingListStrategys, Criteria::IN);
    }

    /**
     * Applies SprykerCriteria::LIKE filtering criteria for the column.
     *
     * @param string $pickingListStrategy Filter value.
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByPickingListStrategy_Like($pickingListStrategy)
    {
        return $this->filterByPickingListStrategy($pickingListStrategy, Criteria::LIKE);
    }

    /**
     * Filter the query on the picking_list_strategy column
     *
     * Example usage:
     * <code>
     * $query->filterByPickingListStrategy('fooValue');   // WHERE picking_list_strategy = 'fooValue'
     * $query->filterByPickingListStrategy('%fooValue%', Criteria::LIKE); // WHERE picking_list_strategy LIKE '%fooValue%'
     * $query->filterByPickingListStrategy([1, 'foo'], Criteria::IN); // WHERE picking_list_strategy IN (1, 'foo')
     * </code>
     *
     * @param     string|string[] $pickingListStrategy The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE). Add Criteria::LIKE explicitly.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     ...
     * @throws \Spryker\Zed\Propel\Business\Exception\AmbiguousComparisonException
     */
    public function filterByPickingListStrategy($pickingListStrategy = null, $comparison = Criteria::EQUAL)
    {
        if ($comparison == Criteria::LIKE || $comparison == Criteria::ILIKE) {
            $pickingListStrategy = str_replace('*', '%', $pickingListStrategy);
        }

        if (is_array($pickingListStrategy) && !in_array($comparison, [Criteria::IN, Criteria::NOT_IN])) {
            throw new AmbiguousComparisonException('$pickingListStrategy of type array requires one of [Criteria::IN, Criteria::NOT_IN] as comparison criteria.');
        }

        $query = $this->addUsingAlias(SpyStockTableMap::COL_PICKING_LIST_STRATEGY, $pickingListStrategy, $comparison);
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyStockTableMap::COL_UUID, $uuid, $comparison);
     ...
     *
     * @param \Orm\Zed\PickingList\Persistence\SpyPickingList|ObjectCollection $spyPickingList the related object to use as filter
    ...
    public function filterBySpyPickingList($spyPickingList, ?string $comparison = null)
    {
        if ($spyPickingList instanceof \Orm\Zed\PickingList\Persistence\SpyPickingList) {
            $this
                ->addUsingAlias(SpyStockTableMap::COL_ID_STOCK, $spyPickingList->getFkWarehouse(), $comparison);

            return $this;
        } elseif ($spyPickingList instanceof ObjectCollection) {
            $this
                ->useSpyPickingListQuery()
                ->filterByPrimaryKeys($spyPickingList->getPrimaryKeys())
                ->endUse();
    ...
    /**
     * Filter the query by a related \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignment object
     *
     * @param \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignment|ObjectCollection $spyWarehouseUserAssignment the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterBySpyWarehouseUserAssignment($spyWarehouseUserAssignment, ?string $comparison = null)
    {
        if ($spyWarehouseUserAssignment instanceof \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignment) {
            $this
                ->addUsingAlias(SpyStockTableMap::COL_ID_STOCK, $spyWarehouseUserAssignment->getFkWarehouse(), $comparison);

            return $this;
        } elseif ($spyWarehouseUserAssignment instanceof ObjectCollection) {
            $this
                ->useSpyWarehouseUserAssignmentQuery()
                ->filterByPrimaryKeys($spyWarehouseUserAssignment->getPrimaryKeys())
                ->endUse();

            return $this;
        } else {
            throw new PropelException('filterBySpyWarehouseUserAssignment() only accepts arguments of type \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignment or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the SpyWarehouseUserAssignment relation
     *
     * @param string|null $relationAlias Optional alias for the relation
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this The current query, for fluid interface
     */
    public function joinSpyWarehouseUserAssignment(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('SpyWarehouseUserAssignment');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'SpyWarehouseUserAssignment');
        }
    ...
    /**
     * Use the SpyWarehouseUserAssignment relation SpyWarehouseUserAssignment object
     *
     * @see useQuery()
     *
     * @param string $relationAlias optional alias for the relation,
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery A secondary query class using the current class as primary query
     */
    public function useSpyWarehouseUserAssignmentQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSpyWarehouseUserAssignment($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SpyWarehouseUserAssignment', '\Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery');
    }

    /**
     * Use the SpyWarehouseUserAssignment relation SpyWarehouseUserAssignment object
     *
     * @param callable(\Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery):\Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @return $this
     */
    public function withSpyWarehouseUserAssignmentQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useSpyWarehouseUserAssignmentQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the relation to SpyWarehouseUserAssignment table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery The inner query object of the EXISTS statement
     */
    public function useSpyWarehouseUserAssignmentExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery */
        $q = $this->useExistsQuery('SpyWarehouseUserAssignment', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the relation to SpyWarehouseUserAssignment table for a NOT EXISTS query.
     *
     * @see useSpyWarehouseUserAssignmentExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery The inner query object of the NOT EXISTS statement
     */
    public function useSpyWarehouseUserAssignmentNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery */
        $q = $this->useExistsQuery('SpyWarehouseUserAssignment', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to SpyWarehouseUserAssignment table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery The inner query object of the IN statement
     */
    public function useInSpyWarehouseUserAssignmentQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery */
        $q = $this->useInQuery('SpyWarehouseUserAssignment', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to SpyWarehouseUserAssignment table for a NOT IN query.
     *
     * @see useSpyWarehouseUserAssignmentInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery The inner query object of the NOT IN statement
     */
    public function useNotInSpyWarehouseUserAssignmentQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\WarehouseUser\Persistence\SpyWarehouseUserAssignmentQuery */
        $q = $this->useInQuery('SpyWarehouseUserAssignment', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
