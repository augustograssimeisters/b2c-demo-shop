 ...
 * @method     ChildSpyStockProductQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 *
 ...
 * @method     ChildSpyStockProductQuery groupByUuid() Group by the uuid column
 *
 ...
 * @method     ChildSpyStockProduct|null findOneByUuid(string $uuid) Return the first ChildSpyStockProduct filtered by the uuid column
 *
 ...
 * @method     ChildSpyStockProduct requireOneByUuid(string $uuid) Return the first ChildSpyStockProduct filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpyStockProduct[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyStockProduct objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> findByUuid(string|array<string> $uuid) Return ChildSpyStockProduct objects filtered by the uuid column
 *
...
abstract class SpyStockProductQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_stock_product, fk_product, fk_stock, is_never_out_of_stock, quantity, uuid FROM spy_stock_product WHERE id_stock_product = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyStockProductTableMap::COL_UUID, $uuid, $comparison);
