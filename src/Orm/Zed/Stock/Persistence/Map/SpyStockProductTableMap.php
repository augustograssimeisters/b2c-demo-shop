...
class SpyStockProductTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_stock_product.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdStockProduct', 'FkProduct', 'FkStock', 'IsNeverOutOfStock', 'Quantity', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idStockProduct', 'fkProduct', 'fkStock', 'isNeverOutOfStock', 'quantity', 'uuid', ],
        self::TYPE_COLNAME       => [SpyStockProductTableMap::COL_ID_STOCK_PRODUCT, SpyStockProductTableMap::COL_FK_PRODUCT, SpyStockProductTableMap::COL_FK_STOCK, SpyStockProductTableMap::COL_IS_NEVER_OUT_OF_STOCK, SpyStockProductTableMap::COL_QUANTITY, SpyStockProductTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_stock_product', 'fk_product', 'fk_stock', 'is_never_out_of_stock', 'quantity', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdStockProduct' => 0, 'FkProduct' => 1, 'FkStock' => 2, 'IsNeverOutOfStock' => 3, 'Quantity' => 4, 'Uuid' => 5, ],
        self::TYPE_CAMELNAME     => ['idStockProduct' => 0, 'fkProduct' => 1, 'fkStock' => 2, 'isNeverOutOfStock' => 3, 'quantity' => 4, 'uuid' => 5, ],
        self::TYPE_COLNAME       => [SpyStockProductTableMap::COL_ID_STOCK_PRODUCT => 0, SpyStockProductTableMap::COL_FK_PRODUCT => 1, SpyStockProductTableMap::COL_FK_STOCK => 2, SpyStockProductTableMap::COL_IS_NEVER_OUT_OF_STOCK => 3, SpyStockProductTableMap::COL_QUANTITY => 4, SpyStockProductTableMap::COL_UUID => 5, ],
        self::TYPE_FIELDNAME     => ['id_stock_product' => 0, 'fk_product' => 1, 'fk_stock' => 2, 'is_never_out_of_stock' => 3, 'quantity' => 4, 'uuid' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpyStockProduct.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spyStockProduct.uuid' => 'UUID',
        'SpyStockProductTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_stock_product.uuid' => 'UUID',
    ];
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_stock_product.fk_stock.fk_product'],
        ];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyStockProductTableMap::COL_UUID);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyStockProductTableMap::COL_UUID);
        } else {
