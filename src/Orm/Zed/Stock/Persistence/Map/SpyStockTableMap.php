...
class SpyStockTableMap extends TableMap
{
    ...
    /**
     * the column name for the picking_list_strategy field
     */
    public const COL_PICKING_LIST_STRATEGY = 'spy_stock.picking_list_strategy';

    /**
     * the column name for the uuid field
     */
    public const COL_UUID = 'spy_stock.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdStock', 'IsActive', 'Name', 'PickingListStrategy', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idStock', 'isActive', 'name', 'pickingListStrategy', 'uuid', ],
        self::TYPE_COLNAME       => [SpyStockTableMap::COL_ID_STOCK, SpyStockTableMap::COL_IS_ACTIVE, SpyStockTableMap::COL_NAME, SpyStockTableMap::COL_PICKING_LIST_STRATEGY, SpyStockTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_stock', 'is_active', 'name', 'picking_list_strategy', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdStock' => 0, 'IsActive' => 1, 'Name' => 2, 'PickingListStrategy' => 3, 'Uuid' => 4, ],
        self::TYPE_CAMELNAME     => ['idStock' => 0, 'isActive' => 1, 'name' => 2, 'pickingListStrategy' => 3, 'uuid' => 4, ],
        self::TYPE_COLNAME       => [SpyStockTableMap::COL_ID_STOCK => 0, SpyStockTableMap::COL_IS_ACTIVE => 1, SpyStockTableMap::COL_NAME => 2, SpyStockTableMap::COL_PICKING_LIST_STRATEGY => 3, SpyStockTableMap::COL_UUID => 4, ],
        self::TYPE_FIELDNAME     => ['id_stock' => 0, 'is_active' => 1, 'name' => 2, 'picking_list_strategy' => 3, 'uuid' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'COL_NAME' => 'NAME',
        'spy_stock.name' => 'NAME',
        'PickingListStrategy' => 'PICKING_LIST_STRATEGY',
        'SpyStock.PickingListStrategy' => 'PICKING_LIST_STRATEGY',
        'pickingListStrategy' => 'PICKING_LIST_STRATEGY',
        'spyStock.pickingListStrategy' => 'PICKING_LIST_STRATEGY',
        'SpyStockTableMap::COL_PICKING_LIST_STRATEGY' => 'PICKING_LIST_STRATEGY',
        'COL_PICKING_LIST_STRATEGY' => 'PICKING_LIST_STRATEGY',
        'picking_list_strategy' => 'PICKING_LIST_STRATEGY',
        'spy_stock.picking_list_strategy' => 'PICKING_LIST_STRATEGY',
        'Uuid' => 'UUID',
        'SpyStock.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spyStock.uuid' => 'UUID',
        'SpyStockTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_stock.uuid' => 'UUID',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('picking_list_strategy', 'PickingListStrategy', 'VARCHAR', false, 255, null);
    ...
    {
        $this->addRelation('SpyPickingList', '\\Orm\\Zed\\PickingList\\Persistence\\SpyPickingList', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_warehouse',
    1 => ':id_stock',
  ),
), null, null, 'SpyPickingLists', false);
  ...
  array (
    ...
    1 => ':id_stock',
        ...
        $this->addRelation('SpyWarehouseUserAssignment', '\\Orm\\Zed\\WarehouseUser\\Persistence\\SpyWarehouseUserAssignment', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_warehouse',
    1 => ':id_stock',
  ),
), null, null, 'SpyWarehouseUserAssignments', false);
    }
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_stock'],
        ];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyStockTableMap::COL_PICKING_LIST_STRATEGY);
            $criteria->addSelectColumn(SpyStockTableMap::COL_UUID);
        } else {
            $criteria->addSelectColumn($alias . '.id_stock');
            $criteria->addSelectColumn($alias . '.is_active');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.picking_list_strategy');
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyStockTableMap::COL_PICKING_LIST_STRATEGY);
            $criteria->removeSelectColumn(SpyStockTableMap::COL_UUID);
        } else {
            $criteria->removeSelectColumn($alias . '.id_stock');
            $criteria->removeSelectColumn($alias . '.is_active');
            $criteria->removeSelectColumn($alias . '.name');
            $criteria->removeSelectColumn($alias . '.picking_list_strategy');
