...
abstract class SpyUrlQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_url, fk_locale, fk_resource_categorynode, fk_resource_page, fk_resource_product_abstract, fk_resource_product_set, fk_resource_redirect, url FROM spy_url WHERE id_url = :p0';
        try {
