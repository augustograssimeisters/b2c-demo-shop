...
abstract class SpyUrl implements ActiveRecordInterface
{
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyUrlTableMap::translateFieldName('FkResourcePage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_resource_page = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyUrlTableMap::translateFieldName('FkResourceProductAbstract', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_resource_product_abstract = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyUrlTableMap::translateFieldName('FkResourceProductSet', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpyUrlTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = SpyUrlTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[3] => $this->getFkResourcePage(),
            $keys[4] => $this->getFkResourceProductAbstract(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setFkResourcePage($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setFkResourceProductAbstract($arr[$keys[4]]);
        }
