...
class SpyUrlTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdUrl', 'FkLocale', 'FkResourceCategorynode', 'FkResourcePage', 'FkResourceProductAbstract', 'FkResourceProductSet', 'FkResourceRedirect', 'Url', ],
        self::TYPE_CAMELNAME     => ['idUrl', 'fkLocale', 'fkResourceCategorynode', 'fkResourcePage', 'fkResourceProductAbstract', 'fkResourceProductSet', 'fkResourceRedirect', 'url', ],
        self::TYPE_COLNAME       => [SpyUrlTableMap::COL_ID_URL, SpyUrlTableMap::COL_FK_LOCALE, SpyUrlTableMap::COL_FK_RESOURCE_CATEGORYNODE, SpyUrlTableMap::COL_FK_RESOURCE_PAGE, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_ABSTRACT, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_SET, SpyUrlTableMap::COL_FK_RESOURCE_REDIRECT, SpyUrlTableMap::COL_URL, ],
        self::TYPE_FIELDNAME     => ['id_url', 'fk_locale', 'fk_resource_categorynode', 'fk_resource_page', 'fk_resource_product_abstract', 'fk_resource_product_set', 'fk_resource_redirect', 'url', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdUrl' => 0, 'FkLocale' => 1, 'FkResourceCategorynode' => 2, 'FkResourcePage' => 3, 'FkResourceProductAbstract' => 4, 'FkResourceProductSet' => 5, 'FkResourceRedirect' => 6, 'Url' => 7, ],
        self::TYPE_CAMELNAME     => ['idUrl' => 0, 'fkLocale' => 1, 'fkResourceCategorynode' => 2, 'fkResourcePage' => 3, 'fkResourceProductAbstract' => 4, 'fkResourceProductSet' => 5, 'fkResourceRedirect' => 6, 'url' => 7, ],
        self::TYPE_COLNAME       => [SpyUrlTableMap::COL_ID_URL => 0, SpyUrlTableMap::COL_FK_LOCALE => 1, SpyUrlTableMap::COL_FK_RESOURCE_CATEGORYNODE => 2, SpyUrlTableMap::COL_FK_RESOURCE_PAGE => 3, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_ABSTRACT => 4, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_SET => 5, SpyUrlTableMap::COL_FK_RESOURCE_REDIRECT => 6, SpyUrlTableMap::COL_URL => 7, ],
        self::TYPE_FIELDNAME     => ['id_url' => 0, 'fk_locale' => 1, 'fk_resource_categorynode' => 2, 'fk_resource_page' => 3, 'fk_resource_product_abstract' => 4, 'fk_resource_product_set' => 5, 'fk_resource_redirect' => 6, 'url' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
