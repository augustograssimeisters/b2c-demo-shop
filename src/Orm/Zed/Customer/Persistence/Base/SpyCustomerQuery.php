 ...
 *
 * @method     ChildSpyCustomerQuery joinWithSpyWishlist($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyWishlist relation
 *
 * @method     ChildSpyCustomerQuery leftJoinWithSpyWishlist() Adds a LEFT JOIN clause and with to the query using the SpyWishlist relation
 * @method     ChildSpyCustomerQuery rightJoinWithSpyWishlist() Adds a RIGHT JOIN clause and with to the query using the SpyWishlist relation
 * @method     ChildSpyCustomerQuery innerJoinWithSpyWishlist() Adds a INNER JOIN clause and with to the query using the SpyWishlist relation
 *
...
abstract class SpyCustomerQuery extends ModelCriteria
{
     ...
     *
     * @param \Orm\Zed\Wishlist\Persistence\SpyWishlist|ObjectCollection $spyWishlist the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
