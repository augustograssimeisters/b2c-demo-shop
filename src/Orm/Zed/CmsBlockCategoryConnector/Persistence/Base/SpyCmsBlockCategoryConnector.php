...
abstract class SpyCmsBlockCategoryConnector implements ActiveRecordInterface
{
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyCmsBlockCategoryConnectorTableMap::translateFieldName('FkCmsBlock', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_cms_block = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyCmsBlockCategoryConnectorTableMap::translateFieldName('FkCategory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_category = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyCmsBlockCategoryConnectorTableMap::translateFieldName('FkCategoryTemplate', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[3] => $this->getFkCategoryTemplate(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setFkCategoryTemplate($arr[$keys[3]]);
        }
