...
abstract class SpyCmsBlockCategoryConnectorQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_cms_block_category_connector, fk_cms_block, fk_category, fk_category_template, fk_cms_block_category_position FROM spy_cms_block_category_connector WHERE id_cms_block_category_connector = :p0';
        try {
