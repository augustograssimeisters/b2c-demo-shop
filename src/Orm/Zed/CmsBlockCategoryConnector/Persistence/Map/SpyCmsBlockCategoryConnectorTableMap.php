...
class SpyCmsBlockCategoryConnectorTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCmsBlockCategoryConnector', 'FkCmsBlock', 'FkCategory', 'FkCategoryTemplate', 'FkCmsBlockCategoryPosition', ],
        self::TYPE_CAMELNAME     => ['idCmsBlockCategoryConnector', 'fkCmsBlock', 'fkCategory', 'fkCategoryTemplate', 'fkCmsBlockCategoryPosition', ],
        ...
        self::TYPE_FIELDNAME     => ['id_cms_block_category_connector', 'fk_cms_block', 'fk_category', 'fk_category_template', 'fk_cms_block_category_position', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCmsBlockCategoryConnector' => 0, 'FkCmsBlock' => 1, 'FkCategory' => 2, 'FkCategoryTemplate' => 3, 'FkCmsBlockCategoryPosition' => 4, ],
        self::TYPE_CAMELNAME     => ['idCmsBlockCategoryConnector' => 0, 'fkCmsBlock' => 1, 'fkCategory' => 2, 'fkCategoryTemplate' => 3, 'fkCmsBlockCategoryPosition' => 4, ],
        self::TYPE_COLNAME       => [SpyCmsBlockCategoryConnectorTableMap::COL_ID_CMS_BLOCK_CATEGORY_CONNECTOR => 0, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CMS_BLOCK => 1, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CATEGORY => 2, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CATEGORY_TEMPLATE => 3, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CMS_BLOCK_CATEGORY_POSITION => 4, ],
        self::TYPE_FIELDNAME     => ['id_cms_block_category_connector' => 0, 'fk_cms_block' => 1, 'fk_category' => 2, 'fk_category_template' => 3, 'fk_cms_block_category_position' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
