...
class SpyRegionTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdRegion', 'FkCountry', 'Iso2Code', 'Name', ],
        self::TYPE_CAMELNAME     => ['idRegion', 'fkCountry', 'iso2Code', 'name', ],
        self::TYPE_COLNAME       => [SpyRegionTableMap::COL_ID_REGION, SpyRegionTableMap::COL_FK_COUNTRY, SpyRegionTableMap::COL_ISO2_CODE, SpyRegionTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['id_region', 'fk_country', 'iso2_code', 'name', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdRegion' => 0, 'FkCountry' => 1, 'Iso2Code' => 2, 'Name' => 3, ],
        self::TYPE_CAMELNAME     => ['idRegion' => 0, 'fkCountry' => 1, 'iso2Code' => 2, 'name' => 3, ],
        self::TYPE_COLNAME       => [SpyRegionTableMap::COL_ID_REGION => 0, SpyRegionTableMap::COL_FK_COUNTRY => 1, SpyRegionTableMap::COL_ISO2_CODE => 2, SpyRegionTableMap::COL_NAME => 3, ],
        self::TYPE_FIELDNAME     => ['id_region' => 0, 'fk_country' => 1, 'iso2_code' => 2, 'name' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
