...
class SpyShipmentCarrierTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_shipment_carrier.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdShipmentCarrier', 'IsActive', 'Name', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idShipmentCarrier', 'isActive', 'name', 'uuid', ],
        self::TYPE_COLNAME       => [SpyShipmentCarrierTableMap::COL_ID_SHIPMENT_CARRIER, SpyShipmentCarrierTableMap::COL_IS_ACTIVE, SpyShipmentCarrierTableMap::COL_NAME, SpyShipmentCarrierTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_shipment_carrier', 'is_active', 'name', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdShipmentCarrier' => 0, 'IsActive' => 1, 'Name' => 2, 'Uuid' => 3, ],
        self::TYPE_CAMELNAME     => ['idShipmentCarrier' => 0, 'isActive' => 1, 'name' => 2, 'uuid' => 3, ],
        self::TYPE_COLNAME       => [SpyShipmentCarrierTableMap::COL_ID_SHIPMENT_CARRIER => 0, SpyShipmentCarrierTableMap::COL_IS_ACTIVE => 1, SpyShipmentCarrierTableMap::COL_NAME => 2, SpyShipmentCarrierTableMap::COL_UUID => 3, ],
        self::TYPE_FIELDNAME     => ['id_shipment_carrier' => 0, 'is_active' => 1, 'name' => 2, 'uuid' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpyShipmentCarrier.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spyShipmentCarrier.uuid' => 'UUID',
        'SpyShipmentCarrierTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_shipment_carrier.uuid' => 'UUID',
    ];
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_shipment_carrier'],
        ];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyShipmentCarrierTableMap::COL_UUID);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyShipmentCarrierTableMap::COL_UUID);
        } else {
