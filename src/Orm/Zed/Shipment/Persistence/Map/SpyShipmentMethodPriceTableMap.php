...
class SpyShipmentMethodPriceTableMap extends TableMap
{
     ...
     */
    public const COL_UUID = 'spy_shipment_method_price.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdShipmentMethodPrice', 'FkCurrency', 'FkShipmentMethod', 'FkStore', 'DefaultGrossPrice', 'DefaultNetPrice', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idShipmentMethodPrice', 'fkCurrency', 'fkShipmentMethod', 'fkStore', 'defaultGrossPrice', 'defaultNetPrice', 'uuid', ],
        self::TYPE_COLNAME       => [SpyShipmentMethodPriceTableMap::COL_ID_SHIPMENT_METHOD_PRICE, SpyShipmentMethodPriceTableMap::COL_FK_CURRENCY, SpyShipmentMethodPriceTableMap::COL_FK_SHIPMENT_METHOD, SpyShipmentMethodPriceTableMap::COL_FK_STORE, SpyShipmentMethodPriceTableMap::COL_DEFAULT_GROSS_PRICE, SpyShipmentMethodPriceTableMap::COL_DEFAULT_NET_PRICE, SpyShipmentMethodPriceTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_shipment_method_price', 'fk_currency', 'fk_shipment_method', 'fk_store', 'default_gross_price', 'default_net_price', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdShipmentMethodPrice' => 0, 'FkCurrency' => 1, 'FkShipmentMethod' => 2, 'FkStore' => 3, 'DefaultGrossPrice' => 4, 'DefaultNetPrice' => 5, 'Uuid' => 6, ],
        self::TYPE_CAMELNAME     => ['idShipmentMethodPrice' => 0, 'fkCurrency' => 1, 'fkShipmentMethod' => 2, 'fkStore' => 3, 'defaultGrossPrice' => 4, 'defaultNetPrice' => 5, 'uuid' => 6, ],
        self::TYPE_COLNAME       => [SpyShipmentMethodPriceTableMap::COL_ID_SHIPMENT_METHOD_PRICE => 0, SpyShipmentMethodPriceTableMap::COL_FK_CURRENCY => 1, SpyShipmentMethodPriceTableMap::COL_FK_SHIPMENT_METHOD => 2, SpyShipmentMethodPriceTableMap::COL_FK_STORE => 3, SpyShipmentMethodPriceTableMap::COL_DEFAULT_GROSS_PRICE => 4, SpyShipmentMethodPriceTableMap::COL_DEFAULT_NET_PRICE => 5, SpyShipmentMethodPriceTableMap::COL_UUID => 6, ],
        self::TYPE_FIELDNAME     => ['id_shipment_method_price' => 0, 'fk_currency' => 1, 'fk_shipment_method' => 2, 'fk_store' => 3, 'default_gross_price' => 4, 'default_net_price' => 5, 'uuid' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Uuid' => 'UUID',
        'SpyShipmentMethodPrice.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spyShipmentMethodPrice.uuid' => 'UUID',
        'SpyShipmentMethodPriceTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_shipment_method_price.uuid' => 'UUID',
    ];
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_shipment_method_price.fk_shipment_method'],
        ];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyShipmentMethodPriceTableMap::COL_UUID);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyShipmentMethodPriceTableMap::COL_UUID);
        } else {
