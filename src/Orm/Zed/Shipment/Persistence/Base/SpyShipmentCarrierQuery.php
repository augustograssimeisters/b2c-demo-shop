 ...
 * @method     ChildSpyShipmentCarrierQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 *
 ...
 * @method     ChildSpyShipmentCarrierQuery groupByUuid() Group by the uuid column
 *
 ...
 * @method     ChildSpyShipmentCarrier|null findOneByUuid(string $uuid) Return the first ChildSpyShipmentCarrier filtered by the uuid column
 *
 ...
 * @method     ChildSpyShipmentCarrier requireOneByUuid(string $uuid) Return the first ChildSpyShipmentCarrier filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpyShipmentCarrier[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyShipmentCarrier objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyShipmentCarrier> findByUuid(string|array<string> $uuid) Return ChildSpyShipmentCarrier objects filtered by the uuid column
 *
...
abstract class SpyShipmentCarrierQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_shipment_carrier`, `is_active`, `name`, `uuid` FROM `spy_shipment_carrier` WHERE `id_shipment_carrier` = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyShipmentCarrierTableMap::COL_UUID, $uuid, $comparison);
