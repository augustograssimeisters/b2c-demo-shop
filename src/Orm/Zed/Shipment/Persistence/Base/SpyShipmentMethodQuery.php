 ...
 * @method     ChildSpyShipmentMethodQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 *
 ...
 * @method     ChildSpyShipmentMethodQuery groupByUuid() Group by the uuid column
 *
 ...
 * @method     ChildSpyShipmentMethod|null findOneByUuid(string $uuid) Return the first ChildSpyShipmentMethod filtered by the uuid column
 *
 ...
 * @method     ChildSpyShipmentMethod requireOneByUuid(string $uuid) Return the first ChildSpyShipmentMethod filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpyShipmentMethod[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyShipmentMethod objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyShipmentMethod> findByUuid(string|array<string> $uuid) Return ChildSpyShipmentMethod objects filtered by the uuid column
 *
...
abstract class SpyShipmentMethodQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_shipment_method`, `fk_shipment_carrier`, `fk_shipment_type`, `fk_tax_set`, `availability_plugin`, `default_price`, `delivery_time_plugin`, `is_active`, `name`, `price_plugin`, `shipment_method_key`, `uuid` FROM `spy_shipment_method` WHERE `id_shipment_method` = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyShipmentMethodTableMap::COL_UUID, $uuid, $comparison);
