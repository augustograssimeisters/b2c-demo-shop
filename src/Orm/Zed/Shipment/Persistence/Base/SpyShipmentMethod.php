...
abstract class SpyShipmentMethod implements ActiveRecordInterface
{
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyShipmentMethodTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SpyShipmentMethodTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyShipmentMethodTableMap::COL_UUID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyShipmentMethodTableMap::COL_UUID)) {
            $criteria->add(SpyShipmentMethodTableMap::COL_UUID, $this->uuid);
        }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_shipment_method' . '.' . $this->getIdShipmentMethod() . '.' . $this->getFkShipmentCarrier();
