 ...
 * @method     ChildSpyShipmentMethodPriceQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 *
 ...
 * @method     ChildSpyShipmentMethodPriceQuery groupByUuid() Group by the uuid column
 *
 ...
 * @method     ChildSpyShipmentMethodPrice|null findOneByUuid(string $uuid) Return the first ChildSpyShipmentMethodPrice filtered by the uuid column
 *
 ...
 * @method     ChildSpyShipmentMethodPrice requireOneByUuid(string $uuid) Return the first ChildSpyShipmentMethodPrice filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpyShipmentMethodPrice[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyShipmentMethodPrice objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyShipmentMethodPrice> findByUuid(string|array<string> $uuid) Return ChildSpyShipmentMethodPrice objects filtered by the uuid column
 *
...
abstract class SpyShipmentMethodPriceQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_shipment_method_price`, `fk_currency`, `fk_shipment_method`, `fk_store`, `default_gross_price`, `default_net_price`, `uuid` FROM `spy_shipment_method_price` WHERE `id_shipment_method_price` = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyShipmentMethodPriceTableMap::COL_UUID, $uuid, $comparison);
