...
abstract class SpyShipmentMethodPrice implements ActiveRecordInterface
{
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyShipmentMethodPriceTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyShipmentMethodPriceTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = SpyShipmentMethodPriceTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyShipmentMethodPriceTableMap::COL_UUID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyShipmentMethodPriceTableMap::COL_UUID)) {
            $criteria->add(SpyShipmentMethodPriceTableMap::COL_UUID, $this->uuid);
        }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_shipment_method_price' . '.' . $this->getIdShipmentMethodPrice() . '.' . $this->getFkShipmentMethod();
