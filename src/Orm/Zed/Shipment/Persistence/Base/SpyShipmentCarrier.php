...
abstract class SpyShipmentCarrier implements ActiveRecordInterface
{
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyShipmentCarrierTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyShipmentCarrierTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyShipmentCarrierTableMap::COL_UUID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyShipmentCarrierTableMap::COL_UUID)) {
            $criteria->add(SpyShipmentCarrierTableMap::COL_UUID, $this->uuid);
        }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_shipment_carrier' . '.' . $this->getIdShipmentCarrier();
