 ...
 * up to version 1750114779.
 * Generated on 2025-06-16 22:59:39 by spryker */
class PropelMigration_1750114779{
    /**
     * @var string
     */
    public $comment = '';
...
(
    `id_antelope_location` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(255) NOT NULL,
    `latitude` FLOAT NOT NULL,
    `longitude` FLOAT NOT NULL,
    `created_at` TIMESTAMP NULL,
    `updated_at` TIMESTAMP NULL,
    PRIMARY KEY (`id_antelope_location`)
) ENGINE=InnoDB;
